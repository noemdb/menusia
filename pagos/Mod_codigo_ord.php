        ...
        <tr>
          <td><table width="679">
            <tr>
              ...
              <td width="60"><input class="Estilo10" name="btcatcta" type="button" id="btcatcta" title="Abrir Catalogo de Cuentas" onclick="VentanaCentrada('Cat_cuentasc.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)"></td>
