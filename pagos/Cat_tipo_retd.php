...
function Llamar_cat(){var murl;
  murl= "Cat_tipo_retd.php?criterio="+document.form1.criterio.value;
  LlamarURL(murl);
}
function cerrar_catalogo(mcodigo,mnombre){
  window.opener.document.forms[0].txttipo_ret_d.value = mcodigo;
  window.opener.document.forms[0].txttipo_ret_d.focus();
  window.close();
}
</script>
