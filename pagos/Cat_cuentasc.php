...
function Llamar_cat(){var murl;  murl= "Cat_cuentasc.php?criterio="+document.form1.criterio.value;  LlamarURL(murl);}
function cerrar_catalogo(mcodigo,mnombre){
  window.opener.document.forms[0].txtcod_contable.value = mcodigo;
  window.opener.document.forms[0].txtcod_contable.focus();
  window.close();
}
...
<form  name="form1" action="Cat_cuentasc.php" method="get" onSubmit="return revisar()">
<table border="0">
  <tr>
	<td>
