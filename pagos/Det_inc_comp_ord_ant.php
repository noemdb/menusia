...
<body>
  <table width="832" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td  width="260" align="center"><input name="btGenComp" type="button" id="btGenComp" value="Generar Comprobante" title="Generar Comprobante" onclick="javascript:LlamarURL('Gen_Comp_Orden_ant.php?codigo_mov=<?echo $codigo_mov?>')"></td>
...
?>
         ...
         <?}
  $saldo=0; if($t_haber>$t_debe){$saldo=$t_haber-$t_debe;}
