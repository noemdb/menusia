<?php include ("../class/funciones.php"); $equipo=getenv("COMPUTERNAME"); $cta_pasivo='';
if (!$_GET){$mcod_m="PAG001".$equipo;$codigo_mov=substr($mcod_m,0,49);$monto=0;}else{$codigo_mov=$_GET["codigo_mov"];$monto=$_GET["monto"];}
...
<body>
<form name="form1" method="post" action="Insert_cuenta_orden.php" onSubmit="return revisar()">
  <table width="623" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="620" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo2 Estilo3">INCLUIR CUENTA AL COMPROBANTE DE LA ORDEN </span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        ...
        <tr>
          <td><span class="Estilo5"> </span>
            <table width="614" border="0">
              <tr>
                <td width="608"><span class="Estilo5">NOMBRE CUENTA : <input class="Estilo10" name="txtNombre_Cuenta" type="text" id="txtNombre_Cuenta" size="74" maxlength="250" readonly>
                </span></td>
              </tr>
            </table>  </td>
        </tr>
