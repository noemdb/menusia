...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGO (Catalogo Ordenes de Pago)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK href="../class/sia.css" type="text/css" rel="stylesheet">
<script language="JavaScript" type="text/JavaScript">
function cerrar_catalogo(mnro_orden,mfecha,mced_rif,mnomb){
...
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        $criterio = "where (anulado='N')"; $txt_criterio ="";
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Ordenes de Pago</font>";$pagina=1; $inicio=1; $final=1; $numPags=1;
              ...
              if ($_GET["orden"]==""){$orden="nro_orden,tipo_causado";}else{$orden=$_GET["orden"];}  $tamPag=10;
                ...
                $descripcion=$registro["concepto"]; $sfecha=$registro["fecha"]; $func_inv=$registro["func_inv"];
...
?>
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:cerrar_catalogo('<? echo $registro["nro_orden"];?>','<? echo $fecha;?>','<? echo $registro["ced_rif"];?>','<? echo $registro["nombre"];?>');" >
...
<form action="Cat_ord_pago.php" method="get">
