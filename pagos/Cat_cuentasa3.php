...
function Llamar_cat(){var murl;  murl= "Cat_cuentasa3.php?criterio="+document.form1.criterio.value;  LlamarURL(murl);}
function cerrar_catalogo(mcodigo,mnombre){
  window.opener.document.forms[0].txtcodigo3.value = mcodigo;
  window.opener.document.forms[0].txtcodigo3.focus();
  window.close();
}
...
<form  name="form1" action="Cat_cuentasa3.php" method="get" onSubmit="return revisar()">
<table border="0">
  <tr>
	<td>
