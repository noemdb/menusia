...
function Llamar_cat(){var murl;  murl= "Cat_cuentasd.php?criterio="+document.form1.criterio.value;  LlamarURL(murl);}
function cerrar_catalogo(mcodigo,mnombre){
  window.opener.document.forms[0].txtcod_cuentad.value = mcodigo;
  window.opener.document.forms[0].txtcod_cuentad.focus();
  window.close();
}
