...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGO (Catalogo de Estructura de Orden)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK  href="../class/sia.css" type="text/css" rel="stylesheet">
<script language="JavaScript" type="text/JavaScript">
function CargarUrl(mcodigo) {var murl;
   murl="Act_estructura_orden.php?Gcod_estructura="+mcodigo;
...
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron resultados</font>";$pagina=1; $inicio=1; $final=1; $numPags=1; 
              ...
              if ($_GET["orden"]!=""){$orden=$_GET["orden"];}else{$orden="cod_estructura";} $tamPag=15;				
...
<form  name="form1" action="Cat_act_estructura.php" method="get">
<table border="0" width="900">
  <tr>
	...
	<td width="100" >&nbsp;</td>
	<td width="100" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onClick="javascript:LlamarURL('Act_estructura_orden.php')";
        onMouseOut="this.style.backgroundColor='#EAEAEA'"o"];" height="20" align="center" bgcolor=#EAEAEA><a class=menu href="Act_estructura_orden.php">Menu Anterior</a></div></td>
    <td width="100" >&nbsp;</td>
