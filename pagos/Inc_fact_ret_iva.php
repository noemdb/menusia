...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGOS (Incluir Factura Comprobante IVA)</title>
...
var mmonto; var miva;  var mret;
   mmonto=document.form1.txtmontob.value;  mmonto=cambia_punto_coma(mmonto); document.form1.txtmontob.value=mmonto;   
...
var mmonto; var miva;  var mret; 
   mmonto=document.form1.txttasa.value;  mmonto=cambia_punto_coma(mmonto); document.form1.txttasa.value=mmonto;
   mmonto=quitaformatomonto(mform.txtmontob.value);  miva=quitaformatomonto(mform.txttasa.value);    mret=quitaformatomonto(mform.txtretenc.value);
   mmonto=(mmonto*1);miva=(miva*1);mret=(mret*1);  miva=(mmonto*(miva/100)); mret=(miva*(mret/100)); miva=Math.round(miva*100)/100;   mret=Math.round(mret*100)/100;
   mform.txtmontoi.value=miva;  mform.txtmontoi.value=daformatomonto(mform.txtmontoi.value);
   mform.txtmontor.value=mret;  mform.txtmontor.value=daformatomonto(mform.txtmontor.value);
...
var mmonto; var miva;  var mret;
   mmonto=document.form1.txtmontoi.value;  mmonto=cambia_punto_coma(mmonto); document.form1.txtmontoi.value=mmonto;  
...
var mmonto; var miva;  var mret;
   mmonto=document.form1.txtretenc.value;  mmonto=cambia_punto_coma(mmonto); document.form1.txtretenc.value=mmonto;     
  ...
  <table width="745" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="741" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">FACTURA COMPROBANTE IVA</span></td>
        </tr>
        <tr>
          <td><table width="729" >
            <tr>
        ...
        <tr>
          <td><table width="733" border="0">
              <tr>
                ...
                <td width="195"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto"  size="15" maxlength="15" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)"  value="<? echo $monto ?>"> </span></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="737" border="0">
            <tr>
              ...
              <td width="193"> <span class="Estilo5"><input class="Estilo10" name="txtmontos" type="text" id="txtmontos" size="20" maxlength="20" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)"  value="<? echo $montos ?>">  </span> </td>
               <td width="137"><span class="Estilo5">BASE IMPONIBLE :  </span></td>
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtmontob" type="text" id="txtmontob" size="20" maxlength="20" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)"  onchange="chequea_monto(this.form);"  value="<? echo $montob ?>">  </span></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="192"><span class="Estilo5"><input class="Estilo10" name="txttasa" type="text" id="txttasa" size="8" maxlength="8"  style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)" onchange="chequea_tasa(this.form);" value="<? echo $tasa_iva ?>"> </span></td>
              <td width="138"><span class="Estilo5">MONTO IVA : </span></td>
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtmontoi" type="text" id="txtmontoi" size="20" maxlength="20" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)" value="<? echo $montoi ?>"></span></td>
              </tr>
          </table> </td>
        </tr>
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="190"><span class="Estilo5"><input class="Estilo10" name="txtretenc" type="text" id="txtretenc" size="10" maxlength="10"  style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)" onchange="chequea_retenc(this.form);" value="<? echo $retenc ?>"> </span></td>
              <td width="139"><span class="Estilo5"> IVA RETENIDO : </span></td>
             <td width="203"><span class="Estilo5"><input class="Estilo10" name="txtmontor" type="text" id="txtmontor" size="15" maxlength="15" style="text-align:right" onFocus="encender(this)" onBlur="apaga_monto(this)"  value="<? echo $montor ?>"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td><p>&nbsp;</p></td> </tr>
