...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGOS (Detalles Comprobante Retencion IVA)</title>
...
<body>
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr> <td width="845">
<?php $sql="SELECT * FROM BAN029 where codigo_mov='$codigo_mov' order by length(tipo_retencion),tipo_retencion,nro_planilla"; $res=pg_query($sql);
?>
