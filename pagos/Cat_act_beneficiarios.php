...
function CargarUrl(mcodigo) {var murl;    murl="Act_beneficiarios.php?Gced_rif="+mcodigo; document.location = murl;}
</script></head>
<body>
...
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron resultados</font>";$pagina=1; $inicio=1; $final=1; $numPags=1; 
              ...
              if ($_GET["orden"]!=""){$orden=$_GET["orden"];}else{$orden="ced_rif";} $tamPag=15;				
