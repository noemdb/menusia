...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGOS (Detalles Incluir Retencion a la Estructura)</title>
<LINK  href="../class/sia.css" type="text/css" rel="stylesheet">
</head>
<script language="JavaScript" type="text/JavaScript">
function Llama_Modificar(codigo_mov,tipo_ret,tipo,referencia,codigo,fuente){
var murl;
  if (codigo=="") {alert("Codigo Presupuestario debe ser Seleccionada");}
  else{ murl="Mod_ret_est.php?codigo_mov="+codigo_mov+"&tipo_ret="+tipo_ret+"&tipo="+tipo+"&referencia="+referencia+"&codigo="+codigo+"&fuente="+fuente; document.location=murl;}
}
</script>
<body>
