...
function Llamar_cat(){var murl;
  murl= "Cat_cod_presupuestarioh.php?criterio="+document.form1.criterio.value;
  LlamarURL(murl);
}
function cerrar_catalogo(mcodigo,mnombre){
  window.opener.document.forms[0].txtcod_partidah.value = mcodigo;
  window.opener.document.forms[0].txtcod_partidah.focus();
  window.close();
}
...
<form  name="form1" action="Cat_cod_presupuestarioh.php" method="get" onSubmit="return revisar()">
<table border="0">
  <tr>
	<td>
