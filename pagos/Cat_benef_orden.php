...
function cerrar_catalogo(mced_rif,mnombre,mtipoorden,mdestipoorden){
  ...
  window.opener.document.forms[0].txttipo_orden.value = mtipoorden;
  window.opener.document.forms[0].txtdes_tipo_orden.value = mdestipoorden;
...
<?
  ...
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:cerrar_catalogo('<? echo $registro["ced_rif"]; ?>','<? echo $nombre; ?>','<? echo $registro["tipo_orden"]; ?>','<? echo $registro["des_tipo_orden"]; ?>');" >
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><? echo $registro["ced_rif"]; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><? echo $nombre; ?></b></font></td>
     </tr>
<?}}echo "</table>"; }?>
<br>
...
<form action="Cat_benef_orden.php" method="get">
