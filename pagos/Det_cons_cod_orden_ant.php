...
<body>
 <table width="1610" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td width="1610">
       <?php
if (!$_GET){$criterio='';$tipo_causado=''; $referencia_caus='';} else{$criterio=$_GET["clave"];$referencia_caus=substr($criterio,0,8);  $tipo_causado=substr($criterio,8,4);}
$sql="SELECT * FROM codigos_ord_ant where tipo_causado='$tipo_causado' and nro_orden='$referencia_caus' order by cod_presup";
$res=pg_query($sql);
?>
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           ...
           <td width="120" align="left"><?php  echo $registro["cod_contable"]; ?></td>
