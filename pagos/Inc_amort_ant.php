...
function llamar_anterior(){ document.location ='Det_inc_comp_orden.php?codigo_mov=<?echo $codigo_mov?>'; }
function revisar(){
...
?>
<body>
<form name="form1" method="post" action="update_amort_ant.php" onSubmit="return revisar()">
