...
function Llamar_cat(){var murl;  murl= "Cat_cuentash.php?criterio="+document.form1.criterio.value;  LlamarURL(murl);}
function cerrar_catalogo(mcodigo,mnombre){
  window.opener.document.forms[0].txtcod_cuentah.value = mcodigo;
  window.opener.document.forms[0].txtcod_cuentah.focus();
  window.close();
}
