...
function cerrar_catalogo(mtipo_caus,mnro_orden,mnomb_abrev){
...
<body>
<?php 
        $criterio = "where (anulado='N') and (Status='N') and (afecta_presu='S')"; $txt_criterio = "";
...
?>
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:cerrar_catalogo('<?php  echo $registro["tipo_causado"];?>','<?php  echo $registro["nro_orden"];?>','<?php  echo $registro["nombre_abrev_caus"];?>');" >
...
<form action="Cat_orden_pago.php" method="get">
