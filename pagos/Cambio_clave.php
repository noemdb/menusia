...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGO  (Cambio de Clave)</title>
        ...
        <tr>
          <td><table width="520">
            <tr>
              ...
              <td width="300"><input class="Estilo10" name="txtnombre_usuario" type="text"  id="txtnombre_usuario" size="20" maxlength="20" readonly value="<? echo $usuario_sia ?>"></td>
               </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input class="Estilo10" name="txtClaveA" type="password" id="txtClaveA" size="12" maxlength="20" value=" " onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input class="Estilo10" name="txtClaveN" type="password" id="txtClaveN" size="12" maxlength="12" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input class="Estilo10" name="txtClaveNR" type="password" id="txtClaveNR" size="12" maxlength="12" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
