...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">AUDITORIA DE PAGOS </div></td>
...
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        $criterio = " where modulo='01'"; if ($_GET){if ($_GET["criterio"]!=""){  $txt_criterio = $_GET["criterio"]; $txt_criterio = strtoupper ($txt_criterio);
        $criterio = " where modulo='01' and (usuario_sia like '%" . $txt_criterio . "%' or descrip_doc like '%" . $txt_criterio . "%' or operacion like '%" . $txt_criterio . "%')";    }}
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Movimientos</font>";
                ...
                echo "<th bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=descrip_doc&criterio=".$txt_criterio."'>Descripcion</a></th>";
                $linea=0;          $Salir=false;
...
<form action="Auditoria_pagos.php" method="get">
<table width="800" height="50" border="0" >
  <tr>
    ...
    <td width="200"> <input name="btImprimir" type="button" id="btImprimir" value="Imprimir" onClick="javascript:window.open('../pagos/rpt/imprimir_auditoria.php?criterio=<? echo $txt_criterio ?>&fechaop=<? echo $fecha_aud ?>');" >
	</td>
  </tr>
  <tr>
