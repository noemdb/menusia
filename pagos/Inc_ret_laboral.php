...
var Valido=true;
   ...
   if(f.txtmonto_retencion.value=="0"){alert("Monto Retencion no Valido");return false;}
...
$sql="select * from RETENCIONES where ret_grupo='L' or ret_grupo='F' order by tipo_retencion";$res=pg_query($sql);
        ...
        <tr>
          <td><table width="737">
            <tr>
              ...
              <td width="43"><input class="Estilo10" name="bttiporet" type="button" id="bttiporet" title="Abrir Catalogo Tipos de Retencion" onclick="VentanaCentrada('Cat_tipo_ret_laboral.php?criterio=','SIPAP','','750','500','true')" value="..."></td>
