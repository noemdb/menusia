<?php include ("../class/funciones.php");$equipo=getenv("COMPUTERNAME");$cta_pasivo='2-1-1';
...
<body>
<form name="form1" method="post" action="Insert_pasivos_est.php" onSubmit="return revisar()">
            ...
            <table width="614" border="0">
              <tr>
                <td width="608"><span class="Estilo5">NOMBRE CUENTA :
                    <input class="Estilo10" name="txtNombre_Cuenta" type="text" id="txtNombre_Cuenta" size="74" maxlength="250" readonly>
                </span></td>
              </tr>
            </table>            </td>
        </tr>
