...
if (!$_GET){$nro_orden='';$tipo_causado='';$comp_automatico='N'; $fecha_fin=$fecha_hoy; }  
else {$nro_orden=$_GET["txtnro_orden"];$tipo_causado=$_GET["txttipo_causado"]; $comp_automatico=$_GET["comp_aut"]; $fec_fin_e=$_GET["fecha_fin"]; $fecha_fin=formato_ddmmaaaa($fec_fin_e);  }
...
function revisar(){var f=document.form1; var r; var Valido=true;
    ...
    if(f.txtdescrip_anu.value==""){alert("Descripcion de Anulacion no puede estar Vacia"); return false; }  else{f.txtdescrip_anu.value=f.txtdescrip_anu.value.toUpperCase();}
    ...
    if (r==true) {r=confirm("Esta Realmente seguro en Anular la Orden de Pago ?");  if (r==true) {Valido=true;} else {return false;}  }
...
<body>
<form name="form1" method="post" action="Anu_orden.php" onSubmit="return revisar()">
  <table width="714" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="707" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">ANULAR ORDEN DE PAGO </span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
            ...
            <td><span class="Estilo5"> </span>
                <table width="680" border="0" align="center">
                  <tr>
                    ...
                    <td width="494"><span class="Estilo5"> <textarea name="txtdescrip_anu" cols="65" rows="2" onFocus="encender(this)" onBlur="apagar(this)"  id="txtdescrip_anu"></textarea>
                    </span></td>
                  </tr>
              </table></td>
          </tr>
