...
if (!$_GET){$mcod_m="PAG001".$equipo;$codigo_mov=substr($mcod_m,0,49);$ref_comp="N";$desest="";$codest="";}else{$codigo_mov=$_GET["codigo_mov"];$ref_comp=$_GET["ref_comp"];$desest="";$codest="";}
?>
...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGO (Cargar Estructura de Orden)</title>
...
function llama_cat_ced(mform){  var mcod_est; var murl;  var mdet_trab;
   mcod_est=mform.txtcod_est.value;  mdet_trab=mform.txtdet_trab.value;
  if(mdet_trab=="SI"){  murl='Ced_estructuras.php?cod_est='+mcod_est+'&criterio=';   VentanaCentrada(murl,'SIA','','750','500','true');}
return true;}
        ...
        <tr>
          <td><table width="614" border="0">
              <tr>
                ...
                <td width="69"><span class="Estilo5"><input name="txtcod_est" type="text" id="txtcod_est" title="Registre el Codigo de la Estructura"  size="10" maxlength="10" onFocus="encender(this); " onBlur="apagar(this);" value="<?echo $codest?>">   </span></td>
                <td width="432"><input name="btCatest" type="button" id="btCatest" title="Abrir Catalogo Codigo de Estructuras"  onclick="VentanaCentrada('Cat_estructura.php?codigo_mov=<?echo $codigo_mov?>&ref_comp=<?echo $ref_comp?>','SIA','','750','500','true')" value="..."></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><span class="Estilo5"> </span>
            <table width="740" border="0">
              <tr>
                ...
                <td width="589"><span class="Estilo5"><input name="txtdescripcion_est" type="text" id="txtdescripcion_est" size="95" maxlength="250" readonly value="<?echo $desest?>"></span></td>
              </tr>
            </table> </td>
        </tr>
        <tr>
          <td><span class="Estilo5"> </span>
            <table width="740" border="0">
              <tr>
			    <td width="180"><span class="Estilo5">TRABAJADOR ESPECIFICO :</span></td>
                <td width="200"><span class="Estilo5"><select name="txtdet_trab" size="1" id="txtdet_trab"><option selected>NO</option>  <option >SI</option> </select> </span></td>
                  
                <td width="150"><span class="Estilo5">CEDULA TRABAJADOR :</span></td>
                <td width="130"><span class="Estilo5"><input name="txtced_trab" type="text" id="txtced_trab" size="10" maxlength="10" onFocus="encender(this); " onBlur="apagar(this);"></span></td>
                <td width="60"><input name="btCatest" type="button" id="btCatest" title="Abrir Catalogo Cedulas de la Estructura"  onClick="javascript:llama_cat_ced(this.form)"  value="..."></td>
                 <td width="20"><input name="txtnombre_trab" type="hidden" id="txtnombre_trab"></td>       
