...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGO (Reporte Relacion Listado Ordenes de Fecha)</title>
        ...
        <tr>
          <td height="18" colspan="3"><table width="776" border="0">
            <tr>
              ...
              <td width="74"><span class="Estilo5"><input class="Estilo10" name="txttipo_ordend" type="text" id="txttipo_ordend" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tipo_orden_d?>" size="6" maxlength="4" class="Estilo5"></span></td>
              <td width="146"><span class="Estilo5"><input class="Estilo10" name="Catalogo1" type="button" id="Catalogo1" title="Abrir Catalogo de Tipo Orden" onClick="VentanaCentrada('../Cat_tipo_ordend.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
              <td width="77"><span class="Estilo5"><input class="Estilo10" name="txttipo_ordenh" type="text" id="txttipo_ordenh" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tipo_orden_h?>" size="6" maxlength="4" class="Estilo5"></span></td>
              <td width="306"><span class="Estilo5"><input class="Estilo10" name="Catalogo2" type="button" id="Catalogo2" title="Abrir Catalogo de Tipo Orden" onClick="VentanaCentrada('../Cat_tipo_ordenh.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
