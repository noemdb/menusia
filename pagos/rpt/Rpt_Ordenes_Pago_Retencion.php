...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGO (Reporte Relacion Ordenes de Pago Retencion)</title>
...
return true;}
function Llama_Rpt_Ordenes_Pago_Reten(murl){var url;var r;var bene;var monto;
  ...
  r=confirm("Desea Generar el Reporte Ordenes Pago Retencion?");
  if (r==true)
  {
    url=murl+"?tipo_retencion_d="+document.form1.txttipo_reten_d.value+"&tipo_retencion_h="+document.form1.txttipo_reten_h.value+"&nro_orden_d="+document.form1.txtnro_orden_d.value+"&nro_orden_h="+document.form1.txtnro_orden_h.value+"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value+"&clasificacion_d="+document.form1.txtclasificacion_d.value+"&clasificacion_h="+document.form1.txtclasificacion_h.value+"&informacion_beneficiario="+bene+"&imprimir_monto="+monto+"&fecha_cancelada_d="+document.form1.txtFecha_cancd.value+"&fecha_cancelada_h="+document.form1.txtFecha_canch.value;
    window.open(url,"Reporte Ordenes Pago Retencion")
  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE ORDENES DE PAGO RETENCION</div></td>
      ...
      <td width="958" height="659" align="center" valign="top"><table width="783" height="494" border="0" cellpadding="0" cellspacing="0">
          ...
          <td height="19" colspan="3" align="center" class="Estilo16"><table width="776" border="0">
            <tr>
              ...
              <td width="118"><span class="Estilo5">
                <input name="Catalogo1" type="button" id="Catalogo1" title="Abrir Catalogo de Tipos de Retenciones" onClick="VentanaCentrada('../Cat_Tipo_Retencionesd.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
              ...
              <td width="253"><span class="Estilo5">
                <input name="Catalogo2" type="button" id="Catalogo2" title="Abrir Catalogo de Tipos de Retenciones" onClick="VentanaCentrada('../Cat_Tipo_Retencionesh.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="18" colspan="3"><table width="782" border="0">
            <tr>
              <td width="184" height="26"><p align="left">CLASIFICACION:</p></td>
              <td width="230"><span class="Estilo5">
                <select name="txtclasificacion_d" id="txtclasificacion_d">
                  <option></option>
              ...
              <td width="354"><span class="Estilo5">
                <select name="txtclasificacion_h" id="txtclasificacion_h">
        ...
        <tr>
          <td height="18" colspan="3"><table width="771" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="350">IMPRIMIR MONTO OBJETO :</td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="18" colspan="3"><table width="767" border="0" cellspacing="0" cellpadding="0">
            ...
            NO </label></td>
              ...
              <td width="281"><table width="112" height="30" border="1">
                <tr>
                  <td width="113" valign="top"><label>
                    <input name="opimprimir_monto" type="radio" value="S">
      SI </label>
                      <label>
                      <input name="opimprimir_monto" type="radio" value="N" checked>
      NO </label></td>
                </tr>
              </table></td>
            </tr>
        ...
        <tr>
          <td height="18" colspan="3"><table width="771" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="374">IMPRIMIR INFORMACION CANCELADA:</td>
            </tr>
          </table></td>
        </tr>
        <tr>
      ...
      TODAS</label>
        ...
        LIBERADAS</p></td>
          ...
          <td width="281"><table width="112" height="30" border="1">
            <tr>
              <td width="113" valign="top"><label>
                <input name="opimprimir_canc" type="radio" value="S">
      SI </label>
                  <label>
                  <input name="opimprimir_canc" type="radio" value="N" checked>
      NO </label></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="89" colspan="3"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td>
                    <div align="center">
                      <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Ordenes_Pago_Reten('Rpt_Ordenes_Pago_Reten.php');">
                      </div></td>
              <td>
                    <div align="center">
