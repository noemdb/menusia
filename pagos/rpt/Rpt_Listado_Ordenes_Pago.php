...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGOS (Reporte Listado Ordenes de Pagos)</title>
        ...
        <tr>
          <td height="30" colspan="3"><table width="780" border="0">
            <tr>
              ...
              <td width="155"><span class="Estilo5"><input class="Estilo10" name="catadocd" type="button" id="catadocd" title="Abrir Catalogo Documentos causados" onClick="VentanaCentrada('../Cat_doc_causd.php?criterio=','SIPAP','','750','500','true')" value="..."> </span></td>
              ...
              <td width="240"><span class="Estilo5"> <input class="Estilo10" name="catadoch" type="button" id="catadoch" title="Abrir Catalogo  Documentos causados" onClick="VentanaCentrada('../Cat_doc_caush.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="18" colspan="3"><table width="782" border="0">
            <tr>
              ...
              <td width="91"><span class="Estilo5"><input class="Estilo10" name="Catcedd" type="button" id="Catcedd" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosd.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
              ...
              <td width="192"><span class="Estilo5"><input class="Estilo10" name="Catcedh" type="button" id="Catcedh" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosh.php?criterio=','SIPAP','','750','500','true')" value="...">    </span></td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="18" colspan="3"><table width="782" border="0">
            <tr>
              ...
              <td width="126"><span class="Estilo5"><input class="Estilo10" name="Catalogo1" type="button" id="Catalogo1" title="Abrir Catalogo de Tipo Orden" onClick="VentanaCentrada('../Cat_tipo_ordend.php?criterio=','SIPAP','','750','500','true')" value="...">  </span></td>
              ...
              <td width="233"><span class="Estilo5"><input class="Estilo10" name="Catalogo2" type="button" id="Catalogo2" title="Abrir Catalogo de Tipo Orden" onClick="VentanaCentrada('../Cat_tipo_ordenh.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr> <td height="18" colspan="3">&nbsp;</td>  </tr>        
