...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="01"; $opcion="03-0000075"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGO (Reporte Listado Retencion IVA)</title>
            ...
            <table width="950" height="290" border="0">
              <tr>
                <td width="958" height="286" align="center" valign="top"><table width="783" height="214" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="19" colspan="4"><table width="776" border="0">
                          <tr>
                            <td width="210">&nbsp;</td>
                            <td width="174"><span class="Estilo13">DESDE</span></td>
                            <td width="378"><span class="Estilo13">HASTA</span></td>
                          </tr>
                      </table></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td height="19" colspan="4"><table width="776" border="0">
                          <tr>
                            ...
                            <td width="174"><span class="Estilo5"> <input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)" class="Estilo5">
                ...
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario1')"  /></span></td>
                            <td width="378" align="center"><div align="left"><span class="Estilo5">
                ...
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario2')"  /></span></div></td>
                    ...
                    <tr>
                      <td width="216" height="26" class="Estilo5"><p align="left">NRO. COMPROBANTE:</p></td>
                      <td width="180"><span class="Estilo5"><input class="Estilo10" name="txtnum_comprobante_d" type="text" id="txtnum_comprobante_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $comprobante_d?>" size="10" maxlength="8" class="Estilo5"></span></td>
                      <td width="374"><span class="Estilo5"><input class="Estilo10" name="txtnum_comprobante_h" type="text" id="txtnum_comprobante_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $comprobante_h?>" size="10" maxlength="8" class="Estilo5"></span></td>
                      <td width="155"><span class="Estilo5"></span></td>
                    </tr>
                    <tr>
                      <td height="19" colspan="4">&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="19" colspan="4"><table width="782" border="0">
                          <tr>
                            <td width="211" height="26" class="Estilo5"><p align="left">CEDULA /RIF :</p></td>
                            <td width="97"><span class="Estilo5"><input class="Estilo10" name="txtcedula_d" type="text" id="txtcedula_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_d?>" size="15" maxlength="12" class="Estilo5"></span></td>
                            <td width="71"><span class="Estilo5"><input class="Estilo10" name="Catalogo1" type="button" id="Catalogo14" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosd.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
                            <td width="106"><span class="Estilo12"><span class="Estilo5"><input class="Estilo10" name="txtcedula_h" type="text" id="txtcedula_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_h?>" size="12" maxlength="15" class="Estilo5"></span></span></td>
                            <td width="149"><span class="Estilo5"><input class="Estilo10" name="Catalogo2" type="button" id="Catalogo24" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosh.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
                            <td width="122"><span class="Estilo5"></span></td>
                          </tr>
                      </table></td>
                    </tr>
					<tr>
