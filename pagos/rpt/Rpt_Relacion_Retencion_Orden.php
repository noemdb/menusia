...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="01"; $opcion="03-0000024"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGO (Reporte Relacion Retencion/Ordenes)</title>
...
return true;}
function Llama_Rpt_Ordenes_Pago_Retencion(murl){var url;var r;var st;
  ...
  r=confirm("Desea Generar el Reporte Relacion Retenciones/Ordenes ?");
  if (r==true) {url=murl+"?tipo_retencion_d="+document.form1.txttipo_reten_d.value+"&tipo_retencion_h="+document.form1.txttipo_reten_h.value+"&numero_orden_d="+document.form1.txtnro_orden_d.value+"&numero_orden_h="+document.form1.txtnro_orden_h.value+"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value+"&status_orden="+st+"&tipo_rpt="+document.form1.tipo_rpt.value;
    window.open(url,"Reporte Relacion Retenciones/Ordenes")
  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE RELACION RETENCIONES/ORDENES</div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="430" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="400">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
		...
		<tr>
		  <td height="19"><table width="771" border="0">
			  <tr>
				...
				<td width="585"><span class="Estilo5"> <select class="Estilo10" name="tipo_rpt" id="tipo_rpt">
        ...
        <tr>
          <td height="59" colspan="3"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Ordenes_Pago_Retencion('Rpt_Retenciones_Ordenes.php');"> </div></td>
