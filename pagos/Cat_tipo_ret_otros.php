...
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        $criterio = "where (ret_grupo='O' or ret_grupo='T' or ret_grupo='R')"; $txt_criterio = "";
        if ($_GET){if ($_GET["criterio"]!=""){  $txt_criterio = $_GET["criterio"];  $txt_criterio = strtoupper ($txt_criterio);
        $criterio = " where (ret_grupo='O'  or ret_grupo='T' or ret_grupo='R') and (tipo_retencion like '%" . $txt_criterio . "%' or descripcion_ret like '%" . $txt_criterio . "%')";
        }}
...
<form action="Cat_tipo_ret_otros.php" method="get">
