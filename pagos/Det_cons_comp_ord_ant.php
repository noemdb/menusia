...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGO (Detalles Cuentas del Comprobante)</title>
<LINK
...
$sql="SELECT * FROM cuentas_orden_ant where text(fecha)='$fecha' and referencia='$referencia' order by debito_credito desc,cod_cuenta";
$res=pg_query($sql);
?>
