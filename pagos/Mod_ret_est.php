...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGOS (Modificar Codigos en la Estructura)</title>
...
if ($registro=pg_fetch_array($res,0)){$tasa=$registro["tasa_retencion"];$monto_objeto=$registro["monto_objeto_ret"];
  $monto=$registro["monto_retencion"]; $descripcion_ret=$registro["descripcion_ret"];
  $concepto_ret=$registro["des_orden_ret"];$ced_rif=$registro["ced_rif_r"];$nombre=$registro["beneficiario_ret"];
  ...
  <table width="745" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="741" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">MODIFICAR RETENCI&Oacute;N DE LA ESTRUCTURA</span></td>
        </tr>
        <tr>
          <td><table width="738">
            <tr>
