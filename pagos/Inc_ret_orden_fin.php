...
function apaga_tasa(mthis){var mmonto;var mtasa; var msust;
   apagar(mthis);  mmonto=quitaformatomonto(document.form1.txtmonto_objeto.value);
...
function apaga_monto_ret(mthis){var mref; var mmonto;
   apagar(mthis);    mmonto=document.form1.txtmonto_retencion.value;  
   mmonto=camb_punto_coma(mmonto); document.form1.txtmonto_retencion.value=mmonto;
return true;}
function revisar(){
...
<body>
<form name="form1" method="post" action="Insert_ret_orden_fin.php" onSubmit="return revisar()">
  <table width="746" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="742" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">INCLUIR NUEVA RETENCION EN LA ORDEN FINANCIERA </span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><table width="737">
            <tr>
              ...
              <td width="46"><span class="Estilo5"><input name="txttipo_retencion" type="text" id="txttipo_retencion" size="4" maxlength="3"  onFocus="encender(this)" onBlur="apaga_tipo(this)"  onchange="chequea_tipo(this.form);">    </span></td>
              <td width="43"><input name="bttiporet" type="button" id="bttiporet" title="Abrir Catalogo Tipos de Retencion" onclick="VentanaCentrada('Cat_tipo_ret.php?criterio=','SIA','','750','500','true')" value="..."></td>
              <td width="497"><span class="Estilo5"><input name="txtdescripcion_ret" type="text" id="txtdescripcion_ret"  readonly  size="77">
              </span></td>
            </tr>
          </table></td>
        </tr>  
        <tr>
          <td><table width="733" border="0">
            <tr>
              ...
              <td width="57"><span class="Estilo5"><input name="txttasa" type="text" id="txttasa" size="5" maxlength="5"  style="text-align:right" onFocus="encender(this)" onBlur="apaga_tasa(this)" onchange="chequea_tasa(this.form);" onKeypress="return validarNum(event)"> </span></td>
        ...
        <tr>
          <td><table width="737" border="0">
            <tr>
              ...
              <td width="153"><span class="Estilo5"> <input name="txtced_rif" type="text" id="txtced_rif" size="20" maxlength="15"  onFocus="encender(this)" onBlur="apagar(this)"></span> </td>
              <td width="40"><span class="Estilo5"> <input name="btced_rif" type="button" id="btced_rif" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../presupuesto/Cat_beneficiarios.php?criterio=','SIA','','750','500','true')" value="..."></span></td>
              <td width="375"><span class="Estilo5"><input name="txtnombre" type="text" id="txtnombre" size="60" readonly> </span> </td>
            </tr>
          </table></td>
        </tr>
        <tr>
