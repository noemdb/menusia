...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGOS (Modificar Retenciones de Orden)</title>
...
function llamar_impimir(){var murl;var r;var f=document.form1;var tipo_p;
  tipo_p=f.txtplanilla.value;
  if(tipo_p=="00"){alert("Tipo de Planilla Invalida");}
  else{  murl="Desa Imprimir Planilla de Retencion ?";  r=confirm(murl);
    if(r==true){murl="/sia/pagos/rpt/Rpt_planilla_ret.php?nro_planilla=<?echo $nro_planilla?>&planilla=<?echo $planilla?>";
        dwindow.open(url);}
    }
}
    ...
    <tr>
      <td><table width="741" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="737">
            <tr>
              ...
              <td width="556"><span class="Estilo5"><input class="Estilo10" name="txtdescripcion_ret" type="text" id="txtdescripcion_ret"  readonly  size="85" value="<? echo $descripcion_ret ?>"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table width="733" border="0">
              <tr>
                <td width="106"><span class="Estilo5">TIPO PLANILLA :</span></td>
                                <?  if($planilla=="00"){?>
                <td width="12"><span class="Estilo5"><input class="Estilo10" name="txtplanilla" type="text" id="txtplanilla" title="Registre el tipo de Planilla" value="<? echo $planilla ?>"  size="2" maxlength="2" onFocus="encender(this)" onBlur="apagar(this)"  onchange="chequea_planilla(this.form);">  </span></td>
                <?  } else {?>
                ...
                <?  }?>
                <td width="315"><span class="Estilo5"><div id="desplan"><input class="Estilo10" name="txtdescripcion" type="text" id="txtdescripcion" size="50" value="<? echo $descripcion ?>" readonly> </div></span></td>
                <td width="103"><span class="Estilo5">NRO. PLANILLA :</span></td>
                                <?  if($planilla=="00"){?>
                <td width="62"><span class="Estilo5"><div id="nroplan">
        ...
        <tr>
          <td><table width="739" >
            <tr>
              ...
              <td width="151"><span class="Estilo5"><input class="Estilo10" name="txtmonto1" type="text" id="txtmonto1" size="20" maxlength="20" style="text-align:right"  onFocus="encender_monto(this)" onBlur="apaga_monto1(this)"  value="<? echo $monto1 ?>" onKeypress="return validarNum(event)"> </span></td>
              <td width="94"><span class="Estilo5">MONTO IVA: </span></td>
             <td width="126"><span class="Estilo5"><input class="Estilo10" name="txtmonto2" type="text" id="txtmonto2" size="15" maxlength="15" style="text-align:right"  onFocus="encender_monto(this)" onBlur="apaga_monto2(this)"  value="<? echo $monto2 ?>" onKeypress="return validarNum(event)"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr> <td><p>&nbsp;</p> </td> </tr>
