...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGOS (Catalogo Ordenes de Pago)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK  href="../class/sia.css" type="text/css" rel="stylesheet">
<script language="JavaScript" type="text/JavaScript">
function CargarUrl(mclave) {var murl;
   murl="Act_orden_pago_ant.php?Gcriterio=C"+mclave;   document.location = murl;
}
</script></head>
<body>
...
<?php       $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        }else{ if ($_GET["orden"]!=""){$orden=$_GET["orden"];}else{$orden="nro_orden,tipo_causado";} $tamPag=15;				
...
?>
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:CargarUrl('<?php  echo $registro["nro_orden"].$registro["tipo_causado"]; ?>');" >
    ...
    <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><?php  echo $registro["nombre"]; ?></b></font></td>
...
<form action="Cat_act_orden_pago_ant.php" method="get">
