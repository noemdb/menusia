...
function revisar(){var f=document.form1; var Valido=true;
   if(f.txtcod_banco.value==""){alert("C�digo de Banco no puede estar Vacio");return false;}
        ...
        <tr>
          <td><table width="614" border="0">
              <tr>
                ...
                <td width="100"><input name="btcod_banco" type="button" id="btcod_banco" title="Abrir Catalogo de Bancos" onclick="VentanaCentrada('../bancos/Cat_bancos.php?criterio=','SIPAP','','750','500','true')" value="..."></td>
          ...
          <td><table width="614" border="0">
              <tr>
                ...
                <td width="60"><span class="Estilo5"><input name="txttipo_movimiento" type="text" id="txttipo_movimiento"   size="4" maxlength="4" onFocus="encender(this)" onBlur="apagar(this)"></span></td>
                 <td width="55"><input name="bttipo_mov" type="button" id="bttipo_mov" title="Abrir Catalogo Tipos de Movimiento" onclick="VentanaCentrada('../bancos/Cat_tipo_mov_inc.php?criterio=','SIPAP','','750','500','true')" value="..."></td>
