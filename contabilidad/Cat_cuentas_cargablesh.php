...
function Llamar_cat(){var murl;
  murl= "Cat_cuentas_cargablesh.php?criterio="+document.form1.criterio.value;
  LlamarURL(murl);
}
function cerrar_catalogo(mcuenta,mnombre){
  window.opener.document.forms[0].txtCodigo_Cuenta_H.value=mcuenta;
  window.opener.document.forms[0].txtCodigo_Cuenta_H.focus();
  window.close();
}
...
<form  name="form1" action="Cat_cuentas_cargablesh.php" method="get" onSubmit="return revisar()">
<table border="0">
  <tr>
	<td>
