...
function cerrar_catalogo(tipo){
  window.opener.document.forms[0].txttipo_asientoh.value = tipo;
  window.opener.document.forms[0].txttipo_asientoh.focus();
  window.close();
}
</script>
...
<html>
<head>
<title>SIPAP CONTABILIDAD FINANCIERA (Catalogo plan de Cuentas)</title>
...
<form action="Cat_tipo_asientoh.php" method="get">
