...
function Llama_Eliminar(){var murl; var r;
  ...
  if (r==true) {r=confirm("Esta Realmente seguro en Eliminar la Cuenta del comprobante ?");
    if (r==true) { murl="Delete_cuenta_comp.php?codigo_mov="+Gcodigo_mov+"&debito_credito="+Gdebito_credito+"&cod_cuenta="+Gcuenta;   document.location=murl;}    }
   else { url="Cancelado, no elimino"; }
  }
}
function Llama_Modificar(){var murl;
  if (Gcuenta=="") {alert("Cuenta debe ser Seleccionada");}
  else {murl="Mod_cuenta_comp.php?codigo_mov="+Gcodigo_mov+"&debito_credito="+Gdebito_credito+"&cod_cuenta="+Gcuenta;  document.location=murl;}
}
function Llama_Cargar(){var murl; var r;
  r=confirm("Desea Cargar Cuentas de otro comprobante ?");
  if (r==true) {murl="Carga_cuenta_comp.php?codigo_mov="+Gcodigo_mov;  document.location=murl;}
}
</script>
</head>
<body>
    ...
    <tr>
      <td align="left"><table width="870" border="0" align="left">
          <tr>
            ...
            <td width="180" align="center"><input name="btRefrescar" type="button" id="btRefrescar" onClick="JavaScript:self.location.reload();" value="Refrescar" title="Refrescar las Cuentas del Comprobante"></td>
          </tr>
      </table></td>
    </tr>
    <tr height="10">
