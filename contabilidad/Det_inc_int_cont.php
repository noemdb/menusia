...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF' "o"];" >
		   ...
		   <td width="30" align="left"><?php  echo $registro["num_linea"]; ?></td>
		   <td width="80" align="left"><?php  echo $registro["num_cuenta"]; ?></td>
		   <td width="120" align="left"><?php  echo $registro["cod_cuenta"]; ?></td>
           <td width="280" align="left"><?php  echo $registro["campo_str1"]; ?></td>		   
           <td width="150" align="left"><?php  echo $des_concepto; ?></td>
		   <td width="200" align="left"><?php  echo $registro["des_referencia"]; ?></td>
		   <td width="80" align="center"><?php  echo $registro["referencia_r"]; ?></td>
           <td width="10" align="center"><?php  echo $registro["debito_credito"]; ?></td>
           <td width="100" align="right"><?php  echo $monto_asiento; ?></td>
		   <td width="40" align="center"><?php  echo $registro["tipo_doc"]; ?></td>
         </tr>
         <?php } $balance=$t_debe-$t_haber; $balance=formato_monto($balance);
