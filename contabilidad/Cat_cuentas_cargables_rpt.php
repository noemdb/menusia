...
function Llamar_cat(){var murl;  murl= "Cat_cuentas_cargables.php?criterio="+document.form1.criterio.value;
  LlamarURL(murl);
}
function cerrar_catalogo(mcuenta,mnombre){
  window.opener.document.forms[0].txtCodigo_Cuenta.value=mcuenta;
 // window.opener.document.forms[0].txtNombre_Cuenta.value=mnombre;
...
<form  name="form1" action="Cat_cuentas_cargables_rpt.php" method="get" onSubmit="return revisar()">
<table border="0">
  <tr>
	<td>
