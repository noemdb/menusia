...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="03"; $opcion="03-0000065"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP CONTABILIDAD (Reporte Estado de Resultado)</title>
...
function Llama_Rpt_Balance_General(murl){
var url; var r;  var imp;  var turl;  turl=murl;
  if(document.form1.opimprimir[0].checked==true){imp="S";}
  if(document.form1.opimprimir[1].checked==true){imp="N";}
  r=confirm("Desea Generar el Reporte Estado de Resultado ?");
  if (r==true){ url=turl+"?periodo="+document.form1.txtperiodo.value+"&nivel="+document.form1.txtnivel.value+"&vimprimir="+imp+"&tipo_rep="+document.form1.txttipo_rep.value;
    window.open(url,"Reporte Estado de Resultado")
  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE ESTADO DE RESULTADO </div></td>
    ...
    <tr>
      <td width="958" height="283" align="center" valign="top"><table width="783" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> <td colspan="2"><table width="773" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="118">&nbsp;</td>
            <td width="338"><span class="Estilo5">PERIODO:</span></td>
        ...
        <tr> <td colspan="2">&nbsp;</td></tr>
          ...
          <tr>
            <td width="119">&nbsp;</td>
            <td width="334"><span class="Estilo5">NIVEL PARA EL REPORTE:</span></td>
            <td width="187"><select name="txtnivel" size="1" id="select">
          ...
          <tr>
            <td width="120">&nbsp;</td>
            <td width="333"><span class="Estilo5">IMPRIMIR CUENTAS SIN MOVIMIENTOS: </span></td>
            <td width="187"><table width="120" height="30" border="1">
              <tr>
        ...
        <tr>
          <td colspan="2"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Balance_General('Rpt_Estado_Res.php');"></div></td>
