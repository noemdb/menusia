...
<html>
<head>
<title>SIPAP CONTABILIDAD (Reporte Informes Contables)</title>
      ...
      <td width="958" align="center" valign="top"><table width="783" border="0" cellspacing="0" cellpadding="0">
		...
		<tr> <td colspan="2"><table width="773" border="0" cellpadding="0" cellspacing="0">
          <tr>
           ...
           <td width="489"><input class="Estilo10" name="Catalogo1" type="button" id="Catalogo1" title="Abrir Catalogo de Informes" onClick="VentanaCentrada('../Cat_informed.php?criterio=','SIPAP','','750','500','true')" value="..."></td>
		</tr>
        </table></td></tr>
		<tr>
          <td colspan="2">&nbsp;</td>
