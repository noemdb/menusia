...
<html>
<head>
<title>SIPAP CONTABILIDAD (Reporte Comparativo Contabilidad/Presupuesto)</title>
				  ...
				  <td colspan="2"><div align="center">
					<table width="785" border="0" align="center" cellpadding="0" cellspacing="0">
					  <tr>
						...
						<td width="261"><span class="Estilo5"><input class="Estilo10" name="Catalogo3" type="button" id="Catalogo3" title="Abrir Catalogo de Cuentas" onClick="VentanaCentrada('../Cat_cuentas_cargablesd.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
