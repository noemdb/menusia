...
<html>
<head>
<title>SIPAP CONTABILIDAD FISCAL (Reporte Balance General)</title>
...
function Llama_Rpt_Balance_General(murl){var url; var r;  var imp;  var turl;  turl=murl;
  ...
  if (r==true){ url=turl+"?periodo="+document.form1.txtperiodo.value+"&nivel="+document.form1.txtnivel.value+"&vimprimir="+imp+"&tipo_rep="+document.form1.txttipo_rep.value+"&bal_cierre="+document.form1.txtbal_cierre.value;
       ...
       <tr> <td colspan="2">&nbsp;</td> </tr>
        ...
        <tr> <td colspan="2"><table width="773" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="250" align="left"><span class="Estilo5"><select name="txttipo_rep" size="1" id="txttipo_rep" onFocus="encender(this)" onBlur="apagar(this)">
            ...
            <td width="143"><span class="Estilo5">BALANCE DE CIERRE :</span></td>
