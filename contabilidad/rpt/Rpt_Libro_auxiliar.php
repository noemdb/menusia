        ...
        <tr>
          <td colspan="2"><table width="748" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="221" align="left"><span class="Estilo5"><input class="Estilo10" name="txtCodigo_Cuenta_D" type="text" id="txtCodigo_Cuenta_D3" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cod_cuenta_d?>" size="25" maxlength="24"></span></td>
              <td width="59" align="left"><span class="Estilo5"><input class="Estilo10" name="Catalogo3" type="button" id="Catalogo33" title="Abrir Catalogo de Cuentas" onClick="VentanaCentrada('../Cat_cuentas_cargablesd.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
              <td width="54" align="left"><span class="Estilo5">HASTA :</span></td>
              <td width="215" align="center"> <div align="left"><span class="Estilo5"><input class="Estilo10" name="txtCodigo_Cuenta_H" type="text" id="txtCodigo_Cuenta_H2" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cod_cuenta_h?>" size="25" maxlength="24"></span></td>
              <td width="78" align="left"><span class="Estilo5"> <input class="Estilo10" name="Catalogo4" type="button" id="Catalogo4" title="Abrir Catalogo de Cuentas" onClick="VentanaCentrada('../Cat_cuentas_cargablesh.php?criterio=','SIPAP','','750','500','true')" value="...">    </span></td>
            </tr>
          </table></td>
        </tr>
