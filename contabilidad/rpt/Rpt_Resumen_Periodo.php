...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="03"; $opcion="03-0000030"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 if ($filas>0){$reg=pg_fetch_array($res); $Mcamino=$reg["campo607"].$reg["campo608"].$reg["campo609"].$reg["campo610"].$reg["campo611"].$reg["campo612"].$reg["campo613"].$reg["campo614"].$reg["campo615"].$reg["campo616"].$reg["campo617"].$reg["campo618"].$reg["campo619"].$reg["campo620"].$reg["campo621"].$reg["campo622"].$reg["campo623"].$reg["campo624"].$reg["campo625"].$reg["campo626"]; }
}$posicion=strpos($Mcamino,'S');if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> document.location='menu.php';</script><?php }
 $periodo='01';$cod_cuenta_d="";$cod_cuenta_h="9-9-999-99-99-9999";$vstatus="T";$vurl;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
"http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>SIPAP CONTABILIDAD (Reporte Resumen de Periodo)</title>
...
function Llama_Rpt_Res_Periodo(murl){var url; var r;  var st;
  ...
  r=confirm("Desea Generar el Reporte Resumen de Periodo ?");
  if (r==true) {url=murl+"?periodo="+document.form1.txtperiodo.value+"&cod_cuenta_d="+document.form1.txtCodigo_Cuenta_D.value+"&cod_cuenta_h="+document.form1.txtCodigo_Cuenta_H.value+"&vstatus="+st+"&tipo_rpt="+document.form1.tipo_rpt.value;
    window.open(url,"Reporte Resumen de Periodo")
  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE RESUMEN DE PERIODO </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="976" height="299" border="1" id="tablacuerpo">
  <tr>
    <td width="870">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:955px; height:302px; z-index:1; top: 68px; left: 18px;">
        <form name="form1" method="get">
           <table width="939" height="287" border="0">
    <tr>
      <td width="958" height="283" align="center" valign="top"><table width="783" border="0" cellspacing="0" cellpadding="0">
        <tr><td colspan="2">&nbsp;</td> </tr>
        <tr> <td><table width="747" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="167" align="center"><div align="left"><span class="Estilo5">PERIODO : </span></div></td>
            <td width="166" align="center"> <div align="left"><span class="Estilo5"> <select name="txtperiodo" size="1" id="select">
                  <option selected>01</option>  <option>02</option> <option>03</option>
                  <option>04</option> <option>05</option> <option>06</option>
                  <option>07</option> <option>08</option> <option>09</option>
                  <option>10</option> <option>11</option>  <option>12</option>
                </select></span></div></td>
            <td width="68" align="center"><div align="left"></div></td>
            <td width="187" align="center"><div align="left"><span class="Estilo5">            </span></div></td>
          </tr>
        </table></td></tr>
        <tr><td colspan="2">&nbsp;</td> </tr>
        <tr>
        ...
        <tr>
          <td colspan="2"><table width="748" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="169" align="center"><div align="left"><span class="Estilo5">COMPROBANTES: </span></div></td>
              <td width="397" align="center"> <div align="left">
        ...
        <tr>
          <td colspan="2"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Res_Periodo('Rpt_Resumen_Per.php');">  </div></td>
