...
<html>
<head>
<title>SIPAP CONTABILIDAD (Reporte Libro Auxiliar de Tesoreria)</title>
...
function Llama_Rpt_Res_Diario_G(murl){var url; var r; var imp;
  ...
  if (r==true) {url=murl+"?periodo="+document.form1.txtperiodo.value+"&cod_cuenta_d="+document.form1.txtCodigo_Cuenta_D.value+"&cod_cuenta_h="+document.form1.txtCodigo_Cuenta_H.value; window.open(url,"Reporte Libro Auxiliar de Tesoreria")}
}
        ...
        <tr>
          <td colspan="2"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Res_Diario_G('Rpt_Lib_aux_teso.php');">  </div></td>
