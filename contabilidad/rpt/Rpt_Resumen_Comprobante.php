...
<html>
<head>
<title>SIPAP CONTABILIDAD (Reporte Resumen de Comprobantes)</title>
				...
				<tr>
				  <td colspan="2"><table width="590" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  ...
					  <td width="163" align="left"><span class="Estilo5"> <input name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onchange="checkrefechad(this.form)">
					  ...
					  <td width="188" align="left"><span class="Estilo5"><input name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onchange="checkrefechah(this.form)">
				  ...
				  <td colspan="2"><div align="center">
					<table width="588" border="0" align="center" cellpadding="0" cellspacing="0">
					  <tr>
						...
						<td width="166" align="left"><span class="Estilo5"><input name="txtReferenciad" type="text" id="txtReferenciad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $referencia_d?>" size="12" maxlength="8"></span></td>
						<td width="68" align="left"><span class="Estilo5">HASTA:</span></td>
						<td width="187" align="left"><span class="Estilo5"><input name="txtReferenciah" type="text" id="txtReferenciah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $referencia_h?>" size="12" maxlength="8"></span></td>
					  </tr>
					</table>
				  </div></td>
				</tr>
