...
<?php $sql="SELECT MAX(codigo_cuenta) As max_codigo_cuenta, MIN(codigo_cuenta) As min_codigo_cuenta FROM con001";$res=pg_query($sql);
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE CATALOGO DE CUENTAS</div></td>
        ...
        <tr>
          <td colspan="2"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td> <div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Catalogo_Cuen('Rpt_Catalogo_Cuen.php');"> </div></td>
