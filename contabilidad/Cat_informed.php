...
<html>
<head>
<title>SIPAP CONTABILIDAD FINANCIERA (Catalogo Informes Contables)</title>
...
<?php 
  ...
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:cerrar_catalogo('<?php  echo $registro["cod_informe"]; ?>','<?php  echo $registro["nombre_informe"]; ?>','<?php  echo $registro["arch_informe"]; ?>')" >
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><?php  echo $registro["cod_informe"]; ?></b></font></td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><?php  echo $registro["nombre_informe"]; ?></b></font></td>
  </tr>
<?php }
                }
                echo "</table>";
