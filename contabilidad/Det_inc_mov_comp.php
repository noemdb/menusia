  ...
  <table width="1150" border="0">
    <tr>
      <td align="left"><table width="870" border="0" align="left">
          <tr>
            <td width="175" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Cuenta Contable al Comprobante" onclick="javascript:LlamarURL('Inc_contab_mov.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
            <td width="175" align="center"><input name="btBancos" type="button" id="btBancos" value="Bancos" title="Agregar Mov. Banco al Comprobante" onClick="javascript:LlamarURL('Inc_banco_mov.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
            <td width="175" align="center"><input name="btEgreso" type="button" id="btEgreso" value="Egreso" title="Agregar Mov. Presupuesto de Egreso al Comprobante" onClick="JavaScript:LlamarURL('Inc_egreso_mov.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
			<td width="175" align="center"><input name="btIngreso" type="button" id="btIngreso" value="Ingreso" title="Agregar Mov. Presupuesto de Ingreso al Comprobante" onClick="JavaScript:LlamarURL('Inc_ingreso_mov.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
...
?>
            <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:Llama_Eliminar('<?php  echo $codigo_mov; ?>','<?php  echo $registro["nro_linea"]; ?>','<?php  echo $registro["cod_cuenta"]; ?>');">
              <td width="50" height="20" align="left"><?php  echo $des_modulo; ?></td>
              <td width="150" height="20" align="left"><?php  echo $registro["cod_cuenta"]; ?></td>
              <td width="270" align="left"><?php  echo $registro["nombre_cta"]; ?></td>
			  <td width="80" align="center"><?php  echo $registro["referencia"]; ?></td>
              <td width="40" align="center"><?php  echo $tipo; ?></td>
