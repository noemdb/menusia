...
function cerrar_catalogo(tipo){
  window.opener.document.forms[0].txttipo_asientod.value = tipo;
  window.opener.document.forms[0].txttipo_asientod.focus();
  window.close();
}
</script>
...
<form action="Cat_tipo_asientod.php" method="get">
