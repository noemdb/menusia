...
function apaga_monto(mthis){var mref; var mmonto;
 ...
 return true;}
function revisar(){var f=document.form1; var Valido=true; var Mcuenta;
   ...
   if(MontoValido(f.txtmonto.value)) {Valido=true;}else{alert("monto debe tener valores num&eacute;ricos.");return false;}
   Mcuenta=f.txtCodigo_Cuenta.value;
   if (Mcuenta.charAt(0) == '6'){alert("Codigo de Cuenta no puede ser de Egreso");return false;}
   if (Mcuenta.charAt(0) == '5'){alert("Codigo de Cuenta no puede ser de Ingreso");return false;}
...
<body>
<form name="form1" method="post" action="Insert_contab_mov.php" onSubmit="return revisar()">
  <table width="623" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="620" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#003399"><span class="Estilo9">INCLUIR NUEVA CUENTA EN EL MOVIMIENTO</span></td>
        </tr>
        <tr>
          <td><table width="614" border="0">
              <tr>
                ...
                <td width="268"><input name="btCatcuentas" type="button" id="btCatcuentas" title="Abrir Catalogo C&oacute;digo de Cuentas"  onclick="VentanaCentrada('Cat_cuentas_cargables.php?criterio=','SIPAP','','750','500','true')" value="..."></td>
              </tr>
          </table></td>
        </tr>
        <tr>
              ...
              <table width="614" border="0">
                <tr>
                  <td width="336"><span class="Estilo5">DEBITO/CREDITO :
                        <select name="txtDeb_Cre" size="1" id="select">
                          <option>D</option>
                          <option>C</option>
                        </select>
                  </span></td>
                  <td width="242"><span class="Estilo5">MONTO :
                        <input name="txtmonto" type="text" id="txtmonto" size="25" align="right" maxlength="22" onFocus="encender(this)" onBlur="apaga_monto(this)" onKeypress="return validarNum(event)">
                  </span></td>
                </tr>
            </table></td>
        </tr>
