...
<html>
<head>
<title>SIPAP CONTABILIDAD FINANCIERA  (Cambio de Clave)</title>
        ...
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input class="Estilo10" name="txtClaveA" type="password" id="txtClaveA" size="15" maxlength="12" value="" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input class="Estilo10" name="txtClaveN" type="password" id="txtClaveN" size="15" maxlength="12" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input class="Estilo10" name="txtClaveNR" type="password" id="txtClaveNR" size="15" maxlength="12" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
