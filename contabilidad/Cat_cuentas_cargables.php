...
function Llamar_cat(){var murl;  murl= "Cat_cuentas_cargables.php?criterio="+document.form1.criterio.value;  LlamarURL(murl);}
...
<form  name="form1" action="Cat_cuentas_cargables.php" method="get" onSubmit="return revisar()">
<table border="0">
  <tr>
	<td>
