 ...
 *
 *        if(stristr($sPath,"phpreports"))  ORIGINAL                                                                                                                                                                                               *
 ******************************************************************************/
...
class PHPReportsErrorTr
{
        ...
        function PHPReportsErrorTr()
        {
                ...
                // default Espa�ol messages
                $this->_aMsgs["OPS"]["default"] = "ATENCION, OCURRIO UN ERROR.";
                $this->_aMsgs["ERROR"]["default"] = "Este mensaje de error fue generado por SIPAP-phpReports.";
                $this->_aMsgs["NODATA"]["default"] = "DATOS NO LOCALIZADO.";
                $this->_aMsgs["NOPAGE"]["default"] = "Elemento PAGE no localizado en el archivo XML.";
                $this->_aMsgs["NOIF"]["default"] = "Interface de Base de Datos '%s' no disponible.";
                $this->_aMsgs["REFUSEDCON"]["default"] = "Coneccion refused.";
                $this->_aMsgs["QUERYERROR"]["default"] = "Existe un error en la consulta SQL.";
                ...
                $this->_aMsgs["NODATA"]["pt_BR"] = "N�o foram encontrados dados.";
                $this->_aMsgs["NOPAGE"]["pt_BR"] = "N�o h� um elemento PAGE (p�gina) no seu relat�rio.";
                $this->_aMsgs["NOIF"]["pt_BR"] = "N�o h� dispon�vel a interface '%s' para banco de dados.";
                $this->_aMsgs["REFUSEDCON"]["pt_BR"] = "Conex�o recusada.";
                $this->_aMsgs["QUERYERROR"]["pt_BR"] = "Erro na consulta SQL.";
                $this->_aMsgs["NOCOLUMNS"]["pt_BR"] = "N�o foram retornados colunas de dados na sua consulta.";
                $this->_aMsgs["PAGEPARSER"]["pt_BR"] = "N�o consegui copiar o conversor de p�ginas para o diret�rio tempor�rio.";
                $this->_aMsgs["DYNLINK"]["pt_BR"] = "Foi especificado um link din�mico mas n�o existe um elemento COLUMN.";
                $this->_aMsgs["EXPLINK"]["pt_BR"] = "Foi especificado um link com uma express�o mas n�o existe um elemento COLUMN.";
                $this->_aMsgs["NOFIELD"]["pt_BR"] = "Voc� est� tentando recuperar o <b>VALOR</b> de um campo chamado <b>%s</b>, mas ele n�o existe na sua consulta. Por favor revise sua consulta.";
                $this->_aMsgs["NOFIELDSUM"]["pt_BR"] = "Voc� est� tentando recuperar a <b>SOMA</b> de um campo chamado <b>%s</b>, mas ele n�o existe na sua consulta. Por favor revise sua consulta.";
                $this->_aMsgs["NOFIELDMAX"]["pt_BR"] = "Voc� est� tentando recuperar o <b>VALOR M�XIMO</b> de um campo chamado <b>%s</b>, mas ele n�o existe na sua consulta. Por favor revise sua consulta.";
                $this->_aMsgs["NOFIELDMIN"]["pt_BR"] = "Voc� est� tentando recuperar o <b>VALOR M�NIMO</b> de um campo chamado <b>%s</b>, mas ele n�o existe na sua consulta. Por favor revise sua consulta.";
                $this->_aMsgs["NOFIELDAVG"]["pt_BR"] = "Voc� est� tentando recuperar o <b>VALOR M�DIO</b> de um campo chamado <b>%s</b>, mas ele n�o existe na sua consulta. Por favor revise sua consulta.";
                $this->_aMsgs["CANTWRITEPAGE"]["pt_BR"] = "N�o consegui escrever o arquivo <b>%s</b> no disco. Verifique suas permiss�es e espa�o em disco.";
                $this->_aMsgs["DYNBOOK"]["pt_BR"] = "Foi especificado um bookmark din�mico mas n�o existe um elemento COLUMN.";
                $this->_aMsgs["EXPBOOK"]["pt_BR"] = "Foi especificado um bookmark com uma express�o mas n�o existe um elemento COLUMN.";
                $this->_aMsgs["NOXMLTRANS"]["pt_BR"] = "O par�metro <b>%s</b> de COL n�o foi encontrado na tradu��o para XML.";
                $this->_aMsgs["NOXSLT"]["pt_BR"] = "N�o h� um processador XSLT dispon�vel. Verifique se voc� compilou o PHP com <b>--enable-xslt</b> e a library <a href=\"http://www.gingerall.com/charlie/ga/xml/p_sab.xml\">Sablotron</a> (para o <a href=\"http://www.php.net/manual/en/ref.xslt.php\">PHP4</a>) ou com <b>--enable-xsl</b> (para o <a href=\"http://www.php.net/manual/en/ref.xsl.php\">PHP5</a>).";
                $this->_aMsgs["NOPATH"]["pt_BR"] = "Parece que voc� n�o especificou o path do phpReports com o comando <b>include_path</b> ou no <b>php.ini</b>. N�o sei onde as classes est�o.";
                $this->_aMsgs["NOCODE"]["pt_BR"] = "N�o pude criar o c�digo de sa�da para rodar seu relat�rio. Por favor verifique se o usu�rio do servidor web tem direitos para escrever no diret�rio <b>%s</b>.";
                $this->_aMsgs["NOXML"]["pt_BR"] = "N�o pude encontrar o arquivo XML com seus dados (<b>%s</b>) para rodar seu relat�rio. Por favor verifique o nome do arquivo e se o usu�rio do servidor web tem direitos de escrita no seu diret�rio de arquivos tempor�rios.";
                $this->_aMsgs["NOXMLSET"]["pt_BR"] = "O arquivo XML de entrada <b>%s</b> n�o foi encontrado.";
                $this->_aMsgs["NOXSLTSET"]["pt_BR"] = "O arquivo XSLT de entrada <b>%s</b> n�o foi encontrado.";
                $this->_aMsgs["NOPLUGIN"]["pt_BR"] = "O plugin de sa�da <b>%s</b> n�o existe (<b>%s</b>).";
                $this->_aMsgs["NOLOAD"]["pt_BR"] = "N�o encontrei o arquivo <b>%s</b> para carregar o relat�rio.";
                $this->_aMsgs["NOTEMPLATE"]["pt_BR"] = "O arquivo de template <b>%s</b> n�o foi encontrado.";
                $this->_aMsgs["INVALIDCON"]["pt_BR"] = "A vari�vel da conex�o com o banco de dados n�o � v�lida. %s";

                // English messages
                $this->_aMsgs["OPS"]["en_EN"] = "OOOOPS, THERE'S AN ERROR HERE.";
                $this->_aMsgs["ERROR"]["en_EN"] = "This error message was generated by phpReports.";
                $this->_aMsgs["NODATA"]["en_EN"] = "No data was found.";
                $this->_aMsgs["NOPAGE"]["en_EN"] = "No PAGE element was found on your XML file.";
                $this->_aMsgs["NOIF"]["en_EN"] = "No database interface '%s' available.";
                $this->_aMsgs["REFUSEDCON"]["en_EN"] = "Connection refused.";
                $this->_aMsgs["QUERYERROR"]["en_EN"] = "There's an error on your SQL query.";
                $this->_aMsgs["NOCOLUMNS"]["en_EN"] = "No columns returned from your query.";
                $this->_aMsgs["PAGEPARSER"]["en_EN"] = "Could not copy the temporary page parser to the temporary directory.";
                $this->_aMsgs["DYNLINK"]["en_EN"] = "Specified a dynamic link but no COLUMN element found";
                $this->_aMsgs["EXPLINK"]["en_EN"] = "Specified an expression link but no COLUMN element found";
                $this->_aMsgs["NOFIELD"]["en_EN"] = "You're trying to retrieve the <b>VALUE</b> of a field called <b>%s</b>, but it is not on your SQL query. Please check your query.";
                $this->_aMsgs["NOFIELDSUM"]["en_EN"] = "You're trying to retrieve the <b>SUM</b> of a field called <b>%s</b>, but it is not on your SQL query. Please check your query.";
                $this->_aMsgs["NOFIELDMAX"]["en_EN"] = "You're trying to retrieve the <b>MAX VALUE</b> of a field called <b>%s</b>, but it is not on your SQL query. Please check your query.";
                $this->_aMsgs["NOFIELDMIN"]["en_EN"] = "You're trying to retrieve the <b>MIN VALUE</b> of a field called <b>%s</b>, but it is not on your SQL query. Please check your query.";
                $this->_aMsgs["NOFIELDAVG"]["en_EN"] = "You're trying to retrieve the <b>AVERAGE</b> of a field called <b>%s</b>, but it is not on your SQL query. Please check your query.";
                $this->_aMsgs["CANTWRITEPAGE"]["en_EN"] = "Can't write file <b>%s</b> to the disk. Check your disk quota/space and rights.";
                $this->_aMsgs["DYNBOOK"]["en_EN"] = "Specified a dynamic bookmark but no COLUMN element found";
                $this->_aMsgs["EXPBOOK"]["en_EN"] = "Specified an expression bookmark but no COLUMN element found";
                $this->_aMsgs["NOXMLTRANS"]["en_EN"] = "COL parameter <b>%s</b> not found on XML translation.";
                $this->_aMsgs["NOXSLT"]["en_EN"] = "There is no XSLT processor available. Check if you compiled PHP with <b>--enable-xslt</b> and the <a href=\"http://www.gingerall.com/charlie/ga/xml/p_sab.xml\">Sablotron</a> library (for <a href=\"http://www.php.net/manual/en/ref.xslt.php\">PHP4</a>) or with <b>--enable-xsl</b> (for <a href=\"http://www.php.net/manual/en/ref.xsl.php\">PHP5</a>).";
                $this->_aMsgs["NOPATH"]["en_EN"] = "Seems that you didn't specified the phpReports path on the PHP <b>include_path</b> statement or <b>php.ini</b>. I don't know there the classes are.";
                $this->_aMsgs["NOCODE"]["en_EN"] = "Could not create the output code to run your report. Please check if the webserver user have rights to write in your <b>%s</b> directory.";
                $this->_aMsgs["NOXML"]["en_EN"] = "Could not find the XML file with your data (<b>%s</b>) to run your report. Please check the filename and if the webserver user have rights to write in your temporary directory.";
                $this->_aMsgs["NOXMLSET"]["en_EN"] = "The XML input file <b>%s</b> was not found.";
                $this->_aMsgs["NOXSLTSET"]["en_EN"] = "The XSLT input file <b>%s</b> was not found.";
                $this->_aMsgs["NOPLUGIN"]["en_EN"] = "There is no <b>%s</b> output plugin (<b>%s</b>).";
                $this->_aMsgs["NOLOAD"]["en_EN"] = "Could not find file <b>%s</b> for report loading.";
                $this->_aMsgs["NOTEMPLATE"]["en_EN"] = "The template file <b>%s</b> was not found.";
                $this->_aMsgs["INVALIDCON"]["en_EN"] = "Your database connection handle is not valid.";
        }
