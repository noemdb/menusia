<?php include ("../class/conect.php"); include ("../class/funciones.php");  $cod_unidad=""; $cod_empresa="";
...
if (pg_ErrorMessage($conn)) { ?> <script language="JavaScript"> muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS'); </script> <?php }
  ...
  if ($filas==0){?> <script language="JavaScript"> muestra('CODIGO ubicacion NO ASIGNADO AL USUARIO'); </script>  <?php }
