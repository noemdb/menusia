...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Detalles Comprobante Retencion IVA)</title>
<LINK  href="../class/sia.css" type="text/css" rel="stylesheet">
</head>
<script language="JavaScript" type="text/JavaScript">
function Llama_Modificar(codigo_mov,operacion){var murl;  murl="Mod_fact_ret_iva.php?codigo_mov="+codigo_mov+"&operacion="+operacion+"&agregar=<?php  echo $agregar; ?>"; document.location=murl;}
</script>
<body>
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
          <?php if ($agregar=="S"){?><td width="222" align="center" valign="middle"> <input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar retencion Iva" onclick="javascript:Llama_Incluir('<?php  echo $opn; ?>')">   </td>
...
?>
 ...
 <p>&nbsp;</p>
<script language="JavaScript" type="text/JavaScript">
function Llama_Incluir(num_op){var murl; num_op=num_op*1; num_op=num_op+1; murl="Inc_fact_ret_iva.php?codigo_mov=<?php echo $codigo_mov?>&password=<?php echo $password?>&user=<?php echo $user?>&dbname=<?php echo $dbname?>&ivag=<?php echo $ivag?>&opn=<?php echo $opn?>&orden=<?php echo $orden?>"; document.location=murl;}
</script>
</body>
</html>
<?php  pg_close($conn); ?>