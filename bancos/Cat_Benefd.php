...
function Llamar_cat(){var murl;
  murl= "Cat_Benefd.php?criterio="+document.form1.criterio.value;  LlamarURL(murl);}
function cerrar_catalogo(mcodigo,mnombre){
  window.opener.document.forms[0].txtcedula_d.value=mcodigo;
...
<?php 
        $criterio = ""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1; if ($_GET["criterio"]!=""){$txt_criterio=$_GET["criterio"]; $txt_criterio=strtoupper ($txt_criterio);  $criterio=" where ced_rif like '%" . $txt_criterio . "%' or nombre like '%" . $txt_criterio . "%'"; }
...
<form name="form1" method="post">Criterio de b&uacute;squeda:
