...
function Llamar_cat(){var murl;  murl= "Cat_Cod_Presuh.php?criterio="+document.form1.criterio.value;  LlamarURL(murl);}
function cerrar_catalogo(mcodigo,mnombre){
  window.opener.document.forms[0].txtcodigo_pre_h.value=mcodigo;
  window.opener.document.forms[0].txtcodigo_pre_h.focus();
  window.close();
}
</script>
