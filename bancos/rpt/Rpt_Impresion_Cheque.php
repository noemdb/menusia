...
function Llama_Rpt_Impresion_Cheq(murl){
var url;
var r;

  r=confirm("Desea Generar el Reporte Imprimir Cheques ?");
  if (r==true) {
    url=murl+"?cod_banco_d="+document.form1.txtcod_banco_d.value+"&num_cheque_d="+document.form1.txtnum_cheq_d.value+"&num_cheque_h="+document.form1.txtnum_cheq_h.value;
    window.open(url,"Reporte Imprimir Cheques")}}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE IMPRESION DE CHEQUES </div></td>
  ...
  <tr>
    ...
    <tr>
      <td width="958" height="179" align="center" valign="top"><table width="783" height="166" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="26" align="center" class="Estilo16"><table width="816" border="0">
            <tr>
              ...
              <td width="450"><span class="Estilo12"><span class="Estilo5">
        ...
        <tr>
          <td height="24"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td>
                    <div align="center">
                      <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Impresion_Cheq('Rpt_Impresion_Cheq.php');">
                      </div></td>
              <td>
                    <div align="center">
