...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Vefificar Gasto de Caja)</title>
...
function Llama_Rpt_presup_caja(murl){var url;var r;var mrescod;
  if(document.form1.txtrescod[0].checked==true){mrescod="S";}
  if(document.form1.txtrescod[1].checked==true){mrescod="N";}
  r=confirm("Desea Generar el Reporte Vefificar Gasto de Caja ?");
  if (r==true){url=murl+"?periodo_d="+document.form1.selectperiodo_d.value+"&codigod="+document.form1.txtcodigod.value+"&codigoh="+document.form1.txtcodigoh.value+"&rescod="+mrescod;
  window.open(url,"Reporte Vefificar Gasto de Caja")}
}
      ...
      <td width="958" height="247" align="center" valign="top"><table width="783" height="231" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="19"><table width="783" border="0">
            <tr>
              ...
              <td width="348"><span class="Estilo5"></span></td>
            </tr>
          </table></td>
        </tr>
        <tr> <td height="19">&nbsp;</td>   </tr>
		...
		<tr>
		  <td height="19"><table width="775" border="0">
			  <tr>
				<td width="245" class="Estilo5"> RESUMEN DE CODIGOS :</td>
				<td width="175"><table width="115" height="20" border="1">
                  <tr>
                    <td width="105" valign="top" class="Estilo5"><label><input name="txtrescod" type="radio" value="S" >SI </label><label><input name="txtrescod" type="radio" value="N" checked>NO </label></td>
                  </tr>
                </table></td>
        ...
        <tr>
          <td height="95"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_presup_caja('Rpt_ver_gasto_caja.php');">     </div></td>
