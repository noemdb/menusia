...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Movimientos en Libros)</title>
...
true;}
function Llama_Rpt_Movimientos_Lib(murl){var url;var r; var mbenef="N"; var mimpsinmov="N"; var mimpnroorden="N";
  ...
  if(document.form1.impnroorden[0].checked==true){mimpnroorden="S";}
  if(document.form1.impnroorden[1].checked==true){mimpnroorden="N";}
  ...
  if (r==true){url=murl+"?cod_banco_d="+document.form1.txtcod_banco_d.value+"&cod_banco_h="+document.form1.txtcod_banco_h.value+"&tipo_mov_d="+document.form1.txttipo_mov_d.value+"&tipo_mov_h="+document.form1.txttipo_mov_h.value+"&referencia_d="+document.form1.txtreferencia_d.value+"&referencia_h="+document.form1.txtreferencia_h.value+"&periodod="+document.form1.selectperiodo_d.value+"&periodoh="+document.form1.selectperiodo_h.value+"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value+
     "&cedula_d="+document.form1.txtcedula_d.value+"&cedula_h="+document.form1.txtcedula_h.value+"&imp_benef="+mbenef+ "&imp_sinmov="+mimpsinmov+ "&imprimirorden="+mimpnroorden+"&tipo_rep="+document.form1.tipo_rep.value;
...
<table width="977" height="635" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="632">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
        ...
        <tr>
          <td height="30"><table width="776" border="0">
            <tr>
              ...
              <td width="35"><span class="Estilo5"><input class="Estilo10" name="Cat_codd" type="button" id="Cat_codd" title="Abrir Catalogo de Bancos" onClick="VentanaCentrada('../Cat_Bancosd.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
        ...
        <tr>
          <td height="19"><table width="776" border="0">
            <tr>
              ...
              <td width="34"><span class="Estilo5"><input class="Estilo10" name="Cat_codh" type="button" id="Cat_codh" title="Abrir Catalogo de Bancos" onClick="VentanaCentrada('../Cat_Bancosh.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
        ...
        <tr>
          <td height="19"><table width="776" border="0">
            <tr>
              ...
              <td width="38"><span class="Estilo5"><input class="Estilo10" name="Cat_tipod" type="button" id="Cat_tipod" title="Abrir Catalogo de Tipo Movimiento" onClick="VentanaCentrada('../Cat_Tipo_Movd.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
        ...
        <tr>
          <td height="19"><table width="776" border="0">
            <tr>
              ...
              <td width="35"><span class="Estilo5"><input class="Estilo10" name="Cat_tipoh" type="button" id="Cat_tipoh" title="Abrir Catalogo de Tipo Movimiento" onClick="VentanaCentrada('../Cat_Tipo_Movh.php?criterio=','SIPAP','','750','500','true')" value="...">  </span></td>
        ...
        <tr>
          <td height="19"><table width="783" border="0">
            <tr>
              ...
              <td width="167"><span class="Estilo5"> <input class="Estilo10" name="txtreferencia_d" type="text" id="txtreferencia_d" onFocus="encender(this)" onBlur="apaga_referenciad(this)" value="<?php echo $referencia_d?>" size="8" maxlength="8">  </span></td>
              <td width="108"><span class="Estilo5">HASTA :</span></td>
              <td width="243"><span class="Estilo5"><input class="Estilo10" name="txtreferencia_h" type="text" id="txtreferencia_h" onFocus="encender(this)" onBlur="apaga_referenciah(this)" value="<?php echo $referencia_h?>" size="8" maxlength="8">  </span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td height="10" colspan="2">&nbsp;</td></tr>
        ...
        <tr>
          <td height="19"><table width="776" border="0">
            <tr>
              ...
              <td width="174" align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)">
              ...
              <td width="244" align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
		...
		<tr>
		  <td height="19"><table width="775" border="0">
			  <tr>
				...
				<td width="175"><span class="Estilo5"> <select class="Estilo10" name="tipo_rep" id="tipo_rep"> <option value='HTML'>FORMATO HTML</option><option value='PDF'>FORMATO PDF</option><option value='EXCEL'>FORMATO EXCEL</option> </select>	</span></td>
				<td width="150" align="left"><span class="Estilo5">IMPRIMIR BENEFICIARIO : </span></td>
                <td width="195"><table width="195" height="20" border="1">
                  <tr>
                    <td width="195" valign="top" class="Estilo5"><label><input class="Estilo10" name="impbenef" type="radio" value="S" >SI </label><label><input name="impbenef" type="radio" value="N" checked>NO </label> <label><input name="impbenef" type="radio" value="B" >SOLO BENEF.</label></td>
                  </tr>
                </table></td>
			  </tr>
		  </table></td>
		...
		<tr>
		  <td height="19"><table width="775" border="0">
			  <tr>
				...
				<td width="195" align="left"><span class="Estilo5">IMPRIMIR NRO. ORDEN DE PAGO : </span></td>
                <td width="150"><table width="115" height="20" border="1">
                  <tr>
                    <td width="105" valign="top" class="Estilo5"><label><input name="impnroorden" type="radio" value="S" >SI </label><label><input name="impnroorden" type="radio" value="N" checked>NO </label></td>
                  </tr>
                </table></td>
			  </tr>
		  </table></td>
        ...
        <tr>
          <td height="54"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Movimientos_Lib('Rpt_Movimientos_Lib.php');"> </div></td>
