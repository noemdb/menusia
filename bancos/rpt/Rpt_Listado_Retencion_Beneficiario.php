...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Listado de Retencion)</title>
                    ...
                    <tr>
                      <td height="19" align="center" class="Estilo16"><table width="776" border="0">
                          <tr>
                            ...
                            <input class="Estilo10" name="txtcedula_d" type="text" id="txtcedula_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_d?>" size="14" maxlength="12">
                            </span></td>
                            <td width="115"><span class="Estilo5">
                            <input class="Estilo10" name="Catalogo1" type="button" id="Catalogo1" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosd.php?criterio=','SIPAP','','750','500','true')" value="...">
                            </span></td>
                            <td width="102"><span class="Estilo5">
                            <input class="Estilo10" name="txtcedula_h" type="text" id="txtcedula_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_h?>" size="14" maxlength="12">
                            </span></td>
                            <td width="253"><span class="Estilo5">
                            <input class="Estilo10" name="Catalogo2" type="button" id="Catalogo2" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosh.php?criterio=','SIPAP','','750','500','true')" value="...">
                            </span></td>
                          </tr>
                      </table></td>
                    </tr>
                    ...
                    <tr>
                      <td height="19" align="center" class="Estilo16"><table width="781" border="0">
                          <tr>
                            ...
                            <input class="Estilo10" name="txttipo_planilla_ret_d" type="text" id="txttipo_planilla_ret_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tipo_planilla_d?>" size="4" maxlength="2">
                            </span> </span></td>
                            <td width="10">&nbsp;</td>
                            <td width="362"><span class="Estilo12"><span class="Estilo5">
                            <input class="Estilo10" name="txttipo_planilla_ret_h" type="text" id="txttipo_planilla_ret_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tipo_planilla_h?>" size="4" maxlength="2">
                            </span></span></td>
                          </tr>
                      </table></td>
                    </tr>
