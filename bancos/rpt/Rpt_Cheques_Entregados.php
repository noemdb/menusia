...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Cheques Entregados)</title>
        ...
        <tr>
          <td height="22"><table width="790" border="0" >
            <tr>
              ...
              <td width="245" align="center"><div align="left"><span class="Estilo5">
                  <input class="Estilo10" name="txtfechaanud" type="text" id="txtfechaanud" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_entregado_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)">
              ...
              <td width="86" align="left"><span class="Estilo5">HASTA :</span></td>
              <td width="228" align="center"><div align="left"><span class="Estilo5">
                  <input class="Estilo10" name="txtfechaanuh" type="text" id="txtfechaanuh" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_entregado_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
