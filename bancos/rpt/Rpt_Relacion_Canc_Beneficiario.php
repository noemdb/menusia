...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Relacion Cancelaciones por Beneficiario)</title>
...
function Llama_Rpt_Comp_Islr(murl){var url; var r;
  r=confirm("Desea Generar Reporte Relacion Cancelaciones por Beneficiario ?");
  if (r==true) {url=murl+"?cedula_d="+document.form1.txtcedula_d.value+"&cedula_h="+document.form1.txtcedula_h.value+"&tipo_rpt="+document.form1.tipo_rpt.value+"&det_benef="+document.form1.det_benef.value;
    window.open(url,"Relacion Cancelaciones por Beneficiario"); }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE RELACION CANCELACIONES POR BENEFICIARIO </div></td>
				...
				<tr>
				  <td height="19" colspan="5" align="center" ><table width="784" border="0">
					<tr>
					  ...
					  <td width="130"><span class="Estilo5"><input class="Estilo10" name="txtcedula_d" type="text" id="txtcedula_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_d?>" size="15" maxlength="12"></span></td>
					  <td width="108"><span class="Estilo5"><input class="Estilo10" name="cat_cedd" type="button" id="cat_cedd" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Beneficiariosd.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
					  <td width="127"><span class="Estilo5"><input class="Estilo10" name="txtcedula_h" type="text" id="txtcedula_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_h?>" size="15" maxlength="12"></span></td>
					  <td width="209"><span class="Estilo5"><input class="Estilo10" name="cat_cedh" type="button" id="cat_cedh" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Beneficiariosh.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
					</tr>
				  </table></td>
				</tr>
				<tr>
				...
				<tr>
				 <td height="19" colspan="5" align="center" ><table width="784" border="0">
					<tr>
					  ...
					  <td width="260"><span class="Estilo5"> <select class="Estilo10" name="tipo_rpt" id="tipo_rpt">
					  ...
					  <td width="200" class="Estilo5"> DETALLE DE UN BENEFICIARIO :</td>
					  <td width="136"><span class="Estilo5"> <select class="Estilo10" name="det_benef" id="det_benef"> <option value='NO'>NO</option><option value='SI'>SI</option> </select></span></td>
				...
				<tr>
				  <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr align="center" valign="middle">
					  <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Comp_Islr('Rpt_Rel_canc_benef.php');"> </div></td>
