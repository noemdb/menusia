...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Relacion Ordenes de Pago por Pagar)</title>
        ...
        <tr>
          <td height="19" colspan="2" align="center"  ><table width="776" border="0">
            <tr>
              ...
              <td width="110"><span class="Estilo5"><input class="Estilo10" name="Catalogo1" type="button" id="Catalogo1" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Benefd.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
        ...
        <tr>
          <td height="18" colspan="2"><table width="776" border="0">
            <tr>
              ...
              <td width="130"><span class="Estilo5"><input class="Estilo10" name="Catalogo1" type="button" id="Catalogo1" title="Abrir Catalogo de Tipo Orden" onClick="VentanaCentrada('../Cat_tipo_ordend.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
              ...
              <td width="290"><span class="Estilo5"><input class="Estilo10" name="Catalogo2" type="button" id="Catalogo2" title="Abrir Catalogo de Tipo Orden" onClick="VentanaCentrada('../Cat_tipo_ordenh.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
            </tr>
          </table></td>
        </tr>
