...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Archivo Vefificar Flujo de Caja)</title>
...
function Llama_Rpt_presup_caja(murl){var url;var r;var mrescod='N';
  r=confirm("Desea Generar el Archivo Vefificar Flujo de Caja ?");
  if (r==true){url=murl+"?periodo_d="+document.form1.selectperiodo_d.value;
  window.open(url,"Archivo Vefificar Flujo de Caja")}
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">ARCHIVO VERIFICA MOV. FLUJO DE CAJA </div></td>
        ...
        <tr>
          <td height="95"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_presup_caja('Rpt_ver_flujo_caja.php');">     </div></td>
