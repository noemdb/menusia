...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="02"; $opcion="03-0000158"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Listado Retencion IVA)</title>
...
<table width="978" height="289" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="245"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
        <div id="Layer1" style="position:absolute; width:956px; height:260px; z-index:1; top: 75px; left: 16px;">
          <form name="form1" method="get">
            <table width="950" height="240" border="0">
              <tr>
                <td width="958" height="236" align="center" valign="top"><table width="783" height="214" border="0" cellpadding="0" cellspacing="0">
                    <tr>
					...
					<tr>
                      <td height="19" colspan="4"><table width="782" border="0">
                          <tr>
                            ...
                            <td width="101"><span class="Estilo5"> <input class="Estilo10" name="txtcedula_d" type="text" id="txtcedula_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_d?>" size="15" maxlength="12"> </span></td>
						    <td width="95"><span class="Estilo5"><input class="Estilo10" name="Catalogo1" type="button" id="Catalogo14" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosd.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
						    <td width="88"><span class="Estilo5"><input class="Estilo10" name="txtcedula_h" type="text" id="txtcedula_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_h?>" size="12" maxlength="15">	</span></td>
						  <td width="133"><span class="Estilo5"><input class="Estilo10" name="Catalogo2" type="button" id="Catalogo24" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosh.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
				...
				<tr>
				  <td height="19" colspan="5"><table width="783" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					  ...
					  <td width="209" align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)">
						  <img src="../../imagenes/img_cal.png" width="20" height="14" id="calendario1" style="cursor: pointer; border: 1px solid blue;" title="Seleccionar Fecha"
						onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario1')"  /></span></div></td>
					  <td width="359" align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
                ...
                <tr>
				  <td height="19" colspan="5"><table width="783" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="210"><span class="Estilo5"> <input class="Estilo10" name="txtnum_comprobante_d" type="text" id="txtnum_comprobante_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $comprobante_d?>" size="10" maxlength="8">  </span></td>
                      <td width="170"><span class="Estilo5"><input class="Estilo10" name="txtnum_comprobante_h" type="text" id="txtnum_comprobante_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $comprobante_h?>" size="10" maxlength="8">   </span></td>
					...
					<tr>
                        <td height="19" colspan="3"><table width="782" border="0.5" cellspacing="1" cellpadding="1">
                          <tr>
							<td width="213" class="Estilo5"> TIPO DE REPORTE :</td>
							 <td width="550"><span class="Estilo5"> <select name="tipo_rpt" id="tipo_rpt">
