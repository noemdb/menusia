...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Listado Planillas de Retenci&oacute;n/Beneficiario)</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE LISTADO PLANILLAS DE RETENCI&Oacute;N / BENEFICIARIO</div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="419" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="413">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:385px; z-index:1; top: 75px; left: 18px;">
        <form name="form1" method="get">
           <table width="950" height="379" border="0">
    <tr>
      <td width="958" height="375" align="center" valign="top"><table width="783" height="365" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td height="19" align="center" class="Estilo16"><table width="784" border="0">
            <tr>
              ...
              <td width="105"><span class="Estilo5">
                <input name="Catalogo32" type="button" id="Catalogo36" title="Abrir Catalogo de Cuentas" onClick="VentanaCentrada('../Cat_cuentas_cargablesd.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
              ...
              <td width="159"><span class="Estilo5">
                <input name="Catalogo342" type="button" id="Catalogo342" title="Abrir Catalogo de Cuentas" onClick="VentanaCentrada('../Cat_cuentas_cargablesd.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="19" align="center" class="Estilo16"><table width="776" border="0">
            <tr>
              ...
              <td width="214"><span class="Estilo5"> <span class="Estilo12">
              ...
              <td width="78">HASTA : </td>
              <td width="264"><span class="Estilo12"><span class="Estilo5">
        ...
        <tr>
          <td height="19"><table width="783" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="133" align="center"><div align="left">
              ...
              <td width="83" align="center"><div align="left">HASTA :</div></td>
        ...
        <tr>
          <td height="19"><table width="777" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              <td width="213">&nbsp;</td>
              <td width="323"><strong>DESDE</strong></td>
        ...
        <tr>
          <td height="19"><table width="782" border="0">
            <tr>
              <td width="183" height="26"><p align="left">CLASIFICACI&Oacute;N :</p></td>
        ...
        <tr>
          <td height="19"><table width="782" border="0">
            <tr>
              <td width="183" height="26"><p align="left"> TIPO BENEFICIARIO :</p></td>
              <td width="314"><span class="Estilo5">
                <select name="selecttipo_benef_d" id="selecttipo_benef_d">
                  <option>JURIDICO</option>
                  <option>NATURAL</option>
                            </select>
              </span></td>
              <td width="271"><span class="Estilo5">
