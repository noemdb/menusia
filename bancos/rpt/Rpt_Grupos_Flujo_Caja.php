...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Flujo de Caja)</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE FLUJO DE CAJA </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="316" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="310">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:292px; z-index:1; top: 65px; left: 17px;">
        <form name="form1" method="get">
           <table width="950" height="289" border="0">
    <tr>
      <td width="958" height="285" align="center" valign="top"><table width="783" height="238" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="19"><table width="783" border="0">
            <tr>
              <td width="153"><p align="left">PERIODO DESDE :</p></td>
              <td width="245"><select name="selectperiodo_d" size="1" id="selectperiodo_d">
              ...
              <td width="291"><select name="selectperiodo_h" size="1" id="select6">
                  <option selected>01</option>
                  <option>02</option>
                  <option>03</option>
                  <option>04</option>
        ...
        <tr>
          <td height="170"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
