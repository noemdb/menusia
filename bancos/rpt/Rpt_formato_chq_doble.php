...
class PDF extends FPDF{ 
	function Header(){global $monto_cheque; global $nombre_benef; global $monto_letras; global $lugar; global $ano; global $cod_banco; 
	   global $concepto; global $nro_cuenta; global $num_cheque; global $fecha; global $nro_orden;  
		...
		$this->Cell(50,4,$cod_banco,1,0,'C');
    ...
    function Footer(){ global $max_ccont; global $cant_cont; global $cod_c; global $debe_c; global $den_c; global $haber_c;
		...
		$this->Cell(60,4,'Administrador',1,0,'C');		
		$this->Cell(70,4,'Contralora',1,0,'C');
        ...
        $this->Cell(60,4,'T.S.U. Nelsi Gimenez',1,0,'C');		
		$this->Cell(70,4,'Lcda. Maria Inmaculada',1,0,'C');
        $this->Cell(70,4,'Firma y Sello',1,1,'C');		
		$this->Ln(1);
