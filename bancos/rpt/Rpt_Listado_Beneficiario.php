...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Listado Beneficiario)</title>
...
function Llama_Rpt_Listado_Benefi(murl){var url;var r;var det;var ord;
  ...
  if (r==true) {
    url=murl+"?cedula_d="+document.form1.txtcedula_d.value+"&cedula_h="+document.form1.txtcedula_h.value+"&clasificacion_d="+document.form1.txtclasificacion_d.value+"&clasificacion_h="+document.form1.txtclasificacion_h.value+"&detallado="+det+"&ordenado="+ord+"&tipo_rpt="+document.form1.tipo_rpt.value;
        ...
        <tr>
          <td height="19" colspan="3" align="center"  ><table width="784" border="0">
            <tr>
              ...
              <td width="99"><span class="Estilo5"> <input class="Estilo10" name="txtcedula_d" type="text" id="txtcedula_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_d?>" size="15" maxlength="15">
              </span></td>
              <td width="118"><span class="Estilo5"><input class="Estilo10" name="catcedd" type="button" id="catcedd" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosd.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
              <td width="102"><span class="Estilo5"><input class="Estilo10" name="txtcedula_h" type="text" id="txtcedula_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $cedula_h?>" size="15" maxlength="15">
              </span></td>
              <td width="253"><span class="Estilo5"><input class="Estilo10" name="catcedh" type="button" id="catcedh" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('../Cat_Beneficiariosh.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
            </tr>
          </table></td>
        </tr>
		...
		<tr>
		  <td height="19" colspan="3" align="center"  ><table width="782" border="0">
			  <tr>
				...
				<td width="580"><span class="Estilo5"> <select class="Estilo10" name="tipo_rpt" id="tipo_rpt">
