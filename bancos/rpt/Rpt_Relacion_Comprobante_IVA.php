...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="01"; $opcion="03-0000157"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
$periodod=substr($fecha_hoy,6,4);  $periodoh=substr($fecha_hoy,3,2); $fecha_d="01".substr($fecha_hoy,2,8); $fecha_h="15".substr($fecha_hoy,2,8);
?>
...
<html>
<head>
<title>SIPAP ORDENAMIENTO DE PAGOS (Reporte Listado Relacion Comprobante IVA)</title>
...
return true;}
function Llama_Rpt_Relacion_Comprobante(murl){var url;var r; var mtipo_comp=document.form1.txttipo_comp.value;
  r=confirm("Desea Generar el Reporte Listado Relacion Comprobante IVA?");
  if (r==true) {
    url=murl+"?periodod="+document.form1.txtperiodo_d.value+"&mes="+document.form1.txtmes.value+"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value+'&tipo_comp='+mtipo_comp+"&tipo_rpt="+document.form1.tipo_rpt.value;
    window.open(url,"Reporte Listado Relacion Comprobante IVA")}
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE LISTADO RELACI&Oacute;N COMPROBANTE IVA </div></td>
        ...
        <tr>
          <td height="19" align="center" class="Estilo16"><table width="776" border="0">
            <tr>
              ...
              <td width="223"><span class="Estilo5"><input class="Estilo10" name="txtperiodo_d" type="text" id="txtperiodo_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $periodod?>" size="12" maxlength="10" class="Estilo5"></span></td>
              <td width="52" class="Estilo5">MES : </td>
              <td width="285"><span class="Estilo12"><span class="Estilo5"><input class="Estilo10" name="txtmes" type="text" id="txtmes" onFocus="encender(this)" onBlur="apaga_mes(this)" value="<?php echo $periodoh?>" size="3" maxlength="3" class="Estilo5"></span></span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td> </tr>
        <tr>
          <td height="19"><table width="783" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="217" align="center"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)" class="Estilo5">
                  <img src="../../imagenes/img_cal.png" width="20" height="14" id="calendario1" style="cursor: pointer; border: 1px solid blue;" title="Seleccionar Fecha"
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario1')"  /></span></div></td>
              <td width="70" align="center" class="Estilo5"><div align="left">HASTA :</div></td>
              <td width="289" align="center"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)" class="Estilo5">
        ...
        <tr>
          <td height="18" colspan="3"><table width="783" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="220"><span class="Estilo5"> <select class="Estilo10" name="tipo_rpt" id="tipo_rpt"><option value='HTML'>FORMATO HTML</option><option value='PDF'>FORMATO PDF</option><option value='EXCEL'>FORMATO EXCEL</option> </select></span></td>
        ...
        <tr>
          <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Relacion_Comprobante('../../pagos/rpt/Rpt_Relacion_Comprobante.php');">  </div></td>
