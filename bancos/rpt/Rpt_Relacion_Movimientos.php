...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="02"; $opcion="03-0000175"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 if ($filas>0){$reg=pg_fetch_array($res); $Mcamino=$reg["campo607"].$reg["campo608"].$reg["campo609"].$reg["campo610"].$reg["campo611"].$reg["campo612"].$reg["campo613"].$reg["campo614"].$reg["campo615"].$reg["campo616"].$reg["campo617"].$reg["campo618"].$reg["campo619"].$reg["campo620"].$reg["campo621"].$reg["campo622"].$reg["campo623"].$reg["campo624"].$reg["campo625"].$reg["campo626"]; }
}$posicion=strpos($Mcamino,'S');if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> document.location='../menu.php';</script><?}
$cod_banco_d="";$tipo_mov_d="";$periodod='01';$periodoh='01';$fecha_d=formato_ddmmaaaa($Fec_Ini_Ejer);$fecha_h=formato_ddmmaaaa($Fec_Fin_Ejer);$subtotales="S";$ordenarcheque="S";$imprimirbene="N";$imprimircuen="N";$imprimirorden="N";$imprimirsolo="N";$vurl;
$des_tipo_d="";$des_tipo_h=""; $nombre_banco_d="";  $nombre_banco_h="";
?>
...
function apaga_tipo_mov_d(mthis){var mref;
   apagar(mthis); mref=document.form1.txtdesc_tipo_Mov_d.value;  
   document.form1.txtencab_reporte.value="RELACION DE "+mref;
return true;}

function Llama_Rpt_Relacion_Movimien(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Relacion Movimientos?");
  if (r==true){url=murl+"?cod_banco_d="+document.form1.txtcod_banco_d.value+"&cod_banco_h="+document.form1.txtcod_banco_h.value+"&tipo_mov_d="+document.form1.txttipo_mov_d.value+"&periodod="+document.form1.selectperiodo_d.value+"&periodoh="+document.form1.selectperiodo_h.value+"&tipo_rep="+document.form1.tipo_rep.value+"&encab_reporte="+document.form1.txtencab_reporte.value;
    window.open(url,"Reporte Relacion Movimientos")}}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE RELACI&Oacute;N DE MOVIMIENTOS </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="415" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="412">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:406px; z-index:1; top: 63px; left: 19px;">
        <form name="form1" method="get"><table width="950" height="402" border="0">
    <tr>
      <td width="958" height="410" align="center" valign="top"><table width="783" height="403" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="19"><table width="776" border="0">
            <tr>
              <td width="245" height="26"><div align="left"><span class="Estilo5">TIPO DE MOVIMIENTO : </span></div></td>
              <td width="51"><span class="Estilo5"><input class="Estilo10" name="txttipo_mov_d" type="text" id="txttipo_mov_d" onFocus="encender(this)" onBlur="apaga_tipo_mov_d(this)" value="" size="5" maxlength="3"> </span></td>
              <td width="34"><span class="Estilo5"><input class="Estilo10" name="Cat_tipod" type="button" id="Cat_tipod" title="Abrir Catalogo de Tipo Movimiento" onClick="VentanaCentrada('../Cat_Tipo_Movd.php?criterio=','SIA','','750','500','true')" value="...">  </span></td>
              <td width="426"><span class="Estilo5"><input class="Estilo10" name="txtdesc_tipo_Mov_d" type="text" id="txtdesc_tipo_Mov_d" size="60" maxlength="150" value=""  readonly>   </span></td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="19"><table width="776" border="0">
            <tr>
              <td width="245"><p align="left"><span class="Estilo5">PERIODO DESDE :</span></p></td>
		 ...
		 <tr>
          <td height="19"><table width="776" border="0">
            <tr>
              <td width="245"><div align="left"><span class="Estilo5">ENCABEZADO DEL REPORTE :  </span></div></td>
              <td width="511"><span class="Estilo5"><input class="Estilo10" name="txtencab_reporte" type="text" id="txtencab_reporte" onFocus="encender(this)" onBlur="apagar(this)" value="RELACION DE " size="80" maxlength="50"> </span></td>
	    ...
	    <tr>
		  <td height="19"><table width="782" border="0">
			  <tr>
				...
				<td width="554"><span class="Estilo5"> <select class="Estilo10" name="tipo_rep" id="tipo_rep">
        ...
        <tr>
          <td height="54"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Relacion_Movimien('Rpt_Relacion_Movimien.php');">   </div></td>
