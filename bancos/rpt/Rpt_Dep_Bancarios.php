...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Depositos Bancarios)</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE DEPOSITOS BANCARIOS </div></td>
      ...
      <td width="958" height="247" align="center" valign="top"><table width="783" height="231" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="19"><table width="775" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="155"><span class="Estilo5">FECHA INFORME: </span></td>
              <td width="610"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_d?>" size="12" maxlength="10"  class="Estilo5" onChange="checkrefechad(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
              ...
              <td width="5"><input class="Estilo10" name="txtcod_banco_d" type="hidden" id="txtcod_banco_d" value="<?php echo $cod_banco_d?>" ></td>
              <td width="5"><input class="Estilo10" name="txtcod_banco_h" type="hidden" id="txtcod_banco_h" value="<?php echo $cod_banco_h?>" ></td>
            </tr>
          </table></td>
        </tr>
        <tr> <td height="19">&nbsp;</td>   </tr>
		...
		<tr>
		  <td height="19"><table width="775" border="0">
			  <tr>
				...
				<td width="620"><span class="Estilo5"> <select class="Estilo10" name="tipo_rep" id="tipo_rep">
        ...
        <tr>
          <td height="95"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Dep_Banca('Rpt_Dep_Banca.php');">     </div></td>
