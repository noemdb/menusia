...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="02"; $opcion="03-0000025"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 if ($filas>0){$reg=pg_fetch_array($res); $Mcamino=$reg["campo607"].$reg["campo608"].$reg["campo609"].$reg["campo610"].$reg["campo611"].$reg["campo612"].$reg["campo613"].$reg["campo614"].$reg["campo615"].$reg["campo616"].$reg["campo617"].$reg["campo618"].$reg["campo619"].$reg["campo620"].$reg["campo621"].$reg["campo622"].$reg["campo623"].$reg["campo624"].$reg["campo625"].$reg["campo626"]; }
}$posicion=strpos($Mcamino,'S');if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> document.location='../menu.php';</script><?php }
$cod_banco_d="";$cod_banco_h="";$tipo_mov_d="";$tipo_mov_h="";$referencia_d="";$referencia_h="zzzzzzzz";$periodod='01';$periodoh='01';$fecha_d=formato_ddmmaaaa($Fec_Ini_Ejer);$fecha_h=formato_ddmmaaaa($Fec_Fin_Ejer);$vurl;
?>
...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Movimientos en Bancos)</title>
...
return true;}
function apaga_periodo_d(mthis){var mmes;  var mano; var mdesde; var mhasta; var mdia;
...
true;}
function apaga_periodo_h(mthis){var mmes;  var mano; var mdesde; var mhasta; var mdia;
...
true;}
function Llama_Rpt_Movimientos_Banc(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Movimientos en Bancos?");
  if (r==true){url=murl+"?cod_banco_d="+document.form1.txtcod_banco_d.value+"&cod_banco_h="+document.form1.txtcod_banco_h.value+"&tipo_mov_d="+document.form1.txttipo_mov_d.value+"&tipo_mov_h="+document.form1.txttipo_mov_h.value+"&referencia_d="+document.form1.txtreferencia_d.value+"&referencia_h="+document.form1.txtreferencia_h.value+"&periodod="+document.form1.selectperiodo_d.value+"&periodoh="+document.form1.selectperiodo_h.value+"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value+"&tipo_rep="+document.form1.tipo_rep.value;
    window.open(url,"Reporte Movimientos en Bancos")}
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE MOVIMIENTOS EN BANCOS </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="455" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="450">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:457px; z-index:1; top: 52px; left: 17px;">
        <form name="form1" method="get">
           <table width="950" height="449" border="0">
    <tr>
      <td width="958" height="445" align="center" valign="top"><table width="783" height="435" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="30"><table width="776" border="0">
            <tr>
              ...
              <td width="427"><span class="Estilo5"><input class="Estilo10" name="txtdesc_banco_d" type="text" id="txtcod_titulo22" size="60" maxlength="150"  value="<?php echo $nombre_banco_d?>" readonly>   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19"><table width="783" border="0">
            <tr>
              <td width="241"><p align="left"><span class="Estilo5">PERIODO DESDE :</span></p></td>
              <td width="212"><select class="Estilo10" name="selectperiodo_d" size="1" id="selectperiodo_d" onFocus="encender(this)" onBlur="apaga_periodo_d(this)">
                  <option selected>01</option> <option>02</option> <option>03</option>
                  <option>04</option> <option>05</option> <option>06</option>
                  <option>07</option> <option>08</option> <option>09</option>
                  <option>10</option> <option>11</option> <option>12</option>
              </select></td>
              <td width="81"><span class="Estilo5">HASTA :</span></td>
              <td width="231"><select class="Estilo10" name="selectperiodo_h" size="1" id="selectperiodo_h" onFocus="encender(this)" onBlur="apaga_periodo_h(this)">
        ...
        <tr>
          <td height="22"><table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="241" align="left"><span class="Estilo5">FECHA MOVIMIENTO DESDE :</span></div></td>
              <td width="218" align="left"><span class="Estilo5">
              ...
              <td width="86" align="left"><span class="Estilo5">HASTA :</span></div></td>
              <td width="231" align="left"><span class="Estilo5">
        ...
        <tr>
          <td height="50"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Movimientos_Banc('Rpt_Movimientos_Banc.php');"></div></td>
