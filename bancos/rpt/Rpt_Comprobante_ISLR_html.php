...
//INI nmdb 21-02-2017 (Extraer nombre autorizad)
$sql="Select ced_rif_autorizado,nombre_autorizado from PRE099 where ced_rif='".$ced_rif_emp."' ";
$res=pg_query($sql);
$filas=pg_num_rows($res);
if($filas>=1){
  $registro=pg_fetch_array($res,0); 
  $ced_funcionario=$registro["ced_rif_autorizado"];
  $nombre_funcionario=$registro["nombre_autorizado"];
}
//FIN nmdb 21-02-2017 (Extraer nombre autorizad)
              ...
              <td height="150"><table width="543" height="150" border="0" cellspacing="0" bordercolor="1">
				  ...
				  <tr>
                      <td height="150"><table width="500"  height="150" border="0">
						  ...
						  <tr>
							<td height="12" class="Estilo20"><?php echo $nombre_agente?></td>
							<td class="Estilo20"><?php echo $rif?></td>
						  </tr>
						  <tr>
							<td height="12" bordercolor="#000000" class="Estilo3">Funcionario Autorizado para hacer la Retenci�n: </td>
							<td class="Estilo3">N&uacute;mero de Rif</td>
						  </tr>
						  <tr>
							<td height="12" class="Estilo20"><?php echo $nombre_funcionario?></td>
							<td class="Estilo20"><?php echo $ced_funcionario?></td>
						  </tr>
				   </table></td>
				  </tr>
        ...
        <td><table width="676" height="250" border="1" cellspacing="0" bordercolor="#000000">
            <tr>
              ...
              <td width="169"><table width="157" border="0">
                ...
                <td class="Estilo3">Natural [ <?php echo $tpe1?> ] &nbsp;&nbsp;  Juridica [ <?php echo $tpe2?> ]</td>
              </table></td>
            </tr>
            <tr>
