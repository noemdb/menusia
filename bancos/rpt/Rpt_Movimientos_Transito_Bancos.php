...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Movimientos en Transito Bancos)</title>
...
return true;}
function Llama_Rpt_Movimientos_Transito_Banc(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Movimientos en Transito Bancos?");
  ...
  window.open(url,"Reporte Movimientos en Transito Bancos")}}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE MOVIMIENTOS EN TRANSITO BANCOS </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="412" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="410">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:387px; z-index:1; top: 50px; left: 19px;">
        <form name="form1" method="get">
           <table width="950" height="400" border="0">
    <tr>
      <td width="958" height="400" align="center" valign="top"><table width="783" height="395" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="19">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19"><table width="783" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="255" align="left"><span class="Estilo5">FECHA MOVIMIENTO DESDE : </span></td>
              <td width="199" align="left"><span class="Estilo5">
              ...
              <td width="67" align="left"><span class="Estilo5">HASTA :</span></div></td>
              <td width="262" align="left"><span class="Estilo5">
        ...
        <tr>
          <td height="54"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Movimientos_Transito_Banc('Rpt_Movimientos_Transito_Banc.php');"> </div></td>
