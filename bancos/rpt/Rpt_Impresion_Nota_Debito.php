...
$cod_banco_d="";$nro_debito_d="00000000"; $nro_debito_h="99999999";
 $vurl;
?>
...
<html>
<head>
<title>SIPAP CONTABILIDAD (Reporte Impresion de Notas de Debito)</title>
...
function Llama_Rpt_Impresion_Nota_Debi(murl){
var url;
var r;

  r=confirm("Desea Generar el Reporte Impresion de Notas de Debitos ?");
  if (r==true) {
    url=murl+"?cod_banco_d="+document.form1.txtcod_banco_d.value+"&nro_debito_d="+document.form1.txtnum_ndb_d.value+"&nro_debito_d="+document.form1.txtnum_ndb_h.value;
    window.open(url,"Reporte Impresion de Notas de Debitos")}}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE DE NOTAS DE DEBITO </div></td>
...
<table width="977" height="223" border="1" id="tablacuerpo">
  <tr>
    ...
    <tr>
      <td width="958" height="179" align="center" valign="top"><table width="783" height="166" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="22"><div align="center">
              <table width="783" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="271" align="center"><div align="left">NUMERO NOTA DEBITO DESDE : </div></td>
                  <td width="174" align="center">
                    <div align="left"><span class="Estilo5">
                      <input name="txtnum_ndb_d" type="text" id="txtnum_ndb_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $nro_debito_d?>" size="12" maxlength="12">
                  </span></div></td>
                  <td width="78" align="center"><div align="left">HASTA :</div></td>
                  <td width="260" align="center">
                    <div align="left"><span class="Estilo5">
                      <input name="txtnum_ndb_h" type="text" id="txtnum_ndb_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $nro_debito_h?>" size="12" maxlength="12">
                  </span></div></td>
                </tr>
              </table>
          </div></td>
        ...
        <tr>
          <td height="24"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td>
                    <div align="center">
                      <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Impresion_Nota_Debi('Rpt_Impresion_Nota_Debi.php');">
                      </div></td>
              <td>
                    <div align="center">
