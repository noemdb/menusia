...
$cod_banco_d="";$num_trasnf_d="00000000"; $num_trasnf_h="99999999";$tipo_mov="";
 $vurl;
?>
...
return true;}
function Llama_Rpt_Impresion_Movimientos_Libro(murl){
var url;
var r;

  r=confirm("Desea Generar el Reporte Impresion de Movimiento en Libros ?");
  if (r==true) {
    url=murl+"?cod_banco_d="+document.form1.txtcod_banco_d.value+"&num_trasnf_d="+document.form1.txtnum_trasnf_d.value+"&num_trasnf_h="+document.form1.txtnum_trasnf_h.value+"&tipo_mov="+document.form1.txttipo_mov.value;
    window.open(url,"Reporte Impresion de Movimiento en Libros")}}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE IMPRESION MOVIMIENTOS EN LIBROS </div></td>
...
<table width="978" height="249" border="1" id="tablacuerpo">
  <tr>
    ...
    <tr>
      <td width="958" height="179" align="center" valign="top"><table width="783" height="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="18"><table width="783" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="234" align="center"><div align="left">TIPO MOVIMIENTO  DESDE : </div></td>
              <td width="224" align="center">
                <div align="left"><span class="Estilo5">
                  <select name="txttipo_mov" size="1">
              ...
              <td width="64" align="center"><div align="left"></div></td>
        ...
        <tr>
          <td height="24"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td>
                    <div align="center">
                      <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Impresion_Movimientos_Libro('Rpt_Impresion_Movimientos_Libro.php');">
                      </div></td>
              <td>
                    <div align="center">
