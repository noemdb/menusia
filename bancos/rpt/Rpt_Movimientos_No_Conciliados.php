...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="02"; $opcion="03-0000065"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Movimientos no Conciliados)</title>
...
function Llama_Rpt_Movimientos_No_Concili(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Movimientos No Conciliados ?"); 
  if (r==true){url=murl+"?cod_banco_d="+document.form1.txtcod_banco_d.value+"&cod_banco_h="+document.form1.txtcod_banco_h.value+"&tipo_mov_d="+document.form1.txttipo_mov_d.value+"&tipo_mov_h="+document.form1.txttipo_mov_h.value+"&referencia_d="+document.form1.txtreferencia_d.value+"&referencia_h="+document.form1.txtreferencia_h.value+"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value+"&mov_conc="+document.form1.selectmov.value+"&tipo_rep="+document.form1.tipo_rep.value;
     window.open(url,"Reporte Movimientos No Conciliados")
  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE MOVIMIENTOS NO CONCILIADOS</div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="500" border="1" id="tablacuerpo">
<tr>
    <td width="870" height="495">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:488px; z-index:1; top: 51px; left: 19px;">
        <form name="form1" method="get"><table width="950" height="490" border="0">
    <tr>
      <td width="958" height="490" align="center" valign="top"><table width="783" height="490" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="19"><table width="783" border="0">
            <tr>
              <td width="247"><p align="left"><span class="Estilo5">PERIODO DESDE :</span></p></td>
        ...
        <tr>
          <td height="19"><table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="111" align="center"><div align="left"><span class="Estilo5">HASTA :</span></div></td>
		...
		<tr>
          <td height="19"><table width="783" border="0">
            <tr>
              <td width="247"><p align="left"><span class="Estilo5">MOVIMIENTOS NO CONCILIADOS :</span></p></td>
              <td width="170"><select class="Estilo10" name="selectmov" size="1" id="selectmov" onFocus="encender(this)" onBlur="apagar(this)">
                  <option selected>EN LIBRO</option> <option>EN BANCO</option> </select></td>
              <td width="348"></td>
            </tr>
          </table></td>
        </tr>
		...
		<tr>
		  <td height="19"><table width="783" border="0">
			  <tr>
				<td width="248" class="Estilo5"> TIPO DE REPORTE :</td>
				<td width="535"><span class="Estilo5"> <select class="Estilo10" name="tipo_rep" id="tipo_rep">
        ...
        <tr>
          <td height="54"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Movimientos_No_Concili('Rpt_Movimientos_No_Concili.php');">  </div></td>
