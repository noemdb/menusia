...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Reporte Relacion de Saldos Bancarios)</title>
...
function Llama_Rpt_Disponibilidad_Bancaria_Mes(murl){var url; var r; var imp;
  ...
  r=confirm("Desea Generar el Reporte Relacion de Saldos Bancarios ?");
  ...
  window.open(url,"Reporte Relacion de Saldos Bancarios");  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE RELACION SALDOS BANCARIOS </div></td>
        ...
        <tr>
          <td height="19" colspan="2"><table width="775" border="0">
            <tr>
              ...
              <td width="97"><select class="Estilo10" name="selectperiodo" size="1" id="selectperiodo">
        ...
        <tr>
          <td height="54" colspan="2"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td height="24"> <div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Disponibilidad_Bancaria_Mes('Rpt_Rel_Saldo_Banca.php');">    </div></td>
