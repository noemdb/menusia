...
if (!$_GET){$cod_banco='';$num_cheque='';}  else{$cod_banco=$_GET["txtcod_banco"];$num_cheque=$_GET["num_cheque"];}
...
var Valido=true;
    ...
    r=confirm("Desea Recibir el Cheque ?");  if (r==true) {Valido=true;} else {return false;}
  ...
  <table width="374" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="370" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">RECEPCION DE CHEQUE EN CAJA</span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            <td><table width="360" align="center">
              <tr>
                <td width="30">&nbsp;</td>
                <td width="100" align="center" valign="middle"><input name="Recibir" type="submit" id="Recibir"  value="Recibir"></td>
