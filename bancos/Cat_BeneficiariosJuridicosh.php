...
function Llamar_cat(){var murl;  murl= "Cat_Beneficiariosh.php?criterio="+document.form1.criterio.value;  LlamarURL(murl);}
function cerrar_catalogo(mcedula,mnombre){
  window.opener.document.forms[0].txtcedula_h.value=mcedula;
...
<html>
<head>
<title>SIPAP CONTTROL BANCARIO (Catalogo de Beneficiarios)</title>
