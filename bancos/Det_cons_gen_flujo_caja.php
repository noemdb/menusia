...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Detalle Flujo de Caja)</title>
<LINK
 ...
 ?>
       <table width="1450"  border="1" cellspacing='0' cellpadding='0' align="left" id="comp_iva">
         <tr height="20" class="Estilo5">
           <td width="50"  align="left" bgcolor="#99CCFF"><strong>Codigo</strong></td>
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="40" align="left"><?php  echo $registro["cod_movimiento"]; ?></td>	
		   <td width="45" align="left"><?php  echo $registro["cod_grupo"]; ?></td>	
