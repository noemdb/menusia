...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Detalle Gastos para Flujo de Caja)</title>
<LINK href="../class/sia.css" type="text/css" rel="stylesheet">
</head>
<script language="JavaScript" type="text/JavaScript">
function Llama_Modificar(cod_banco,referencia,tipo_mov,cod_presup,fuente,periodo){var murl;  murl="Mod_gasto_flujo.php?cod_banco="+cod_banco+"&referencia="+referencia+"&tipo_mov="+tipo_mov+"&cod_presup="+cod_presup+"&fuente="+fuente+"&periodo="+periodo; document.location=murl;}
</script>
<body>
