...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (Detalles Emision de Notas)</title>
<LINK  href="../class/sia.css" type="text/css" rel="stylesheet">
</head>
<script language="JavaScript" type="text/JavaScript">
function Llama_Modificar(codigo_mov,mtipoord,rif,orden,tipo,selec,mord,mult,mmost){var murl;
   murl="Selec_Orden_Canc_ndb.php?codigo_mov="+codigo_mov+"&tipo_ord_nom="+mtipoord+"&ced_rif="+rif+"&nro_orden="+orden+"&tipo="+tipo+"&selec="+selec+'&orden='+mord+"&multiple="+mult+'&mostrar='+mmost; document.location=murl;
}
function Act_Multiple(codigo_mov,mtipoord,mult){var murl;   murl="Act_multiple_ndb_nom.php?codigo_mov="+codigo_mov+"&tipo_ord_nom="+mtipoord+"&multiple="+mult; document.location=murl;}
function Camb_Orden(codigo_mov,mtipoord,mord,mmos){
var murl;   if (mord=="N"){mord="R";} else {mord="N";} 
   murl="Det_ord_canc_nomina.php?codigo_mov="+codigo_mov+"&tipo_ord_nom="+mtipoord+"&orden="+mord+"&mostrar="+mmos; document.location=murl;
}
</script>
<style type="text/css">
<!--
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
    <tr>
     ...
     <td width="250"><input name="btOrden" type="button" id="btOrden" value="Cambiar Orden" title="Cambiar M�todo de Ordenaci�n" onclick="javascript:Camb_Orden('<?php  echo $codigo_mov; ?>','<?php echo $tipo_ord_nom?>','<?php  echo $orden; ?>','<?php  echo $mostrar; ?>');"></td>
     ...
     <td width="2000">
       <table width="2000"  border="1" cellspacing='0' cellpadding='0' align="left" id="ret_orden">
         <tr height="20" class="Estilo5">
           ...
           <td width="400" align="left" bgcolor="#99CCFF"><strong>Descripcion Orden</strong></td>
           ...
           <td width="100" align="right" bgcolor="#99CCFF" ><strong>Retenci�n</strong></td>
