...
<html>
<head>
<title>SIPAP CONTROL BANCARIO (AUDITORIA DE BANCOS)</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">AUDITORIA DE BANCOS </div></td>
...
<form action="Auditoria_bancos.php" method="get">
<table width="800" height="50" border="0" >
  <tr>
    ...
    <td width="200"> <input name="btImprimir" type="button" id="btImprimir" value="Imprimir" onClick="javascript:window.open('../bancos/rpt/imprimir_auditoria.php?criterio=<? echo $txt_criterio ?>&fechaop=<? echo $fecha_aud ?>');" >
	</td>
  </tr>
  <tr>
