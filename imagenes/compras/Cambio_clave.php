        ...
        <tr>
          <td><table width="520">
            <tr>
              ...
              <td width="300"><input name="txtnombre_usuario" type="text"  id="txtnombre_usuario" size="20" maxlength="20" readonly value="<?php  echo $usuario_sia ?>"></td>
               </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input name="txtClaveA" type="password" id="txtClaveA" size="12" maxlength="8" value=" " onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input name="txtClaveN" type="password" id="txtClaveN" size="12" maxlength="8" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input name="txtClaveNR" type="password" id="txtClaveNR" size="12" maxlength="8" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
