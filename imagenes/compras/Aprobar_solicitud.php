...
if (!$_GET){$nro_solicitud=''; $aprobado_por='';}  else {$nro_solicitud=$_GET["txtnro_solicitud"]; $aprobado_por=$_GET["mnomb"]; }
...
var Valido=true;
    ...
    r=confirm("Esta seguro en Aprobar la Solicitud ?");
    if (r==true) {r=confirm("Esta Realmente seguro en Aprobar la solicitud ?");
...
<body>
<form name="form1" method="post" action="Update_aprob_sol.php" onSubmit="return revisar()">
  <table width="714" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="707" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">APROBAR SOLICITUD DE SERVICIOS</span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
