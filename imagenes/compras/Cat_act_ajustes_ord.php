...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Catalogo de Ajustes Ordenes)</title>
...
?>
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:CargarUrl('<?php  echo $registro["tipo_ajuste"].$registro["referencia_ajuste"].$registro["tipo_pago"].$registro["referencia_pago"].$registro["tipo_causado"].$registro["referencia_caus"].$registro["tipo_compromiso"].$registro["referencia_comp"].$registro["cod_banco"]; ?>');" >
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><?php  echo $registro["referencia_ajuste"]; ?></b></font></td>
