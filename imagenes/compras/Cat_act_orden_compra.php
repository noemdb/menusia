...
function CargarUrl(mclave) {var murl;
   murl="Act_Orden_Compra.php?Gcriterio=C"+mclave;   document.location = murl;
}
</script></head>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATAL0GO ORDENES DE COMPRA </div></td>
...
<?php       $criterio = "";    $txt_criterio = "";
        ...
        $sql="SELECT * FROM ORD_COMPRA  ".$criterio; $res=pg_query($sql);    $numeroRegistros=pg_num_rows($res);
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Ordenes</font>";$pagina=1; $inicio=1; $final=1; $numPags=1;
              ...
              if(!isset($orden)){$orden="nro_orden,tipo_compromiso";}
                ...
                $sql="SELECT * FROM ORD_COMPRA ".$criterio." ORDER BY ".$orden;  $res=pg_query($sql);
...
<form action="Cat_act_orden_compra.php" method="get">
