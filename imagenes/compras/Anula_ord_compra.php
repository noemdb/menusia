...
var Valido=true;
    ...
    if (r==true) {r=confirm("Esta Realmente seguro en Anular la Orden de Compra ?");
...
<body>
<form name="form1" method="post" action="Anu_orden_comp.php" onSubmit="return revisar()">
  <table width="714" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="707" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">ANULAR ORDEN DE COMPRA </span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
