...
function cerrar_catalogo(tipo_nomina,des_nomina){
  window.opener.document.forms[0].txttipo_nomina_h.value = tipo_nomina;
  window.opener.document.forms[0].txtdescripcion_h.value = des_nomina;
  window.opener.document.forms[0].txttipo_nomina_h.focus();
  window.close();
}
</script>
...
<form action="Cat_tipo_nominah.php" method="get">
