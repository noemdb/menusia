...
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1; $numPags=1;
        $criterio = "where (substring(cod_presup from ".$c." for 3)='401') and  (length(Cod_Presup)=".$long_c.")";         $txt_criterio = "";
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Codigos Presupuestarios</font>";
        }else{
...
<form action="Cat_codigos_presuph.php"  method="get" onSubmit="return revisar()">
<table border="0">
  <tr>
	<td>
