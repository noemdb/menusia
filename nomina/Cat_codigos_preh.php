...
function cerrar_catalogo(cod_presup,den_presup){
  window.opener.document.forms[0].txtcod_presup_h.value = cod_presup;
  window.opener.document.forms[0].txtdenominacion_h.value = den_presup;
...
<form action="Cat_codigos_preh.php" method="get" onSubmit="return revisar()">
<table border="0">
  <tr>
	<td>
