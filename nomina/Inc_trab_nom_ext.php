...
<body>
<form name="form1" method="post" action="Insert_trab_ext.php" onSubmit="return revisar()">
  <table width="634" height="200" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="628" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">INCLUIR TRABAJADOR PARA EL CALCULO</span></td>
        </tr>
        <tr> <td>&nbsp;</td> </tr>
        <tr>
          <td><table width="620">
                 <tr>
                   <td width="170"><span class="Estilo5">C&Oacute;DIGO DE TRABAJADOR : </span></td>
				   <td width="110"><span class="Estilo5"><input name="txtcod_empleado" type="text" id="txtcod_empleado" size="15" maxlength="15" onFocus="encender(this)" onBlur="apagar(this)"> </span></td>
                   <td width="340"><input name="btconcepto" type="button" id="bttrabajador" title="Abrir Catalogo Trabajadores"  onClick="VentanaCentrada('Cat_trabajadores.php?criterio=','SIA','','750','500','true')" value="..."> </span></td>
                 </tr>
           </table></td>
        </tr>
        <tr> <td>&nbsp;</td> </tr>
