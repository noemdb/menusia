...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">AUDITORIA DE NOMINA Y PERSONAL </div></td>
...
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron  Movimientos de Auditoria</font>"; ECHO $sql;
				...
				$descripcion=$descripcion." EQUIPO:".$registro["nombre_equipo"];   
...
<form action="Auditoria_nomina_uti.php" method="get">
