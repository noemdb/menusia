...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Detalles del Concepto de la Liquidaci&oacute;n)</title>
...
?>
       <table width="830"  border="1" cellspacing='0' cellpadding='0' align="left" id="ret_estructura">
         <tr height="20" class="Estilo5">
           <td width="167" align="center" bgcolor="#99CCFF"><strong>C&oacute;digo</strong></td>
           <td width="634" align="center" bgcolor="#99CCFF"><strong>Denominaci&oacute;n</strong></td>
		   <td width="167" align="center" bgcolor="#99CCFF"><strong>A/D</strong></td>
		   <td width="167" align="center" bgcolor="#99CCFF"><strong>Monto Base</strong></td>
		   <td width="167" align="center" bgcolor="#99CCFF"><strong>Cantidad</strong></td>
		   <td width="167" align="center" bgcolor="#99CCFF"><strong>Monto</strong></td>
           </tr>
         <? $total=0;
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="167" align="left"><? echo $registro["tipo_ret"]; ?></td>
           <td width="634" align="left"><? echo $registro["descripcion_ret"]; ?></td>
		   <td width="167" align="left"><? echo $registro["tipo_ret"]; ?></td>
		   <td width="167" align="left"><? echo $registro["tipo_ret"]; ?></td>
		   <td width="167" align="left"><? echo $registro["tipo_ret"]; ?></td>
		   <td width="167" align="left"><? echo $registro["tipo_ret"]; ?></td>
