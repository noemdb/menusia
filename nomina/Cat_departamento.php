...
function cerrar_catalogo(codigo_departamento,des_departam){
  window.opener.document.forms[0].txtcodigo_departamento.value = codigo_departamento;
  window.opener.document.forms[0].txtdescripcion_dep.value = des_departam;
  window.opener.document.forms[0].txtcodigo_departamento.focus();
  window.close();
}
</script>
...
<form action="Cat_departamento.php" method="get">
