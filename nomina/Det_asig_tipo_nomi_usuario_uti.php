...
$res=pg_query($sql);
?>
       <table width="828"  border="1" cellspacing='0' cellpadding='0' align="left" id="ret_estructura">
         <tr height="20" class="Estilo5">
           <td width="183" align="center" bgcolor="#99CCFF"><strong>C&oacute;digo n&oacute;mina</strong></td>
           <td width="561" align="center" bgcolor="#99CCFF"><strong>Denominaci&oacute;n</strong></td>
	     </tr>
         <? $total=0;
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="183" align="left"><? echo $registro["tipo_ret"]; ?></td>
           <td width="561" align="left"><? echo $registro["tipo_ret"]; ?></td>
         </tr>
         <?}
