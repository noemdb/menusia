...
function Llama_Rpt_compro_vaca_mpv(murl){
var url; var r; var per; var car;

  r=confirm("Desea Generar el Reporte Comprobante de Vacaciones?");
  if (r==true) {url=murl+"?cod_empleado_d="+document.form1.txtcod_empleado_d.value+"&cod_empleado_h="+document.form1.txtcod_empleado_h.value;
   window.open(url,"Reporte Comprobante de Vacaciones")
  }
}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE DE COMPROBATE  DE VACACIONES </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="248" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="242"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
       ...
       <div id="Layer1" style="position:absolute; width:504px; height:94px; z-index:1; top: 81px; left: 42px;">
         <table width="828" border="0" align="center" >
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="260" scope="col"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong>
                   <input name="Catalogo1" type="button" id="Catalogo1" title="Abrir Catalogo de Trabajadores" onClick="VentanaCentrada('../Cat_Trabajadoresvacad.php?criterio=','SIA','','650','500','true')" value="...">
                 </strong></strong></span></span></span></td>
                 <td width="50" scope="col"><span class="Estilo5">HASTA :</span></td>
                 ...
                 <td width="108" scope="col"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong>
                   <input name="Catalogo2" type="button" id="Catalogo2" title="Abrir Catalogo de Trabajadores" onClick="VentanaCentrada('../Cat_Trabajadoresvacah.php?criterio=','SIA','','650','500','true')" value="...">
                 </strong></strong></span></span></span></td>
               </tr>
             </table></td>
           </tr>
           <tr>
             <td><table width="905">
               <tr>
                 <td width="107" scope="col"><div align="left"><span class="Estilo5">OBSERVACIONES :</span></div></td>
                 <td width="786" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10">
                     <textarea name="txtcant_vence_fact22532222232" cols="85" id="txtcant_vence_fact22532222232" onFocus="encender(this)" onBlur="apagar(this)"></textarea>
                     <span class="menu"><strong><strong>                 </strong></strong></span> <span class="menu"><strong><strong> </strong></strong></span></span> </span></div></td>
               </tr>
             </table></td>
           </tr>
             ...
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center">
                     <input name="btgenera2" type="button" id="btgenera2" value="GENERAR" onClick="javascript:Llama_Rpt_compro_vaca_mpv('Rpt_compro_vaca_mpv.php');">
                 </div></th>
