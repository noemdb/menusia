...
function Llama_Rpt_con_asig_trab_cata(murl){var url;var r;
  r=confirm("Desea Generar el Reporte de Conceptos Asignados por Trabajador?");
  if (r==true){
    url=murl+"?&tipo_nomina_d="+document.form1.txttipo_nomina_d.value+"&tipo_nomina_h="+document.form1.txttipo_nomina_h.value+"&cod_empleado_d="+document.form1.txtcod_empleado_d.value+"&cod_empleado_h="+document.form1.txtcod_empleado_h.value+"&cod_cedula_d="+document.form1.txtcedula_d.value+"&cod_cedula_h="+document.form1.txtcedula_h.value+"&cod_concepto_d="+document.form1.txtcod_concepto_d.value+"&cod_concepto_h="+document.form1.txtcod_concepto_h.value+"&tipo_rpt="+document.form1.tipo_rpt.value;
    window.open(url,"Reporte de Conceptos Asignados por Trabajador")}
}
...
<?
$descripcion_d="";$descripcion_h=""; $nombre_d="";$nombre_h=""; $denominacion_d="";$denominacion_h="";
...
$sql="SELECT MAX(cedula) As Max_cedula, MIN(cedula) As Min_cedula FROM nom006 ";$res=pg_query($sql);
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE DE CONCEPTOS ASIGNADOS POR TRABAJADORES </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="477" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="470"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
         ...
         <table width="828" border="0" align="center" >
           ...
           <tr>
             <td><div align="left">
               <table width="894">
                   <tr>
                     <th width="445" scope="col"><div align="center">  <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_con_asig_trab_cata('Rpt_con_asig_trab_cata.php');">    </div></th>
