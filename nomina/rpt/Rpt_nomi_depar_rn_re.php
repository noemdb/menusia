<?$gnomina="00"; include ("../../class/seguridad.inc");include ("../../class/conects.php");  include ("../../class/funciones.php"); include ("../../class/configura.inc");
$conn=pg_connect("host=".$host." port=".$port." password=".$password." user=".$user." dbname=".$dbname."");
if (pg_ErrorMessage($conn)){ ?> <script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script> <? } else { $Nom_Emp=busca_conf(); }
$sql="SELECT campo103 FROM sia001 where campo101='$usuario_sia'"; $resultado=pg_exec($conn,$sql);$filas=pg_numrows($resultado);  $tipo_u="U";
if ($filas>0){$registro=pg_fetch_array($resultado); $tipo_u=$registro["campo103"]; $tiene_acceso="S";} $Mcamino="NNNNNNNNNNNNNNNNNNNN";
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="04"; $opcion="03-0000035"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 if ($filas>0){$reg=pg_fetch_array($res); $Mcamino=$reg["campo607"].$reg["campo608"].$reg["campo609"].$reg["campo610"].$reg["campo611"].$reg["campo612"].$reg["campo613"].$reg["campo614"].$reg["campo615"].$reg["campo616"].$reg["campo617"].$reg["campo618"].$reg["campo619"].$reg["campo620"].$reg["campo621"].$reg["campo622"].$reg["campo623"].$reg["campo624"].$reg["campo625"].$reg["campo626"]; }
}$posicion=strpos($Mcamino,'S'); if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> document.location='../menu.php';</script><?}
$tipo_nominad="";$tipo_nominah="zz";$codigo_departamentod="";$codigo_departamentoh="zzzzzzzzzzzzzzzz";$estatus_trab_d="";$ocultar_n="";$imprimir_esp="";$mostrar_cant="";$mostrar_saldo="";$tipo_reporte="";$forma_pago="";$cod_presup_catd="";$cod_presup_cath="zz";$tipo_calculo="";
$fecha_nomina=asigna_fecha_hoy(); if ($gnomina=="00"){ $criterion=""; $criterioc=""; $temp_nomina="";}else{ $temp_nomina=$gnomina; $criterion=" where tipo_nomina='$gnomina' ";  $criterioc=" and tipo_nomina='$gnomina' ";}
?>
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reporte Nomina por Departamento)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK href="../../class/sia.css" type="text/css" rel="stylesheet">
<script language="JavaScript" src="../../class/sia.js" type="text/javascript"></script>
<script language="JavaScript" type="text/JavaScript">
function Llama_Rpt_nomi_depar_rn(murl){var url;var r; var grupo_rpt=document.form1.grupo_rpt.value;
  if(grupo_rpt=="CAT"){  murl="Rpt_nomi_categoria_rn.php";} 
  r=confirm("Desea Generar el Reporte de Nomina por Departamneto?");
  if (r==true){url=murl+"?&tipo_nomina_d="+document.form1.txttipo_nomina_d.value+"&tipo_nomina_h="+document.form1.txttipo_nomina_h.value+"&estatus_trab_d="+document.form1.txtestatus_t.value+"&tipo_concepto="+document.form1.txtconcepto_t.value+   
  "&ocultar_n=N&imprimir_esp=N&mostrar_cant=N&mostrar_saldo=N&tipo_reporte="+document.form1.txttipo_report.value+"&forma_pago="+document.form1.txtforma_pago.value+
  "&cod_presup_catd="+document.form1.txtcod_presup_d.value+"&cod_presup_cath="+document.form1.txtcod_presup_h.value+"&tipo_calculo="+document.form1.txttipo_calculo.value+
  "&cod_departd="+document.form1.txtcodigo_departamento_d.value+"&cod_departh="+document.form1.txtcodigo_departamento_h.value+"&act_hist="+document.form1.txtact_hist.value+"&fecha_nom="+document.form1.txtfecha_nom.value+"&num_periodos="+document.form1.txtnum_periodos.value+
  "&salto_dep="+txtsalto_dep.value+"&esp_firma="+document.form1.txtesp_firma.value+"&tipo_rpt="+document.form1.tipo_rpt.value+"&rango_f="+document.form1.txtrang_fec.value+"&fecha_desde="+document.form1.txtfecha_nomd.value+"&fecha_hasta="+document.form1.txtfecha_nomh.value;
  window.open(url,"Reporte de Nomina por Departamneto")}
}
...
$sql="SELECT fecha_p_hasta,fecha_p_desde FROM nom017 where tipo_nomina='$tipo_nomina_d' and tp_calculo='N'"; $res=pg_query($sql); $fecha_nominad=$fecha_nomina;
...
<table width="977" height="485" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="480"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
         <form name="form1" method="post" action="">
       <div id="Layer1" style="position:absolute; width:460px; height:94px; z-index:1; top: 60px; left: 42px;">
         <table width="828" border="0" align="center" >
		   ...
		   <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
                 ...
                 <td width="125" align="left" class="Estilo5"><input class="Estilo10" name="txtcod_presup_d" type="text" id="txtcod_presup_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $cod_presup_catd?>" size="16" maxlength="20">  </td>
                 <td width="100" align="left" class="Estilo5"><input class="Estilo10" name="cat_catd" type="button" id="cat_catd" title="Abrir Catalogo de Categorias" onClick="VentanaCentrada('../Cat_codigos_catd.php?criterio=','SIA','','750','500','true')" value="..."></td>
                 <td width="63" align="left" class="Estilo5">HASTA:</td>
                 <td width="125" align="left" class="Estilo5"><input class="Estilo10" name="txtcod_presup_h" type="text" id="txtcod_presup_h" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $cod_presup_cath?>" size="16" maxlength="20"> </td>
                 <td width="100"align="left" class="Estilo5"><input class="Estilo10" name="cat_cath" type="button" id="cat_cath" title="Abrir Catalogo de Categorias" onClick="VentanaCentrada('../Cat_codigos_cath.php?criterio=','SIA','','750','500','true')" value="..."> </td>
                 <td width="105" align="left" class="Estilo5">AGRUPAR POR:</td>
				 <td width="160"><span class="Estilo5"> <select class="Estilo10" name="grupo_rpt" id="grupo_rpt"> <option value='DEP'>DEPARTAMENTO</option><option value='CAT'>CATEGORIA</option> </select></span></td>              
            <!--
			     <td width="160"><span class="Estilo5"> <select class="Estilo10" name="grupo_rpt" id="grupo_rpt"> <option value='CAT'>CATEGORIA</option><option value='DEP'>DEPARTAMENTO</option> </select></span></td>              
             -->
			  </tr>
             </table></td>
           </tr>
		   ...
		   <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
			     <td width="200"  align="left" class="Estilo5">TIPO DE REPORTE :</td>	
                 <td width="250" align="left"><span class="Estilo5"><select class="Estilo10" name="txttipo_report" size="1" id="txttipo_report"><option value='N' selected>NOMINA</option> <option value='P'>PRE-NOMINA</option></select></span></td>
		   ...
		   <tr>
            <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
                 <td width="200"  align="left" class="Estilo5">CONCEPTOS CALCULADOS POR :</td>
				 ...
				 <td width="180"  align="left" class="Estilo5">SALTO POR DEPARTAMENTO :</td>				 
				 <td width="270"><span class="Estilo5"> <select class="Estilo10" name="txtsalto_dep" id="txtsalto_dep"> <option value='SI'>SI</option><option value='NO'>NO</option> </select></span></td>              
              </tr>
             </table></td>
           </tr>
		   <tr>
            <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
                 <td width="200"  align="left" class="Estilo5">ESPACIO PARA FIRMAS :</td>
				 <td width="250" align="left"><span class="Estilo5"><select class="Estilo10" name="txtesp_firma" size="1" id="txtesp_firma"><option value='NO' selected>NO</option><option value='SI'>SI</option></select></span></td>
           ...
           <tr><td>&nbsp;</td></tr>
		   <?if(($Cod_Emp=="58")OR ($Cod_Emp=="A1")or($Cod_Emp=="A4")){?>
           <tr>
           ...
           <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
                 <th width="446" scope="col"><div align="center"><input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_nomi_depar_rn('Rpt_nomi_depar_rn.php');">  </div></th>
