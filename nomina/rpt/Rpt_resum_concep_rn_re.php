...
function Llama_Rpt_rela_concep_rn(murl){var url;var r; var mtipo_monto=document.form1.tipo_monto.value;
  ...
  if (r==true){url=murl+"?&tipo_nomina_d="+document.form1.txttipo_nomina_d.value+"&tipo_nomina_h="+document.form1.txttipo_nomina_h.value+"&estatus_trab_d="+document.form1.txtestatus_t.value+"&tipo_concepto="+document.form1.txtconcepto_t.value+"&num_periodos="+document.form1.txtnum_periodos.value+
  "&cod_departd="+document.form1.txtcodigo_departamento_d.value+"&cod_departh="+document.form1.txtcodigo_departamento_h.value+"&tipo_reporte="+document.form1.txttipo_report.value+"&forma_pago="+document.form1.txtforma_pago.value+"&tipo_calculo="+document.form1.txttipo_calculo.value+
  "&act_hist="+document.form1.txtact_hist.value+"&fecha_nom="+document.form1.txtfecha_nom.value+"&tipo_resumen="+document.form1.txttipo_resumen.value+"&tipo_rpt="+document.form1.tipo_rpt.value+"&tipo_monto="+mtipo_monto;   
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE RESUMEN DE CONCEPTOS </div></td>
...
<table width="977" height="426" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="410"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
       ...
       <div id="Layer1" style="position:absolute; width:504px; height:94px; z-index:1; top: 62px; left: 45px;">
         <table width="828" border="0" align="center" >
		   ...
		   <tr>
             <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
			     <td width="200"  align="left" class="Estilo5">TIPO DE RESUMEN :</td>	
                 <td width="250" align="left"><span class="Estilo5"><select class="Estilo10" name="txttipo_resumen" size="1" id="txttipo_resumen"> <option value='A' selected>ASIGNACIONES</option> <option value='D'>DEDUCCIONES</option> <option value='P'>APORTE</option> <option value='T'>TODOS</option>  </select></span></td>
           ...
           <tr>
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center"><input  name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_rela_concep_rn('Rpt_resumen_concep_rn.php');">    </div></th>
