...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL  (Reporte Disponibilidad de Periodo)</title>
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="260"><span class="Estilo5"> <select class="Estilo10" name="txt_mes_hasta">
          ...
          <td height="19"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
			  ...
			  <td width="505"><table width="115" height="30" border="1">
                <tr>
                  <td width="504" valign="top"><span class="Estilo5"> <input class="Estilo10" name="opasig" type="radio" value="S" checked> SI </span>
        ...
        <tr>
          <td height="19"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
			  ...
			  <td width="505"><select class="Estilo10" name="txtsubtotal" id="txtsubtotal" onFocus="encender(this)" onBlur="apagar(this);"> 
...
function Llama_Rpt_Disponibilidad_Perio(murl){var url;var r;var asig; var s; 
  ...
  if (r==true) { url=murl+"?cod_presupd="+document.form1.txtcod_presupd.value+"&cod_presuph="+document.form1.txtcod_presuph.value+"&cod_fuented="+document.form1.txtcod_fuented.value+"&cod_fuenteh="+document.form1.txtcod_fuenteh.value+"&mes_desde="+document.form1.txt_mes_desde.value+"&mes_hasta="+document.form1.txt_mes_hasta.value+"&asig_global="+asig+"&csubtotal="+s+"&tipo_rpt="+document.form1.tipo_rpt.value;
        window.open(url);
  }
}
