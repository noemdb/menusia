...
function Llama_Rpt_rela_concep_rn(murl){var url;var r; var mtipo_monto=document.form1.tipo_monto.value;
  ...
  r=confirm("Desea Generar el Reporte Relacion de Conceptos?");
  ...
  "&act_hist="+document.form1.txtact_hist.value+"&fecha_nom="+document.form1.txtfecha_nom.value+"&tipo_rpt="+document.form1.tipo_rpt.value+"&tipo_monto="+mtipo_monto+"&rango_f="+document.form1.txtrang_fec.value+"&fecha_desde="+document.form1.txtfecha_nomd.value+"&fecha_hasta="+document.form1.txtfecha_nomh.value;
  window.open(url,"Reporte Relacion de Conceptos")}
}
       ...
       <div id="Layer1" style="position:absolute; width:504px; height:94px; z-index:1; top: 62px; left: 45px;">
         <table width="828" border="0" align="center" >
           ...
           <tr>
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center"><input  name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_rela_concep_rn('Rpt_rela_concep_rn.php');">    </div></th>
