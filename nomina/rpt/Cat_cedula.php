...
function cerrar_catalogo(cedula,nomb){
  ...
  window.opener.document.forms[0].txtnombre_d.value = nomb;
...
<?
        ...
        $sql="SELECT * FROM nom006 ".$criterio;
...
<form action="../Nomina/Cat_departamentoh.php" method="get">
