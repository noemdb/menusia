...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="04"; $opcion="03-0000120"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reporte Informacion Hoja de Vida del Trabajador)</title>
...
function Llama_Rpt_info_ho_vid_mp_mit(murl){var url; var r;
  ...
  if (r==true) {url=murl+"?cod_empleado_d="+document.form1.txtcod_empleado_d.value+"&cod_empleado_h="+document.form1.txtcod_empleado_h.value+
    "&tipo_nominad="+document.form1.txttipo_nomina_d.value+"&tipo_nominah="+document.form1.txttipo_nomina_h.value+
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE DE INFORMACI&Oacute;N HOJA DE VIDA DEL TRABAJADOR </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="525" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="519"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
             ...
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center">
                     <input class="Estilo10" name="btgenera2" type="button" id="btgenera25" value="GENERAR" onClick="javascript:Llama_Rpt_info_ho_vid_mp_mit('Rpt_info_ho_vid_mp_mit.php');">
                 </div></th>
                 <th width="447" scope="col"><input class="Estilo10" name="btcancelar2" type="button" id="btcancelar25" value="CANCELAR" onClick="javascript:Llama_Menu_Rpt('menu.php');"></th>
               </tr>
             </table></td>
           </tr>
         </table>
