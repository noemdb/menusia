...
function Llama_Rpt_compro_liqui_mpr(murl){
var url; var r;

  r=confirm("Desea Generar el Reporte Comprobante de Liquidacion?");
  if (r==true) {url=murl+"?cod_empleado_d="+document.form1.txtcod_empleado_d.value+"&cod_empleado_h="+document.form1.txtcod_empleado_h.value;
   window.open(url,"Reporte Comprobante de Liquidacion")
  }
}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE DE COMPROBANTE DE LIQUIDACION</div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="233" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="227"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
       ...
       <div id="Layer1" style="position:absolute; width:504px; height:94px; z-index:1; top: 81px; left: 42px;">
         <table width="828" border="0" align="center" >
           ...
           <tr>
             <td><table width="905">
               <tr>
                 <td width="237" scope="col"><div align="right"></div></td>
                 <td width="389" scope="col"><div align="center"><span class="Estilo5"><span class="Estilo10"><span class="Estilo12">EXPRESADO EN </span></span></span></div></td>
                 <td width="263" scope="col">&nbsp;</td>
               </tr>
             </table></td>
           </tr>
           <tr>
             <td><table width="905">
               <tr>
                 <td width="366" scope="col"><div align="right"><span class="Estilo5">
        </span></div></td>
                 <td width="527" scope="col"><span class="Estilo5">
      </span>
                    <div align="left"><span class="Estilo5">
                      <select name="select2" size="1" id="select2">
                        <option>BOLIVARES</option>
                        <option selected>BOLIVARES FUERTES</option>
                                                                                        </select>
                    </span></div></td>
               </tr>
             </table></td>
             ...
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center">
                     <input name="btgenera2" type="button" id="btgenera2" value="GENERAR" onClick="javascript:Llama_Rpt_compro_liqui_mpr('Rpt_compro_liqui_mpr.php');">
                 </div></th>
                 <th width="447" scope="col"><input name="btcancelar2" type="button" id="btcancelar24" value="CANCELAR" onClick="javascript:Llama_Menu_Rpt('menu.php');"></th>
               </tr>
             </table></td>
           </tr>
         </table>
