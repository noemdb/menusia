...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="04"; $opcion="03-0000140"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 if ($filas>0){$reg=pg_fetch_array($res); $Mcamino=$reg["campo607"].$reg["campo608"].$reg["campo609"].$reg["campo610"].$reg["campo611"].$reg["campo612"].$reg["campo613"].$reg["campo614"].$reg["campo615"].$reg["campo616"].$reg["campo617"].$reg["campo618"].$reg["campo619"].$reg["campo620"].$reg["campo621"].$reg["campo622"].$reg["campo623"].$reg["campo624"].$reg["campo625"].$reg["campo626"]; }
}$posicion=strpos($Mcamino,'S'); if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> document.location='../menu.php';</script><?}
$fecha_d="01/01/1970";  $fecha_h=formato_ddmmaaaa($Fec_Fin_Ejer);  $fecha_hoy=asigna_fecha_hoy(); $fecha_h=$fecha_hoy; $cod_empleado_d="";   $cod_empleado_h="zzzzzzzzzzzzzzz";
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reporte Control Individual de Prestaciones)</title>
...
function Llama_Rpt_con_indi_pres_mpr(murl){var url; var r;
  ...
  if (r==true) {url=murl+"?tipo_nominad="+document.form1.txttipo_nomina_d.value+"&tipo_nominah="+document.form1.txttipo_nomina_h.value+"&cod_empleado_d="+document.form1.txtcod_empleado_d.value+"&cod_empleado_h="+document.form1.txtcod_empleado_h.value+"&fecha_h="+document.form1.txtFechah.value+"&estatus="+document.form1.txtestatus.value+"&detalle="+document.form1.txtdetalle.value+"&tipo_rpt="+document.form1.tipo_rpt.value;
...
<?  $nombre_d="";$nombre_h=""; $descripcion_d=""; $descripcion_h="";   
...
$res=pg_query($sql);if ($registro=pg_fetch_array($res,0)){ $cod_empleado_d=$registro["min_cod_empleado"]; $cod_empleado_h=$registro["max_cod_empleado"];   }
?>
</head>
<body>
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE DE CONTROL INDIVIDUAL DE PRESTACIONES E INTERESES</div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="382" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="376"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
         <form name="form1" method="post" action="">
       <div id="Layer1" style="position:absolute; width:504px; height:345px; z-index:1; top: 70px; left: 43px;">
         <table width="828" border="0" align="center" >
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="725"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)">
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="725"><div align="left"><span class="Estilo5">
           ...
           <tr>
             <td><table width="905">
               <tr>
				 ...
				 <td width="305" align="left"><span class="Estilo5"><select class="Estilo10" name="tipo_rpt" id="tipo_rpt"> <option value='HTML'>FORMATO HTML</option><option value='PDF'>FORMATO PDF</option>  <option value='PDF2'>FORMATO PDF2</option> </select></span></td>
               </tr>
             </table></td>
           </tr>
           <tr><td>&nbsp;</td></tr>	
           ...
           <tr>
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center"><input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_con_indi_pres_mpr('Rpt_con_indi_pres_mpr.php');">  </div></th>
