...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="04"; $opcion="03-0000155"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
$fecha_hoy=asigna_fecha_hoy(); if ($gnomina=="00"){ $criterion=""; $criterioc=""; $temp_nomina="";}else{ $temp_nomina=$gnomina; $criterion=" where tipo_nomina='$gnomina' ";  $criterioc=" and tipo_nomina='$gnomina' ";}
 $fecha_d=colocar_pdiames($fecha_hoy); $fecha_h=colocar_udiames($fecha_hoy); 
?>
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reporte Ralaci&oacute;n de Saldo de Prestaciones e Intereses)</title>
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE DE RELACI&Oacute;N  DE PRESTACIONES E INTERESES POR MES </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="250" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="240"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
         <form name="form1" method="post" action="">
       <div id="Layer1" style="position:absolute; width:504px; height:94px; z-index:1; top: 72px; left: 39px;">
             ...
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center">
                     <input name="btgenera2" type="button" id="btgenera26" value="GENERAR" onClick="javascript:Llama_Rpt_rela_pres_inte_mes_mpr('Rpt_rela_pres_inte_mes_mpr.php');">
                 </div></th>
