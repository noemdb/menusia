...
<html>
<head>
<title>SIPAP CONTROL N&Oacute;MINA Y PERSONAL  (Reporte de Modificaciones al Presupuesto)</title>
...
function Llama_Rpt_modifica(murl){var url;var r;var tipo;
  ...
  if (r==true) {
    url=murl+"?referencia_d="+document.form1.txtreferencia_d.value+"&referencia_h="+document.form1.txtreferencia_h.value+
...
"&cod_fuented="+document.form1.txtcod_fuented.value+"&cod_fuenteh="+document.form1.txtcod_fuenteh.value+"&tipo_modif="+document.form1.txttipo_modif.value+"&agrupa_cat="+document.form1.txtgrupo_cat.value+"&agrupa_par="+document.form1.txtgrupo_par.value+"&agrupa_fuen="+document.form1.txtgrupo_fuen.value+"&tipo_rep="+document.form1.txttipo_rep.value;
        window.open(url);
  }
}
      ...
      <td width="958" height="557" align="center" valign="top"><table width="830" height="550" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="10"><table width="827" border="0">
            <tr>
              <td width="210" height="26"><span class="Estilo5">REFERENCIA :</span></td>
          ...
          <td height="10"><table width="827" border="0">
            <tr>
              <td width="212" height="24">
                <span class="Estilo5">FECHA MODIFICACION : </span></td>
        ...
        <tr>
         ...
         <tr>
          <td height="5"><table width="824" border="0">
            <tr>
              <td width="213"><div align="right"> </div></td>
       ...
       <tr>
		...
		<tr>
          <td height="10"><table width="828" border="0">
            <tr>
        ...
        <tr>
          <td height="10"><table width="814" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="230"><select class="Estilo10" name="txttipo_modif">
			    <option>TODOS</option>
			  ...
			  <td width="190"><span class="Estilo5"> <select class="Estilo10" name="txtgrupo_cat"><option selected >NO</option><option >SI</option></select></span></td> 
        ...
        <tr>
          <td height="10"><table width="814" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  <td width="184"><span class="Estilo5"> <select class="Estilo10" name="txtgrupo_par"><option selected >NO</option><option >SI</option></select></span></td> 
              <td width="210"><div align="center"><span class="Estilo5">AGRUPAR FUENTE :</span></div></td>
			  <td width="190"><span class="Estilo5"> <select class="Estilo10" name="txtgrupo_fuen"><option selected >NO</option><option >SI</option></select></span></td> 
