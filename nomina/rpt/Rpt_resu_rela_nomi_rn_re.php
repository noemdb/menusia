...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="04"; $opcion="03-0000080"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 if ($filas>0){$reg=pg_fetch_array($res); $Mcamino=$reg["campo607"].$reg["campo608"].$reg["campo609"].$reg["campo610"].$reg["campo611"].$reg["campo612"].$reg["campo613"].$reg["campo614"].$reg["campo615"].$reg["campo616"].$reg["campo617"].$reg["campo618"].$reg["campo619"].$reg["campo620"].$reg["campo621"].$reg["campo622"].$reg["campo623"].$reg["campo624"].$reg["campo625"].$reg["campo626"]; }
}$posicion=strpos($Mcamino,'S'); if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> document.location='../menu.php';</script><?}
$tipo_nominad="";$tipo_nominah="zz";$codigo_departamentod="";$codigo_departamentoh="zzzz";$tipo_reporte="";$forma_pago="";$tipo_calculo="";$fecha_nomina=asigna_fecha_hoy();
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reporte Resumen Relaci&oacute;n Nominas)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK href="../../class/sia.css" type="text/css" rel="stylesheet">
<script language="JavaScript" src="../../class/sia.js" type="text/javascript"></script>
<script language="JavaScript" type="text/JavaScript">
function Llama_Rpt_resu_rela_nomi_rn(murl){var url;var r; var mforma="TODOS";
  r=confirm("Desea Generar el Reporte Resumen Relacion Nominas?");
  if (r==true){url=murl+"?&tipo_nomina_d="+document.form1.txttipo_nomina_d.value+"&tipo_nomina_h="+document.form1.txttipo_nomina_h.value+"&estatus_trab_d="+document.form1.txtestatus_t.value+"&forma_pago="+mforma+"&tipo_concepto="+document.form1.txtconcepto_t.value+"&num_periodos="+document.form1.txtnum_periodos.value+
  "&cod_departd="+document.form1.txtcodigo_departamento_d.value+"&cod_departh="+document.form1.txtcodigo_departamento_h.value+"&tipo_calculo="+document.form1.txttipo_calculo.value+"&act_hist="+document.form1.txtact_hist.value+"&fecha_nom="+document.form1.txtfecha_nom.value+"&tipo_rpt="+document.form1.tipo_rpt.value+"&rango_f="+document.form1.txtrang_fec.value+"&fecha_desde="+document.form1.txtfecha_nomd.value+"&fecha_hasta="+document.form1.txtfecha_nomh.value;
  window.open(url,"Reporte Resumen Relacion Nominas")}
}
...
if ($registro=pg_fetch_array($res,0)){$tipo_nomina_d=$registro["min_tipo_nomina"];$tipo_nomina_h=$registro["min_tipo_nomina"];   }
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">  REPORTE DE RESUMEN RELACI&Oacute;N DE NOMINA </div></td>
...
<table width="977" height="396" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="390"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
       ...
       <div id="Layer1" style="position:absolute; width:504px; height:94px; z-index:1; top: 60px; left: 45px;">
           ...
           <tr>
            <td><table width="903" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
				 ...
				 <td width="250" align="left"><span class="Estilo5"><select class="Estilo10" name="txtestatus_t" size="1" id="txtestatus_t"><option value='TODOS' selected>TODOS</option> <option value='ACTIVO'>ACTIVO</option> <option value='VACACIONES'>VACACIONES</option></select>
                 </span></td>
             ...
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center">
                     <input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_resu_rela_nomi_rn('Rpt_resu_rela_nomi_rn.php');"> 
                 </div></th>
