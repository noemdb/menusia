...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="04"; $opcion="03-0000110"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reportes Maestro de Trabajadores)</title>
...
return true;}
function Llama_Rpt_ma_traj_mp(murl){var url; var r; var per; var car;
  per=document.form1.txtmost_inf_p.value;car=document.form1.txtmost_inf_c.value;
  r=confirm("Desea Generar el Reporte Maestro de Trabajadores?");
  ...
  "&inf_per="+per+"&inf_car="+car+"&tipo_rpt="+document.form1.tipo_rpt.value;   window.open(url,"Reporte Maestro de Trabajadores")
  }
}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE DE MAESTRO DE TRABAJADORES </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="575" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="569"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
       ...
       <div id="Layer1" style="position:absolute; width:504px; height:94px; z-index:1; top: 61px; left: 42px;">
         <table width="828" border="0" align="center" >
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="30"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txttipo_nomina_d" type="text" id="txttipo_nomina_d" onFocus="encender(this)" onBlur="apaga_tipo(this)" size="2" maxlength="2" value="<?echo $tipo_nomina_d?>"  onchange="chequea_tipo(this.form);">  </span></div></td>
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="269"><div align="left"><span class="Estilo5">  <input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_d?>" size="12" maxlength="10" onChange="checkrefechad(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
                  <img src="../../imagenes/img_cal.png" width="20" height="14" id="calendario1" style="cursor: pointer; border: 1px solid blue;" title="Seleccionar Fecha"
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario1')"  /></span></div></td>
                 <td width="56"><span class="Estilo5">HASTA :</span></td>
                 <td width="378"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_h?>" size="12" maxlength="10" onChange="checkrefechah(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
           ...
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="269"><div align="left"><span class="Estilo5"><input class="Estilo10" name="txtedad_d" type="text" id="txtedad_d" size="5" maxlength="15"  onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $edad_d?>"> </span></div></td>
                 <td width="56"><span class="Estilo5">HASTA :</span></td> <td width="378"><span class="Estilo5"><input class="Estilo10" name="txtedad_h" type="text" id="txtedad_h" size="5" maxlength="15"  onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $edad_h?>">   </span></td>
               </tr>
             </table></td>
           </tr>
           <tr>
             <td><table width="905">
               <tr>
                 ...
                 <td width="272"><div align="left"><span class="Estilo5">  <input class="Estilo10" name="txtFechaingresod" type="text" id="txtFechaingresod" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_d?>" size="12" maxlength="10" onChange="checkfechaingd(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
                ...
                onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario9')"  />  </span></div></td>
                 ...
                 <td width="376"><span class="Estilo5"> <input class="Estilo10" name="txtFechaingresoh" type="text" id="txtFechaingresoh" onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_h?>" size="12" maxlength="10" onChange="checkfechaingh(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
           ...
           <tr>
             <td><table width="905">
               <tr>
                 <td width="277"><div align="right"><span class="Estilo5">MOSTRAR INFORMACION PERSONAL : </span></div></td>
				 <td width="169" align="left"><span class="Estilo5"><select class="Estilo10" name="txtmost_inf_p" size="1" id="txtmost_inf_p"> <option value='S' selected>SI</option> <option value='N'>NO</option> </select></span></td>
				 <td width="230"><span class="Estilo5"><span class="Estilo12">MOSTRAR INFORMACION DE CARGO :</span></span></td>
				 <td width="269" align="left"><span class="Estilo5"><select class="Estilo10" name="txtmost_inf_c" size="1" id="txtmost_inf_c"> <option value='S' selected>SI</option> <option value='N'>NO</option> </select></span></td>
           ...
           <tr>
             <td><table width="894">
               <tr>
                 <th width="445"><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_ma_traj_mp('Rpt_ma_traj_mp.php');"> </div></th>
