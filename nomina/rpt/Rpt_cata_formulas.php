...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reporte catalogo de Formulas)</title>
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE CATALOGO FORMULAS DE CONCEPTOS</div></td>
         ...
         <table width="828" border="0" align="center" >
           ...
           <tr>
             <td><div align="left">
               <table width="894">
                   <tr>
                     <th width="445" scope="col"><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_con_asig_trab_cata('Cat_formu_concep_cata_re.php');">    </div></th>
