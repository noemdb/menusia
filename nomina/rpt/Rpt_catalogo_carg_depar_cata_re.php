...
function Llama_Rpt_catalogo_carg_depar_cata(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Catalogo de Cargos por Departamentos ?");
  if (r==true){
    url=murl+"?&codigo_departamento_d="+document.form1.txtcodigo_departamento_d.value+"&codigo_departamento_h="+document.form1.txtcodigo_departamento_h.value+"&codigo_cargo_d="+document.form1.txtcodigo_cargo_d.value+"&codigo_cargo_h="+document.form1.txtcodigo_cargo_h.value+"&tipo_rpt="+document.form1.tipo_rpt.value;
    window.open(url,"Reporte Catalogo de Cargos por Departamentos")}
}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE CATALOGO DE CARGOS POR DEPARTAMENTOS</div></td>
               ...
               <table width="894">
                   <tr>
                     <th width="445" scope="col"><div align="center">
                         <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_catalogo_carg_depar_cata('Rpt_catalogo_carg_depar_cata.php');">
                     </div></th>
