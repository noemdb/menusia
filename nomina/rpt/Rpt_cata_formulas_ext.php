...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="04"; $opcion="03-0000015"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reporte catalogo de Formulas Extraordinaria)</title>
...
function Llama_Rpt_con_asig_trab_cata(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Catalogo Formulas de Conceptos ?");
  if (r==true){
    ...
    window.open(url,"Reporte Catalogo Formulasde Conceptos")}
}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> REPORTE CATALOGO FORMULAS DE CONCEPTOS EXTRAORDINARIAS</div></td>
         ...
         <table width="828" border="0" align="center" >
           ...
           <tr>
             <td><div align="left">
               <table width="894">
                   <tr>
                     <th width="445" scope="col"><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_con_asig_trab_cata('Cat_formu_concep_ext_re.php');">    </div></th>
