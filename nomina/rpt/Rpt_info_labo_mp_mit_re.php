...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="04"; $opcion="03-0000121"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reportes Informaci&oacute;n Laboral)</title>
...
return true;}
function Llama_Rpt_info_labo_mp_mit(murl){var url; var r; var per; 
  r=confirm("Desea Generar el Reporte Informacion Laboral?");
  ...
  "&codigo_departamentod="+document.form1.txtcodigo_departamento_d.value+"&codigo_departamentoh="+document.form1.txtcodigo_departamento_h.value+"&tipo_rpt="+document.form1.tipo_rpt.value;   
   window.open(url,"Reporte Informacion Laboral")
  }
}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE DE INFORMACI&Oacute;N LABORAL DEL TRABAJADOR  </div></td>
       ...
       <div id="Layer1" style="position:absolute; width:504px; height:94px; z-index:1; top: 61px; left: 42px;">
         <table width="828" border="0" align="center" >
           ...
           <tr>
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center"><input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_info_labo_mp_mit('Rpt_info_labo_mp_mit.php');"></div></th>
