...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="04"; $opcion="03-0000165"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Reporte Listado de Movmientos de Prestaciones e Intereses)</title>
...
return true;}
function Llama_Rpt_rela_pres_inte_mes_mpr(murl){
var url; var r;
  r=confirm("Desea Generar el Reporte Relacion de Prestaciones e Intereses por Mes?");
  if (r==true) {url=murl+"?cod_empleado_d="+document.form1.txtcod_empleado_d.value+"&cod_empleado_h="+document.form1.txtcod_empleado_h.value+
   ...
   window.open(url,"Reporte Relacion de Prestaciones e Intereses por Mes")
  }
}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6"> LISTADO MOVIMIENTOS DE PRESTACIONES E INTERESES</div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="282" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="276"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
         <form name="form1" method="post" action="">
       <div id="Layer1" style="position:absolute; width:504px; height:245px; z-index:1; top: 70px; left: 43px;">
         <table width="828" border="0" align="center" >
		   ...
		   <tr>
             <td><table width="905" border="0" align="center" cellpadding="0" cellspacing="0" >
               <tr>
			     <td width="180"  align="left" class="Estilo5">FECHA PROCESO DESDE :</td>	
				 <td width="230" align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" size="12" maxlength="10"  onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_d?>" onchange="checkrefecha(this.form)" onkeyup="mascara(this,'/',patronfecha,true)">
				 ...
				 <td width="100"  align="left" class="Estilo5">HASTA :</td>				 
				 <td width="390" align="left"><span class="Estilo5"><input class="Estilo10" name="txtFechah" type="text" id="txtFechah" size="12" maxlength="10"  onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $fecha_h?>" onchange="chequea_fecha(this);" onkeyup="mascara(this,'/',patronfecha,true)">
             ...
             <td><table width="905">
               <tr>
                 <th width="446" scope="col"><div align="center">
                     <input name="btgenera2" type="button" id="btgenera26" value="GENERAR" onClick="javascript:Llama_Rpt_rela_pres_inte_mes_mpr('Rpt_lis_movi_pres_inte_mpr.php');">
                 </div></th>
