...
function CargarUrl(mcodigo){var murl;  if(mcodigo.charAt(0)=='C'){mcodigo='C'+mcodigo;} if(mcodigo.charAt(0)=='A'){mcodigo='C'+mcodigo;}  if(mcodigo.charAt(0)=='S'){mcodigo='C'+mcodigo;} if(mcodigo.charAt(0)=='P'){mcodigo='C'+mcodigo;} if(mcodigo.charAt(0)=='U'){mcodigo='C'+mcodigo;}
murl="Act_info_trabajadores.php?Gcod_empleado="+mcodigo;   document.location = murl;
}
</script></head>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATALOGO TRABAJADORES</div></td>
...
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1; $numPags=1;  if ($gnomina=="00"){ $criterion="";$criterioc=""; }else{ $criterion=" where tipo_nomina='$gnomina' ";  $criterioc=" and tipo_nomina='$gnomina' ";}
        ...
        $criterio = " where (cod_empleado  like '%" . $txt_criterio . "%' or cedula like '%" . $txt_criterio . "%' or nombre like '%" . $txt_criterio . "%')".$criterioc;}}
		...
		if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron resultados</font>"; $pagina=1; $inicio=1; $final=1; $numPags=1;
              ...
              if ($_GET["orden"]==""){$orden="cod_empleado";} else{$orden=$_GET["orden"];} $tamPag=15;if ($_GET["pagina"]==""){$pagina=1;$inicio=1;$final=$tamPag;}else{$pagina=$_GET["pagina"];}$limitInf=($pagina-1)*$tamPag;$numPags=ceil($numeroRegistros/$tamPag);
                ...
                echo "<th height='25' bgcolor='#99CCFF' ><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=cedula&criterio=".$txt_criterio."'>C&eacute;dula</a></th>";
...
<form action="Cat_act_trabajadores.php" method="get">
<table border="0" width="900">
  <tr>
	...
	<td width="100" >&nbsp;</td>
	<td width="100" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onClick="javascript:LlamarURL('Act_info_trabajadores.php')";
        onMouseOut="this.style.backgroundColor='#EAEAEA'"o"];" height="20" align="center" bgcolor=#EAEAEA><a class=menu href="Act_info_trabajadores.php">Menu Anterior</a></div></td>
    <td width="100" >&nbsp;</td>
