...
<html>
<head>
<title>SIPAP NOMINA Y PERSONAL (Catalogo Trabajadores Calculo de Vacaciones)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK href="../class/sia.css" type="text/css" rel="stylesheet">
<script language="JavaScript" type="text/JavaScript">
function CargarUrl(mcodigo){var murl;  murl="Act_calculo_vacaciones_ima.php?Gcriterio=C"+mcodigo;   document.location = murl;}
</script></head>
<body>
...
<form action="Cat_calculo_vacaciones_ima.php" method="get">Criterio de busqueda:<input type="text" name="criterio" size="22" maxlength="150"> <input type="submit" value="Buscar">
</div>
</form>
</body>
</html>
