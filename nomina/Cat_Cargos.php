...
function cerrar_catalogo(codigo_cargo,des){
...
<form action="Cat_Cargos.php" method="get">Criterio de b&uacute;squeda:<input type="text" name="criterio" size="22" maxlength="150">
