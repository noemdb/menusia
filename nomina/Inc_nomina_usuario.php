...
<body>
<form name="form1" method="post" action="Insert_nom_usuario.php" onSubmit="return revisar()">
  <table width="740" height="150" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="739" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">INCLUIR NOMINAS A USUARIOS</span></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
             <td><table width="738">
