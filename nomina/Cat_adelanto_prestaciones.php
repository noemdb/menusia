...
function CargarUrl(mcodigo){var murl;  murl="Act_adelanto_prestaciones.php?Gcriterio="+mcodigo;   document.location = murl;}
</script></head>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    <td width="73"><div align="center" class="Estilo2 Estilo4"><img src="../imagenes/Logo_sia.gif" width="72" height="42"></div></td>
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATALOGO ADELANTO DE PRESTACIONES</div></td>
...
<?      $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1; $numPags=1; 
        ...
        $sql="SELECT cod_empleado,fecha_adelanto,nombre FROM ADELANTO_PRESTA ".$criterio;  $res=pg_query($sql);$numeroRegistros=pg_num_rows($res);
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron resultados</font>"; $pagina=1;$inicio=1;$final=1; $numPags=1; 
                ...
                $sql="SELECT cod_empleado,fecha_adelanto,nombre FROM ADELANTO_PRESTA ".$criterio." ORDER BY ".$orden;  $res=pg_query($sql);
                ...
                echo "<th height='25' bgcolor='#99CCFF' ><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=fecha_adelanto&criterio=".$txt_criterio."'>Fecha</a></th>";
                ...
                $linea=0; $Salir=false;
                while($registro=pg_fetch_array($res)) {$linea=$linea+1;  $fecha=formato_ddmmaaaa($registro["fecha_adelanto"]);
...
<form action="Cat_adelanto_prestaciones.php" method="get">Criterio de b&uacute;squeda:<input type="text" name="criterio" size="22" maxlength="150"> <input type="submit" value="Buscar">
</div>
</form>
</body>
</html>
