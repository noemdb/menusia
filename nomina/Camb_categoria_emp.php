...
function revisar(){ var f=document.form1; var Valido=true;
   //if(f.txtcod_categoria.value==""){alert("Categoria Actual no puede estar Vacio");return false;}
   if(f.txtcod_cat_alter.value==""){alert("Categoria Nueva no puede estar Vacio");return false;}
   if(f.txtcod_cat_alter.value==f.txtcod_categoria.value){alert("Codigo de Categoria no pueden ser Iguales");return false;}
   r=confirm("Desea Cambiar el Codigo de Categoria por cual se les paga a los Trabajadores Indicados ?"); if(r==true){r=confirm("Esta Realmente Seguro en cambiar el Codigo de Categoria por cual se les paga a los Trabajadores ?"); if(r==false){return false;}}
...
?>
<body>
<form name="form1" method="post" action="Update_categoria_emp.php" onSubmit="return revisar()">
  <table width="580" height="40" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="580" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">CAMBIAR CODIGO DE CATEGORIA DE TRABAJADORES </span></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
        ...
        <tr>
          <td align="center"><table width="560" border="0">
              <tr>
                <td width="170"><span class="Estilo5"> C&Oacute;DIGO CATEGORIA NUEVA :</span> </td>
                 ...
                 <td width="260"><input class="Estilo10" name="btcodcat" type="button" id="btcodcat" title="Abrir Catalogo Categorias"  onClick="VentanaCentrada('Cat_codigos_cat.php?criterio=','SIA','','750','500','true')" value="..."> </span></td>
                </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
