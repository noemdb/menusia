...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Detalles del Archivo Texto Banco)</title>
...
?>
       <table width="830"  border="1" cellspacing='0' cellpadding='0' align="left" id="ret_estructura">
         <tr height="20" class="Estilo5">
           <td width="20" align="center" bgcolor="#99CCFF"><strong>C&oacute;digo Trabajador</strong></td>
           <td width="15" align="center" bgcolor="#99CCFF"><strong>Cedula</strong></td>
		   <td width="60" align="center" bgcolor="#99CCFF"><strong>Nombre Trabajador</strong></td>
           <td width="30" align="center" bgcolor="#99CCFF"><strong>Cargo</strong></td>
		   <td width="30" align="center" bgcolor="#99CCFF"><strong>Departamento</strong></td>
		   <td width="10" align="center" bgcolor="#99CCFF"><strong>Monto</strong></td>
         </tr>
         <? $total=0;
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="20" align="left"><? echo $registro["tipo_ret"]; ?></td>
           <td width="15" align="left"><? echo $registro["descripcion_ret"]; ?></td>
		   <td width="60" align="left"><? echo $registro["tipo_ret"]; ?></td>
           <td width="30" align="left"><? echo $registro["descripcion_ret"]; ?></td>
		   <td width="30" align="left"><? echo $registro["tipo_ret"]; ?></td>
           <td width="10" align="left"><? echo $registro["descripcion_ret"]; ?></td>
         </tr>
         <?}
