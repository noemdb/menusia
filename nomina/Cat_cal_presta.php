...
function CargarUrl(mcodigo){var murl;  murl="Act_cal_prestaciones.php?Gcodigo="+mcodigo;   document.location = murl;}
</script></head>
<body>
...
<form action="Cat_cal_presta.php" method="get">Criterio de b&uacute;squeda:<input type="text" name="criterio" size="22" maxlength="150"> <input type="submit" value="Buscar">
</div>
</form>
</body>
</html>
