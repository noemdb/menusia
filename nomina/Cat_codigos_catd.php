...
function cerrar_catalogo(cod_presup_cat,denominacion_cat){
  window.opener.document.forms[0].txtcod_presup_d.value = cod_presup_cat;
...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Catalogo de C&oacute;digos Categorias)</title>
...
<form action="Cat_codigos_catd.php" method="get">
