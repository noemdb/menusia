...
<html>
<head>
<title>SIPAP NOMINA Y PERSONAL (Actualizar Grupo de Concepto)</title>
...
function revisar(){var f=document.form1; var Valido=true;
   r=confirm("Desea Actualizar Grupos de Conceptos Asignados  ?"); if(r==true){r=confirm("Esta Realmente Seguro en Actualizar Grupos de Conceptos Asignados ?"); if(r==false){return false;}}
...
?>
<body>
<form name="form1" method="post" action="Update_grupo_conc.php" onSubmit="return revisar()">
  <table width="580" height="40" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="580" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">ACTUALIZAR CONCEPTOS ASIGNADOS </span></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
