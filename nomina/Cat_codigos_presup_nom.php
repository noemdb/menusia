...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Catalogo de Codigos Presupuestarios)</title>
...
<?
        ...
        $criterio="where ((substring(cod_presup from ".$c." for 3)='401') or (substring(cod_presup from ".$c." for 3)='407') ) and (length(cod_presup)=".$long_c.")"; $txt_criterio="401";
        ...
        $res=pg_query($sql);$numeroRegistros=pg_num_rows($res); //echo $sql;
...
<form  name="form1" action="Cat_codigos_presup_nom.php" method="get" onSubmit="return revisar()">
<table border="0">
  <tr>
	<td>
