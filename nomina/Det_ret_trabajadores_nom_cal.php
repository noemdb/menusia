...
<html>
<head>
<title>SIPAP N&Oacute;MINA Y PERSONAL (Detalles del C&oacute;digo Presupuestarios)</title>
<LINK  href="../class/sia.css" type="text/css" rel="stylesheet">
</head>
<body>
 <table width="1115" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td width="1115">
       <?php
if (!$_GET){$codigo_mov='';} else{$codigo_mov=$_GET["codigo_mov"];}
$sql="SELECT pag045.cod_rif_est,pag045.tipo_ret,pag045.ref_comp_est,pag045.tipo_comp_est,pag045.cod_presup_est,pag045.fuente_est,pag045.tasa,pag045.monto_objeto,pag045.monto_ret,pag045.ced_rif_ret,pag003.descripcion_ret FROM PAG045 left join pag003 on (pag003.tipo_retencion=pag045.tipo_ret) where codigo_mov='$codigo_mov' order by cod_rif_est,tipo_ret"; $res=pg_query($sql);
?>
       <table width="1110"  border="1" cellspacing='0' cellpadding='0' align="left" id="ret_estructura">
         ...
         <? $total=0;
while($registro=pg_fetch_array($res)){ $monto=$registro["monto_ret"]; $monto=formato_monto($monto);$total=$total+$registro["monto_ret"];
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="100" align="left"><? echo $registro["cod_rif_est"]; ?></td>
           ...
           <td width="200" align="center"><? echo $registro["cod_presup_est"]; ?></td>
           <td width="50" align="center"><? echo $registro["fuente_est"]; ?></td>
           <td width="140" align="center"><? echo $registro["ced_rif_ret"]; ?></td>
