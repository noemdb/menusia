      ...
      <tr>
        <td>
          <table width="346" height="28" border="0" cellpadding="0" cellspacing="0" bgcolor="#000066">
            <tr>
              <td align="center"><span class="Estilo6 Estilo4 Estilo2 Estilo5"><strong>NOMINA Y PERSONAL</strong></span>
              </td>
            </tr>
          </table>
              ...
              <td height="110">
                <table width="305" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td><input name="txtclave" type="password" id="txtclave" onFocus="encender(this); "
                        onBlur="apagar(this);"></td>
                  </tr>
                </table>
              </td>
