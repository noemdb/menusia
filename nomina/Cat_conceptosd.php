...
function cerrar_catalogo(cod_concepto,den_concepto){
 window.opener.document.forms[0].txtcod_concepto_d.value = cod_concepto;
 window.opener.document.forms[0].txtdenominacion_d.value = den_concepto;
 window.close();
}
</script>
...
<form action="Cat_conceptosd.php" method="get">
