...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Modificar Codigos de la Disminucion)</title>
...
function llamar_anterior(){document.location ='Det_inc_disminuciones.php?codigo_mov=<?echo $codigo_mov?>';}
...
?>
<body>
<form name="form1" method="post" action="Update_cod_dism.php" onSubmit="return revisar()">
  <table width="634" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="630" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">MODIFICAR Codigo DE LA DISMINUCIÓN</span></td>
        </tr>
        <tr>
          ...
          <td><span class="Estilo5"> </span>
              <table width="620" border="0">
                <tr>
                  ...
                  <td width="190"><span class="Estilo5"><input class="Estilo10" name="txtdisponible" type="text" id="txtdisponible" size="25" style="text-align:right" value="<? echo $montod ?>" readonly>   </span>    </span></td>
                  <td width="109"><span class="Estilo5">MONTO </span>:</td>
                  <td width="180"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto" size="25" style="text-align:right" maxlength="22" value="<? echo $monto ?>" onFocus="encender_monto(this)" onBlur="apagar(this)" onKeypress="return validarNum(event)" >
                  </span></td>
                </tr>
            </table></td>
        </tr>
