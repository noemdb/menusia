...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Detalles Incluir C&oacute;digos de la Adici&oacute;n)</title>
 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left">
          <tr>
            <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Codigo a la Adicion" onclick="javascript:LlamarURL('Inc_codigo_adic.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
