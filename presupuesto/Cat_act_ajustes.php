...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Catalogo de Ajustes)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK href="../class/sia.css" type="text/css"  rel="stylesheet">
<script language="JavaScript" type="text/JavaScript">
function CargarUrl(mclave) {var murl;  murl="Act_ajustes.php?Gcriterio="+mclave;    document.location = murl;}
</script></head>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    <td width="73"><div align="center" class="Estilo2 Estilo4"><img src="../imagenes/Logo_sia.gif" width="72" height="42"></div></td>
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATALOGO AJUSTES </div></td>
...
<?
        ...
        $criterio = " where tipo_ajuste like '%" . $txt_criterio . "%' or referencia_ajuste like '%" . $txt_criterio . "%' or descripcion like '%" . $txt_criterio . "%'";}}
        $sql="SELECT * FROM AJUSTES ".$criterio; $res=pg_query($sql);$numeroRegistros=pg_num_rows($res);
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Ajustes</font>";
        }else{
              if(!isset($_GET["orden"])){$orden="tipo_ajuste,referencia_ajuste";} else{$orden=$_GET["orden"];} $tamPag=10;
                ...
                echo "<th bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=referencia_ajuste,tipo_ajuste&criterio=".$txt_criterio."'>Referencia</a></th>";
                echo "<th bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=fecha_ajuste,referencia_ajuste,tipo_ajuste&criterio=".$txt_criterio."'>Fecha</a></th>";
...
<form action="Cat_act_ajustes.php" method="get">
