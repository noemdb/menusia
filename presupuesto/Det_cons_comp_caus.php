...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Detalles Cuentas del Comprobante)</title>
...
if (!$_GET){   $criterio='';   $referencia='';   $fecha='';   $tipo_comp='';}
 else{   $criterio=$_GET["criterio"];   $fecha=substr($criterio,0,10);   $referencia=substr($criterio,10,8);   $tipo_comp=substr($criterio,18,5);
}
$sql="SELECT * FROM CUENTAS_COMPROB where text(fecha)='$fecha' and referencia='$referencia' and tipo_comp='$tipo_comp' order by debito_credito desc,cod_cuenta";
$res=pg_query($sql);
?>
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           ...
           <td width="500" align="left"><?php  echo $registro["descripcion_a"]; ?></td>
         </tr>
         <?php }
