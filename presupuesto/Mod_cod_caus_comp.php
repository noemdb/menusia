...
if (!$_GET){ $cod_presup="";$cod_fuente="00"; $mcod_m="PRE006".$equipo; $codigo_mov=substr($mcod_m,0,49);} else{ $cod_presup=$_GET["codigo"];  $cod_fuente=$_GET["fuente"];  $ref_imput_presu=$_GET["ref_imput_presu"];  $codigo_mov=$_GET["codigo_mov"];}
?>
...
function llamar_anterior(){document.location ='Det_inc_causados_comp.php?codigo_mov=<?echo $codigo_mov?>';}
...
<?
$conn=pg_connect("host=".$host." port=".$port." password=".$password." user=".$user." dbname=".$dbname."");$denominacion="";$des_fuente="";$cod_contable="";$monto=0;
...
if ($registro=pg_fetch_array($res,0)){ $denominacion=$registro["denominacion"];  $monto=$registro["monto"];  $des_fuente=$registro["des_fuente_financ"];  $tipo_imput_presu=$registro["tipo_imput_presu"];
...
?>
<body>
<form name="form1" method="post" action="Update_cod_caus_comp.php" onSubmit="return revisar()">
  <table width="707" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="692" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo2 Estilo6"">CAUSAR MONTO DEL C&Oacute;DIGO</span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table width="689" border="0">
            <tr>
              <td width="167"><span class="Estilo5">MONTO COMPROMETIDO  : </span></td>
              ...
              <td width="125"><span class="Estilo5">MONTO A CAUSAR  : </span></td>
              <td width="167"><span class="Estilo5"> <input class="Estilo10" name="txtmonto" type="text" id="txtmonto" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" value="<? echo $montocomp ?>" size="25" maxlength="22" onKeypress="return validarNum(event)"> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
