...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Incluir C�digos en la Adici�n)</title>
...
function llamar_anterior(){ document.location ='Det_inc_adiciones.php?codigo_mov=<?php echo $codigo_mov?>'; }
        ...
        <tr>
          <td><table width="620" border="0">
              <tr>
                ...
                <td width="103"><input class="Estilo10" name="btCodPre" type="button" id="btCodPre" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onclick="VentanaCentrada('Cat_codigos_presup_comp.php?criterio=','SIPAP','','750','500','true')" value="..."></td>
