...
function cerrar_catalogo(mnro_doc){
  window.opener.document.forms[0].txtnro_doc_h.value = mnro_doc;
  window.opener.document.forms[0].txtnro_doc_h.focus();
  window.close();
}
</script></head>
<body>
...
?>
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:cerrar_catalogo('<?php  echo $registro["nro_documento"];?>');" >
...
<form action="Cat_documento_h.php" method="get">
