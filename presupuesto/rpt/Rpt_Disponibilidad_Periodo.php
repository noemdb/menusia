...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="05"; $opcion="03-0000060"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Disponibilidad de Periodo)</title>
...
if($registro["campo515"]<>""){ $i=$i+1; $mdes_cat[$i]=$registro["campo515"];}if($registro["campo517"]<>""){ $i=$i+1; $mdes_cat[$i]=$registro["campo517"];}
if($registro["campo519"]<>""){ $i=$i+1; $mdes_cat[$i]=$registro["campo519"];}if($registro["campo521"]<>""){ $i=$i+1; $mdes_cat[$i]=$registro["campo521"];}
if($registro["campo523"]<>""){ $i=$i+1; $mdes_cat[$i]=$registro["campo523"];}} $l=strlen($formato_presup); $cant_cod=$i-1;
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE DISPONIBILIDAD DE PERIODO </div></td>
      ...
      <td width="958" height="445" align="center" valign="top"><table width="830" height="434" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="30"><table width="828" border="0">
            <tr>
              ...
              <td width="491"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="30" maxlength="35"  value="<?php echo $cod_presup_d?>" onFocus="encender(this); " onBlur="apagar(this);" onkeyup="mascara(this,'-',patroncodigo,true)" onkeypress="return stabular(event,this)">
                <input name="catalogo1" type="button" id="catalogo1" title="Abrir Catalogo Codigos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presupd.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
			  </tr>
          </table></td>
        </tr>
        <tr>
          <td height="30"><table width="828" border="0">
            <tr>
              ...
              <td width="491"><span class="Estilo5"><input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="30" maxlength="35"  value="<?php echo $cod_presup_h?>" onFocus="encender(this); " onBlur="apagar(this);" onkeyup="mascara(this,'-',patroncodigo,true)" onkeypress="return stabular(event,this)">
                <input name="catalogo2" type="button" id="catalogo2" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presuph.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="45"><span class="Estilo5"><input name="catalogo3" type="button" id="catalogo3" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesd.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
              <td width="381"><span class="Estilo5"> <input name="txtdes_fuented" type="text" id="txtdes_fuented" size="60" maxlength="60"  value="<?php echo $des_fuente_d?>"  readonly onkeypress="return stabular(event,this)">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="46"><span class="Estilo5"><input name="catalogo4" type="button" id="catalogo4" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesh.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
              <td width="381"><span class="Estilo5"><input name="txtdes_fuenteh" type="text" id="txtdes_fuenteh" size="60" maxlength="60"  value="<?php echo $des_fuente_h?>"  readonly onkeypress="return stabular(event,this)">   </span></td>
            </tr>
          </table></td>
        </tr>		
        <tr>
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="160"><span class="Estilo5"> <select name="txt_mes_desde" onFocus="encender(this)" onBlur="apagar(this);" onkeypress="return stabular(event,this)"> 
                  <option selected value="01">ENERO</option> <option value="02">FEBRERO</option>
              ...
              <td width="260"><span class="Estilo5"> <select name="txt_mes_hasta" onFocus="encender(this)" onBlur="apagar(this);" onkeypress="return stabular(event,this)"> 
                  <option value="01">ENERO</option> <option value="02">FEBRERO</option>
                  <option value="03">MARZO</option> <option value="04">ABRIL</option>
                  <option value="05">MAYO</option><option value="06">JUNIO</option>
                  <option value="07">JULIO</option><option value="08">AGOSTO</option>
                  <option value="09">SEPTIEMBRE</option><option value="10">OCTUBRE</option>
                  <option value="11">NOVIEMBRE</option> <option selected value="12">DICIEMBRE</option>
                </select></span></td>
            </tr>
          </table></td>
        </tr>
          ...
          <td height="19"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
			  ...
			  <td width="505"><table width="115" height="30" border="1">
                <tr>
                  <td width="504" valign="top"><span class="Estilo5"><input name="opasig" type="radio" value="S" checked> SI </span>
                      <span class="Estilo5"> <input name="opasig" type="radio" value="N"> NO  </span></td>
                </tr>
              </table></td>              
            </tr>
          </table></td>
        ...
        <tr>
          <td height="19"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
			  ...
			  <td width="505"><select name="txtsubtotal" id="txtsubtotal" onFocus="encender(this)" onBlur="apagar(this);" onkeypress="return stabular(event,this)"> 
			 <?php  for ($i=0; $i<=$cant_cod; $i++) {?> <option value="<?php  echo $i;?>"><?php  echo $mdes_cat[$i];?></option> <?php }?>
			  </td>   
              <td width="5"><input name="txtcant_cat" type="hidden" id="txtcant_cat" value="<?php echo $cant_cat?>" ></td>			  
            </tr>
          </table></td>
        </tr>
		...
		<tr>
           <td height="19"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
			  <td width="153">&nbsp;</td>
			  <td width="166" align="right"><span class="Estilo5">TIPO DE REPORTE : </span></td>
              <td width="505"><span class="Estilo5"><select name="txttipo_rep" size="1" id="txttipo_rep" onFocus="encender(this)" onBlur="apagar(this)" onkeypress="return stabular(event,this)">
        ...
        <tr>
          <td height="50"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Disponibilidad_Perio('Rpt_Disponibilidad_Perio.php');">  </div></td>
...
function Llama_Rpt_Disponibilidad_Perio(murl){var url;var r;var asig; var s; 
  if(document.form1.opasig[0].checked==true){asig="S";}  if(document.form1.opasig[1].checked==true){asig="N";}  s=document.form1.txtsubtotal.value;
  r=confirm("Desea Generar el Reporte Disponibilidad de Periodo?");
  if (r==true) { url=murl+"?cod_presupd="+document.form1.txtcod_presupd.value+"&cod_presuph="+document.form1.txtcod_presuph.value+"&cod_fuented="+document.form1.txtcod_fuented.value+"&cod_fuenteh="+document.form1.txtcod_fuenteh.value+"&mes_desde="+document.form1.txt_mes_desde.value+"&mes_hasta="+document.form1.txt_mes_hasta.value+"&asig_global="+asig+"&csubtotal="+s+"&cant_cat="+document.form1.txtcant_cat.value+"&tipo_rep="+document.form1.txttipo_rep.value;
        window.open(url);  }
}
