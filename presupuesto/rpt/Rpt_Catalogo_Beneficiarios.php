...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Catalogo de Beneficiarios)</title>
        ...
        <tr>
          <td height="19" colspan="3" align="center"  ><table width="784" border="0">
            <tr>
              ...
              <td width="118"><span class="Estilo5"><input class="Estilo10" name="catcedd" type="button" id="catcedd" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('Cat_benefi_d.php?criterio=','SIPAP','','750','500','true')" value="...">  </span></td>
              ...
              <td width="253"><span class="Estilo5"><input class="Estilo10" name="catcedh" type="button" id="catcedh" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('Cat_benefi_h.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
