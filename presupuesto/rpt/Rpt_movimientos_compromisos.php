...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="05"; $opcion="03-0000163"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
$cod_presup_d="";  $cod_presup_h="zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz";   $cod_fuente_d="";  $cod_fuente_h="zz"; $des_fuente_d=""; $des_fuente_h="";
 ...
 $tipo_regis=""; $cedula_d=""; $cedula_h="";  $ref_credd="00000000"; $ref_credh="99999999"; $nro_doc_d=""; $nro_doc_h="zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"; 
?>
...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Movimientos de los Compromisos)</title>
...
function Llama_Rpt_compromisos_gene(murl){var url;var r;var tipo;
    r=confirm("Desea Generar el Reporte movmiento de  Compromiso?");
  if (r==true) {url=murl+"?doc_comp_d="+document.form1.txtdoc_compromiso_d.value+"&doc_comp_h="+document.form1.txtdoc_compromiso_h.value+
"&referencia_d="+document.form1.txtreferencia_d.value+"&referencia_h="+document.form1.txtreferencia_h.value+"&tipo_comp_d="+document.form1.txttipo_comp_d.value+"&tipo_comp_h="+document.form1.txttipo_comp_h.value+
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE MOVIMINETOS DE COMPROMISOS </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="425" border="1" id="tablacuerpo">
  <tr>
    <td width="992" height="420">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:952px; height:418px; z-index:1; top: 69px; left: 30px;">
        <form name="form1" method="get">
           <table width="950" height="415" border="0">
    <tr>
      <td width="958" height="410" align="center" valign="top"><table width="830" height="412" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="40"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_compromisos_gene('Rpt_mov_compromisos.php');">  </div></td>
