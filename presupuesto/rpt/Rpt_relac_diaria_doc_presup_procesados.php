...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="05"; $opcion="03-0000193"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 ...
 $cod_fuente_d="";  $cod_fuente_h="zz"; $des_fuente_d=""; $des_fuente_h="";$fecha_d=formato_ddmmaaaa($Fec_Ini_Ejer); $fecha_h=formato_ddmmaaaa($Fec_Ini_Ejer);
?>
...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Relacion Diaria de Documentos Procesados)</title>
...
function Llama_Rpt_consolidado_ejecu(murl){var url;var r;
  document.form1.txtFechah.value=document.form1.txtFechad.value;
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE RELACION DIARIA DE DOCUMENTOS PROCESADOS </div></td>
...
<table width="977" height="445" border="1" id="tablacuerpo">
  <tr>
    <td width="992" height="440">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:952px; height:430px; z-index:1; top: 59px; left: 30px;">
		...
		<tr>
          <td height="19"><table width="827" border="0">
            <tr>
			  ...
			  <td width="345"><span class="Estilo5"><strong><?php  echo $titulo; ?></span></td>
			  <td width="298"><span class="Estilo5"><strong><?php  echo $titulo; ?></span></td>
            </tr>
          </table></td>
        </tr>        
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="211"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="34" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_d?>" > </span></td>
              <td width="50"><span class="Estilo5"> <input class="Estilo10" name="btCodPre" type="button" id="btCodPre" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presupd.php?criterio=','SIPAP','','750','500','true')" value="..."> </span></td>
              <td width="55"><span class="Estilo5">HASTA : </span></td>
              <td width="216"><span class="Estilo5"><input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="34" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_h?>" ></span></td>
              <td width="52"><span class="Estilo5"><input class="Estilo10" name="btCodPre2" type="button" id="btCodPre2" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presuph.php?criterio=','SIPAP','','750','500','true')" value="..."> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="48"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuented" type="text" id="txtcod_fuented" value="<?php echo $cod_fuente_d?>" onFocus="encender(this)" onBlur="apagar(this)" maxlength="2" size="5" > </span></td>
              <td width="47"><span class="Estilo5"><input class="Estilo10" name="btfuente" type="button" id="btfuente" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesd.php?criterio=','SIPAP','','750','500','true')" value="..."> </span></td>
              <td width="470"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuented" type="text" id="txtdes_fuented" size="60" maxlength="60" value="<?php echo $des_fuente_d?>" readonly></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="19"><table width="890" border="0">
            <tr>
              ...
              <td width="50"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuenteh" type="text" id="txtcod_fuenteh" value="<?php echo $cod_fuente_h?>" onFocus="encender(this)" onBlur="apagar(this)" maxlength="2"  size="5" > </span></td>
              <td width="47"><span class="Estilo5"><input class="Estilo10" name="btfuente2" type="button" id="btfuente2" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesh.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
              <td width="533"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuenteh" type="text" id="txtdes_fuenteh" size="60" maxlength="60" value="<?php echo $des_fuente_h?>" readonly></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="19"><table width="896" border="0">
            <tr>
              ...
              <td width="53">&nbsp; </td>
              <td width="173"><span class="Estilo5">FECHA DOCUMENTO : </span></td>
			  
			  <td width="295"><span class="Estilo12"><span class="Estilo5">
              ...
              <td width="66"><span class="Estilo5"> </span></td>
			  <td width="211"><input class="Estilo10" name="txtFechah" type="hidden" id="txtFechah" value="<?php echo $user?>" ></td>
			</tr>
          </table></td>
        </tr>
		<tr>
        ...
        <tr>
          <td height="40"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_consolidado_ejecu('Rpt_relac_dia_doc_proce.php');">  </div></td>
