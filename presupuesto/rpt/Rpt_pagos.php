...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte de Pagos)</title>
		...
		<tr>
          <td height="19"><table width="827" border="0">
            <tr>
			  ...
			  <td width="59"><span class="Estilo5"><input class="Estilo10" name="txttipo_pagod" type="text" id="txttipo_pagod" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tipo_pago_d?>" size="5" maxlength="4"> </span></td>
              <td width="278"><span class="Estilo5"><input class="Estilo10" name="btdoc_comp" type="button" id="btdoc_comp" title="Abrir Catalogo Documentos Pagos" onClick="VentanaCentrada('Cat_tipo_pagod.php?criterio=','SIPAP','','750','500','true')" value="...">  </span></td>
              <td width="60"><span class="Estilo5"><input class="Estilo10" name="txttipo_pagoh" type="text" id="txttipo_pagoh" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $tipo_pago_h?>" size="5" maxlength="4">  </span></td>
              <td width="203"><span class="Estilo5"><input class="Estilo10" name="btdoc_comp" type="button" id="btdoc_comp" title="Abrir Catalogo Documentos Pagos" onClick="VentanaCentrada('Cat_tipo_pagoh.php?criterio=','SIPAP','','750','500','true')" value="...">  </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="169"><span class="Estilo5"><input class="Estilo10" name="txtref_caus_d" type="text" id="txtref_caus_d" size="10" maxlength="8" value="<?php echo $ref_caus_d?>" onFocus="encender(this);" onBlur="apagar(this);"  onchange="checkrefe_comp(this.form);"> </span></td>
              <td width="164"></td>
              <td width="229"><span class="Estilo5"><input class="Estilo10" name="txtref_caus_h" type="text" id="txtref_caus_h" size="10" maxlength="8" value="<?php echo $ref_caus_h?>" onFocus="encender(this);" onBlur="apagar(this);"  onchange="checkrefe_comp(this.form);"> </span></td>
              <td width="38"></td>
            </tr>
          </table></td>
        </tr>
