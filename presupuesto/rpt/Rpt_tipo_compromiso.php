...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte de Tipos de Compromisos)</title>
...
return true;}
function Llama_Rpt_tipo_compro(murl){var url;var r;
  r=confirm("Desea Generar el Reporte de Tipos de Compromiso?");
...
<?php 
$sql="Select max(tipo_comp) As max_tipo_comp, min(tipo_comp) As min_tipo_comp from pre016"; $resultado=pg_query($sql);
if ($registro=pg_fetch_array($resultado,0)){ $tipo_comp_d=$registro["min_tipo_comp"];  $tipo_comp_h=$registro["max_tipo_comp"];}
?>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    <td width="73"><div align="center" class="Estilo2 Estilo4"><img src="../../imagenes/Logo_sia.gif" width="72" height="42"></div></td>
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE DE TIPOS DE COMPROMISOS </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="325" border="1" id="tablacuerpo">
  <tr>
    <td width="992" height="320">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
    ...
    <tr>
      <td width="958" height="710" align="center" valign="top"><table width="830" height="235" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="60"><span class="Estilo5"> <input class="Estilo10" name="txttipo_comp_d" type="text"  id="txttipo_comp_d" size="8"  maxlength="6" onFocus="encender(this); " value="<?php echo $tipo_comp_d?>" onBlur="apagar(this);" class="Estilo5"></span></td>
              ...
              <td width="63"><span class="Estilo5"><input class="Estilo10" name="txttipo_comp_h" type="text"  id="txttipo_comp_h" size="8" maxlength="6" onFocus="encender(this); " value="<?php echo $tipo_comp_h?>" onBlur="apagar(this);" class="Estilo5">  </span></td>
        ...
        <tr>
          <td height="40"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"><input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_tipo_compro('Rpt_tipo_compro.php');">  </div></td>
