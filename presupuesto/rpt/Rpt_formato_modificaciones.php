...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Formato de Modificaciones)</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE FORMATO DE MODIFICACIONES</div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="270" border="1" id="tablacuerpo">
  <tr>
    <td width="992" height="264">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:952px; height:229px; z-index:1; top: 79px; left: 30px;">
        <form name="form1" method="get">
           <table width="950" height="226" border="0">
    <tr>
      <td width="958" height="222" align="center" valign="top"><table width="830" height="191" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="19"><table width="814" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="219">TIPO DE MODIFICACI&Oacute;N : </td>
              <td width="595"><select name="select">
                <option>CR&Eacute;DITOS ADICIONALES</option>
                <option>RECTIFICACIONES</option>
                <option>INSUBSITENCIA</option>
                <option>REDUCCI&Oacute;N DE INGRESOS</option>
                <option>TRASPASOS DE CR&Eacute;DITOS</option>
                <option>TODOS</option>
              </select></td>
            </tr>
          </table></td>
