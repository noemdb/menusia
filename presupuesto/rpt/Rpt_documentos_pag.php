...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte de Documentos Pagos)</title>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="60"><span class="Estilo5"><input class="Estilo10" name="txttipo_pagod" type="text"  id="txttipo_pagod" size="8"  maxlength="6" onFocus="encender(this); " value="<?php echo $tipo_pagod?>" onBlur="apagar(this);" class="Estilo5"></span></td>
              <td width="285"><span class="Estilo5"><input class="Estilo10" name="bttipo_pagod" type="button" id="bttipo_pagod" title="Abrir Catalogo Tipos de Compromiso" onClick="VentanaCentrada('Cat_tipo_pagod.php?criterio=','SIPAP','','750','500','true')" value="...">  </span></td>
              <td width="63"><span class="Estilo5"><input class="Estilo10" name="txttipo_pagoh" type="text"  id="txttipo_pagoh" size="8" maxlength="6" onFocus="encender(this); " value="<?php echo $tipo_pagoh?>" onBlur="apagar(this);" class="Estilo5">   </span></td>
              <td width="194"><span class="Estilo5"> <input class="Estilo10" name="bttipo_pagoh" type="button" id="bttipo_pagoh" title="Abrir Catalogo Tipos de Compromiso" onClick="VentanaCentrada('Cat_tipo_pagoh.php?criterio=','SIPAP','','750','500','true')" value="..."> </span></td>
            </tr>
          </table></td>
        </tr>
        <tr> <td>&nbsp;</td></tr>
