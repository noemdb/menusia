...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Ejecucion Presupuestaria por Partida)</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE EJECUCION PRESUPUESTARIA POR PARTIDA</div></td>
      ...
      <td width="958" height="445" align="center" valign="top"><table width="830" height="434" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
         <td height="19"><table width="827" border="0">
            <tr>
              <td width="103">&nbsp;</td>
              <td width="216"><div align="right"><span class="Estilo5">CODIGO CONTABLE ESPECIFICO :</span></div></td>
			  <td width="160"><span class="Estilo5"> <select class="Estilo10" name="txtcod_esp" onFocus="encender(this)" onBlur="apagar(this);" onkeypress="return stabular(event,this)"><option selected >NO</option><option >SI</option></select></span></td> 
              <td width="74"><div align="right"><span class="Estilo5">CODIGO :  </span></div></td>
              <td width="260"><span class="Estilo5"><input class="Estilo10" name="txtCodigo_Cuenta" type="text" id="txtCodigo_Cuenta" onFocus="encender(this)" onBlur="apagar(this)"  size="30" maxlength="32" onkeypress="return stabular(event,this)">  </span></td>
            </tr>
          </table></td>
        </tr>
		<tr><td height="19">&nbsp;</td></tr>
		<tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="153" align="right"><span class="Estilo5">TIPO DE REPORTE : </span></td>
              <td width="100"><span class="Estilo5"><select class="Estilo10" name="txttipo_rep" size="1" id="txttipo_rep" onFocus="encender(this)" onBlur="apagar(this)" onkeypress="return stabular(event,this)"><option value='HTML'>FORMATO HTML</option>  <option value='PDF'>FORMATO PDF</option> <option value='EXCEL'>FORMATO EXCEL</option> <option value='EXCEL2'>FORMATO EXCEL2</option> </select></td>
              <td width="175"><div align="left"><span class="Estilo5">MOSTRAR GENERICA :  </span></div></td>
			  <td width="75"><span class="Estilo5"><select class="Estilo10" name="txtmost_gen"  id="txtmost_gen" onFocus="encender(this)" onBlur="apagar(this);" onkeypress="return stabular(event,this)"> <option value="NO">NO</option><option value="SI">SI</option>  </select>    </span></td> 			  
              <td width="194"><div align="left"><span class="Estilo5">DETALLE DE MODIFICACIONES :  </span></div></td>
              <td width="75"><span class="Estilo5"><select class="Estilo10" name="txtdet_modif"  id="txtdet_modif" onFocus="encender(this)" onBlur="apagar(this);" onkeypress="return stabular(event,this)"> <option value="NO">NO</option><option value="SI">SI</option>  </select>    </span></td> 			  
        ...
        <tr>
          <td height="50"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Disponibilidad_Perio('Rpt_Ejec_pre_par.php');">  </div></td>
