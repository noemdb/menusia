...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Especial Resumen General de la Ejecucion Presupuestaria)</title>
    ...
    <tr>
      <td width="958" height="345" align="center" valign="top"><table width="830" height="334" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
		  ...
		  <td width="124"><input class="Estilo10" name="txtunidad_sol" type="text"  id="txtunidad_sol" size="15" onFocus="encender(this); " onBlur="apaga_cate(this);" value="<?php echo $cod_cat?>" ></td>
		  <td width="40"><span class="Estilo5"><input class="Estilo10" name="btcat_prog" type="button" id="btcat_prog" title="Abrir Catalogo de Categorias Programaticas" onClick="VentanaCentrada('../Cat_codigos_cat.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
        ...
        <tr>
          <td height="19"><table width="830" border="0">
            <tr>
              ...
              <td width="475"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuented" type="text" id="txtdes_fuented" size="90" maxlength="90"  value="<?php echo $des_fuente_d?>"  readonly></span></td>
        ...
        <tr>
          <td height="19"><table width="830" border="0">
            <tr>
              ...
              <td width="481"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuenteh" type="text" id="txtdes_fuenteh" size="90" maxlength="90"  value="<?php echo $des_fuente_h?>"  readonly></span></td>
            </tr>
          </table></td>
        </tr>		
        <tr> <td height="19">&nbsp;</td> </tr>
