        ...
        <tr>
          <td height="30"><table width="827" border="0">
            <tr>
              ...
              <td width="53"><span class="Estilo5"><input class="Estilo10" name="txttipo_compromiso" type="text"  id="txtdoc_compromiso_d" size="6" maxlength="4" value="<?php echo $doc_comp_d?>" onFocus="encender(this);" onBlur="apagar(this)"  onchange="chequea_tipo(this.form);">   </span></td>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="357"><span class="Estilo5"><strong><?php  echo $titulo; ?></span></td>
              <td width="257"><span class="Estilo5"><strong><?php  echo $titulo; ?></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="51"><span class="Estilo5"> <input class="Estilo10" name="btfuente" type="button" id="btfuente6" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesd.php?criterio=','SIPAP','','750','500','true')" value="...">    </span></td>
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="54"><span class="Estilo5"> <input class="Estilo10" name="btfuente2" type="button" id="btfuente7" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesh.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
        ...
        <tr>
          <td height="19"><table width="829" border="0">
            <tr>
              ...
              <td width="330"><span class="Estilo5"><input class="Estilo10" name="btfuente8"" type="button" id="btfuente9"" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('Cat_beneficiarios_d.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
              ...
              <td width="67"><span class="Estilo5"><input class="Estilo10" name="btced_rif" type="button" id="btced_rif" title="Abrir Catalogo de Beneficiarios" onClick="VentanaCentrada('Cat_beneficiarios_h.php?criterio=','SIPAP','','750','500','true')" value="...">  </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
