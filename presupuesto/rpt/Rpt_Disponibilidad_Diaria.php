...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Disponibilidad Diaria)</title>
		...
		<tr>
          <td height="30"><table width="915" border="0">
            <tr>
			  ...
			  <td width="200"><span class="Estilo5"><input class="Estilo10" name="txtcategoria_d" type="text" id="txtcategoria_d" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $categoria_d?>" size="20" maxlength="20" class="Estilo5" onkeyup="mascara(this,'-',patroncodigoc,true)" onkeypress="return stabular(event,this)">  </span></td>
              <td width="91"><span class="Estilo5"><input class="Estilo10" name="cat_catd" type="button" id="cat_catd" title="Abrir Catalogo de Categoria" onClick="VentanaCentrada('Cat_Categoriad.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span> </td>
			  
              <td width="55"><span class="Estilo5">HASTA : </span></td>
			  
			  <td width="200"><span class="Estilo5"> <input class="Estilo10" name="txtcategoria_h" type="text" id="" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $categoria_h?>" size="20" maxlength="20" class="Estilo5" onkeyup="mascara(this,'-',patroncodigoc,true)" onkeypress="return stabular(event,this)">   </span></td>
              <td width="98"><span class="Estilo5"><input class="Estilo10" name="cat_cath" type="button" id="cat_cath" title="Abrir Catalogo de Categoria" onClick="VentanaCentrada('Cat_Categoriah.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">      </span></td>
			</tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="19"><table width="884" border="0">
            <tr>
              ...
              <td width="358"><span class="Estilo15"><?php  echo $titulo; ?></span></td>
              <td width="268"><span class="Estilo15"><?php  echo $titulo; ?></span></td>
            </tr>
          </table></td>
        </tr>        
        <tr>
          <td height="30"><table width="915" border="0">
            <tr>
              ...
              <td width="201"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="35" maxlength="35" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_d?>" onkeyup="mascara(this,'-',patroncodigo,true)" onkeypress="return stabular(event,this)">   </span></td>
              <td width="90"><span class="Estilo5"> <input class="Estilo10" name="btCodPre" type="button" id="btCodPre" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presupd.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
              <td width="55"><span class="Estilo5">HASTA : </span></td>
              <td width="206"><span class="Estilo5"><input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="35" maxlength="35" onFocus="encender(this); " onBlur="apagar(this);" value="<?php echo $cod_presup_h?>" onkeyup="mascara(this,'-',patroncodigo,true)" onkeypress="return stabular(event,this)">   </span></td>
              <td width="92"><span class="Estilo5"><input class="Estilo10" name="btCodPre2" type="button" id="btCodPre2" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presuph.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td height="19">&nbsp;</td> </tr>
        <tr>
          <td height="19"><table width="890" border="0">
            <tr>
              ...
              <td width="50"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuented" type="text" id="txtcod_fuented" value="<?php echo $cod_fuente_d?>" onFocus="encender(this)" onBlur="apagar(this)" maxlength="2" size="5"  onkeypress="return stabular(event,this)">   </span></td>
              <td width="47"><span class="Estilo5"><input class="Estilo10" name="btfuente" type="button" id="btfuente" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesd.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
              <td width="530"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuented" type="text" id="txtdes_fuented" size="80" maxlength="80" value="<?php echo $des_fuente_d?>" readonly onkeypress="return stabular(event,this)">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td height="19">&nbsp;</td></tr>
        <tr>
          <td height="19"><table width="890" border="0">
            <tr>
              ...
              <td width="50"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuenteh" type="text" id="txtcod_fuenteh" value="<?php echo $cod_fuente_h?>" onFocus="encender(this)" onBlur="apagar(this)" maxlength="2"  size="5"  onkeypress="return stabular(event,this)">   </span></td>
              <td width="47"><span class="Estilo5"><input class="Estilo10" name="btfuente2" type="button" id="btfuente2" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesh.php?criterio=','SIPAP','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
              <td width="530"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuenteh" type="text" id="txtdes_fuenteh" size="80" maxlength="80" value="<?php echo $des_fuente_h?>" readonly onkeypress="return stabular(event,this)">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr><td height="19">&nbsp;</td></tr>
        <tr>
          <td height="19"><table width="890" border="0">
            <tr>
              ...
              <td width="240"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad" onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $fecha_hoy?>" size="12" maxlength="12" onChange="checkrefechad(this.form)" onkeypress="return stabular(event,this)">
