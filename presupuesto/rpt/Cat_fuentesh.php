...
function cerrar_catalogo(mcuenta,mnombre){
  window.opener.document.forms[0].txtcod_fuenteh.value = mcuenta;
  window.opener.document.forms[0].txtdes_fuenteh.value = mnombre;
  window.opener.document.forms[0].txtcod_fuenteh.focus();
  window.close();
}
</script>
...
<?php 
  ...
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:cerrar_catalogo('<?php  echo $registro["cod_fuente_financ"]; ?>','<?php  echo $registro["des_fuente_financ"]; ?>');" >
    <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><?php  echo $registro["cod_fuente_financ"]; ?></b></font></td>
    <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><?php  echo $registro["des_fuente_financ"]; ?></b></font></td>
     </tr>
<?php } }echo "</table>"; }?>
<br>
...
<form action="Cat_fuentesh.php" method="get">
