...
function cerrar_catalogo(mced_rif,mnombre){
  window.opener.document.forms[0].txtced_rif_h.value = mced_rif;
  window.opener.document.forms[0].txtced_rif_h.focus();
  window.close();
}
</script>
...
<form action="Cat_beneficiarios_h.php" method="get">
