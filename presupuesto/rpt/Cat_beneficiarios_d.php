...
function cerrar_catalogo(mced_rif,mnombre){
  window.opener.document.forms[0].txtced_rif_d.value = mced_rif;
  window.opener.document.forms[0].txtced_rif_d.focus();
  window.close();
}
</script>
...
<form action="Cat_beneficiarios_d.php" method="get">
