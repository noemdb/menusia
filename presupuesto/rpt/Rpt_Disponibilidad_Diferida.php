...
if (pg_last_error($conn)){ ?> <script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script> <?php } else { $Nom_Emp=busca_conf(); }
 ...
 $cod_fuente_d="";  $cod_fuente_h="zz"; $des_fuente_d=""; $des_fuente_h="";$mostrar_diferido="";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
"http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Disponibilidad Diferida)</title>
...
function Llama_Rpt_Disponibilidad_Diferi(murl){var url;var r;var most;
  if(document.form1.opmonto_dif[0].checked==true){most="S";}
  if(document.form1.opmonto_dif[1].checked==true){most="N";}
  r=confirm("Desea Generar el Reporte Disponibilidad Diferida?");
  if (r==true) {
    url=murl+"?cod_presupd="+document.form1.txtcod_presupd.value+"&cod_presuph="+document.form1.txtcod_presuph.value+"&cod_fuented="+document.form1.txtcod_fuented.value+"&cod_fuenteh="+document.form1.txtcod_fuenteh.value+"&mostrar_diferido="+most;
        window.open(url);
  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE DISPONIBILIDAD DIFERIDA</div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="978" height="441" border="1" id="tablacuerpo">
  <tr>
    <td width="965" height="435">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:414px; z-index:1; top: 71px; left: 16px;">
        <form name="form1" method="get">
           <table width="950" height="405" border="0">
    <tr>
      <td width="958" height="401" align="center" valign="top"><table width="934" height="396" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="19"><table width="824" border="0">
            <tr>
              <td width="300" height="26"><div align="right"> </div></td>
              <td width="302"><span class="Estilo15"><?php echo $titulo?></span></td>
              <td width="208"><span class="Estilo15"><?php echo $titulo?></span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="19"><table width="915" border="0">
            <tr>
              ...
              <td width="190"><span class="Estilo12"><span class="Estilo5">
              ...
              <td width="94"><span class="Estilo5">SIPAP
              ...
              <td width="193"><span class="Estilo12"><span class="Estilo5">
              ...
              <td width="40"><span class="Estilo5">SIPAP
        ...
        <tr>
          <td height="22"><table width="930" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              <td width="367">SOLO C&Oacute;DIGOS CON MONTOS DIFERIDOS : </td>
              <td width="556"><table width="268" height="30" border="1">
                <tr>
                  <td width="601" valign="top"><label>
                    <input name="opmonto_dif" type="radio" value="S">
      SI</label>
                      <label>
                      <input name="opmonto_dif" type="radio" value="N" checked>
      NO</label></td>
                </tr>
              </table></td>
            </tr>
        ...
        <tr>
          <td height="57"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td>
                    <div align="center">
                      <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Disponibilidad_Diferi('Rpt_Disponibilidad_Diferi.php');">
                      </div></td>
              <td>
                    <div align="center">
