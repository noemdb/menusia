...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Especial del Resumen de Ejecuci&oacute;n del Presupuesto de Gastos Forma (5703))</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE ESP.  DE EJECUCI&Oacute;N DEL PRESUPUESTO DE GASTOS </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="450" border="1" id="tablacuerpo">
  <tr>
    <td width="992" height="444">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:952px; height:415px; z-index:1; top: 79px; left: 29px;">
        <form name="form1" method="get">
           <table width="950" height="408" border="0">
    <tr>
      <td width="958" height="404" align="center" valign="top"><table width="830" height="328" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td height="30"><table width="610" border="0">
            <tr>
              ...
              <td width="260"><span class="Estilo5">
                <input name="Catalogo322224" type="button" id="Catalogo322222" title="Abrir Catalogo de Cuentas" onClick="VentanaCentrada('../Cat_cuentas_cargablesd.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
              </tr>
          </table></td>
        </tr>
          ...
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="45"><span class="Estilo5">
                <input name="Catalogo3223" type="button" id="Catalogo322" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('../Cat_cuentas_cargablesd.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
          ...
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="46"><span class="Estilo5">
                <input name="Catalogo32232" type="button" id="Catalogo32232" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('../Cat_cuentas_cargablesd.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
              <td width="380"><span class="Estilo12"><span class="Estilo5">
                <input name="txtdesc_ced_rif_benef_d22" type="text" id="txtdesc_ced_rif_benef_d22" size="50" maxlength="50"  value="C&Oacute;DIGO PRESUPUESTARIO" readonly>
              </span></span></td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="18"><table width="911" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              <td width="10">&nbsp;</td>
              <td width="11">&nbsp;</td>
              <td width="78">&nbsp;</td>
              <td width="503">TOTAL POR  : </td>
              <td width="293">FORMATO EXPRESADO EN:</td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="18"><table width="914" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="8" height="83">&nbsp;</td>
              <td width="617"><table width="531" height="30" border="1">
                  <tr>
                    <td width="521" valign="top"><label>
...
PROGRAMA</label>
              ...
              <td width="289"><table width="207" height="83" border="1">
                  <tr>
                    <td width="476" height="77" valign="top"><label>
                      <input name="opimprimir" type="radio" value="S">
            BOLIVARES</label>
                      <p>
                        <input name="opimprimir" type="radio" value="S"><label>MILES DE BOLIVARES</label>
                        </p>
                      <label> </label></td>
                  </tr>
              </table></td>
