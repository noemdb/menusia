...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Ejecucion Presupuestaria)</title>
...
if($registro["campo523"]<>""){ $i=$i+1; $mdes_cat[$i]=$registro["campo523"];}} $l=strlen($formato_presup); $cant_cod=$i-2;
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE EJECUCION PRESUPUESTARIA</div></td>
		...
		<tr>
          <td height="19"><table width="827" border="0">
            <tr>
			  ...
			  <td width="140"><div align="left"><span class="Estilo5">MOSTRAR DEUDA :  </span></div></td>
              <td width="69"><span class="Estilo5"><select class="Estilo10" name="txtmost_deuda"  id="txtmost_deuda" onFocus="encender(this)" onBlur="apagar(this);" onkeypress="return stabular(event,this)"> <option value="NO">NO</option><option value="SI">SI</option>  </select>    </span></td> 			  
               
              <td width="194"><div align="left"><span class="Estilo5">DETALLE DE MODIFICACIONES :  </span></div></td>
              <td width="60"><span class="Estilo5"><select class="Estilo10" name="txtdet_modif"  id="txtdet_modif" onFocus="encender(this)" onBlur="apagar(this);" onkeypress="return stabular(event,this)"> <option value="NO">NO</option><option value="SI">SI</option>  </select>    </span></td> 			  
        ...
        <tr>
          <td height="50"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_Disponibilidad_Perio('Rpt_Ejec_presup.php');">  </div></td>
