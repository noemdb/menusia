...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="05"; $opcion="03-0000195"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 ...
 $cod_fuente_d="";  $cod_fuente_h="zz"; $des_fuente_d=""; $des_fuente_h="";$fecha_d=formato_ddmmaaaa($Fec_Ini_Ejer); $fecha_h=formato_ddmmaaaa($Fec_Fin_Ejer);
?>
		...
		<tr>
          <td height="19"><table width="827" border="0">
            <tr>
			  ...
			  <td width="345"><span class="Estilo5"><strong><? echo $titulo; ?></span></td>
			  <td width="298"><span class="Estilo5"><strong><? echo $titulo; ?></span></td>
            </tr>
          </table></td>
        </tr>        
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="211"><span class="Estilo5"><input class="Estilo10" name="txtcod_presupd" type="text" id="txtcod_presupd" size="34" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?echo $cod_presup_d?>" onkeyup="mascara(this,'-',patroncodigo,true)" onkeypress="return stabular(event,this)"> </span></td>
              <td width="50"><span class="Estilo5"> <input class="Estilo10" name="btCodPre" type="button" id="btCodPre" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presupd.php?criterio=','SIA','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
              <td width="55"><span class="Estilo5">HASTA : </span></td>
              <td width="216"><span class="Estilo5"><input class="Estilo10" name="txtcod_presuph" type="text" id="txtcod_presuph" size="34" maxlength="32" onFocus="encender(this); " onBlur="apagar(this);" value="<?echo $cod_presup_h?>"  onkeyup="mascara(this,'-',patroncodigo,true)" onkeypress="return stabular(event,this)"></span></td>
              <td width="52"><span class="Estilo5"><input class="Estilo10" name="btCodPre2" type="button" id="btCodPre2" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presuph.php?criterio=','SIA','','750','500','true')" value="..." onkeypress="return stabular(event,this)">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="48"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuented" type="text" id="txtcod_fuented" value="<?echo $cod_fuente_d?>" onFocus="encender(this)" onBlur="apagar(this)" maxlength="2" size="5"  onkeypress="return stabular(event,this)">   </span></td>
        ...
        <tr>
          <td height="19"><table width="890" border="0">
            <tr>
              ...
              <td width="533"><span class="Estilo5"><input class="Estilo10" name="txtdes_fuenteh" type="text" id="txtdes_fuenteh" size="60" maxlength="60" value="<?echo $des_fuente_h?>" readonly onkeypress="return stabular(event,this)">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="19"><table width="896" border="0">
            <tr>
              ...
              <td width="295"><span class="Estilo5"><input class="Estilo10" name="txtFechad" type="text" id="txtFechad"  value="<?echo $fecha_d?>" size="12" maxlength="12">  </span></td>
               <td width="66"><span class="Estilo5">HASTA : </span></td>
              <td width="211"><span class="Estilo12"><span class="Estilo5">
                <input class="Estilo10" name="txtFechah" type="text" id="txtFechah" size="12" maxlength="10" onFocus="encender(this); " onBlur="apagar(this);"  value="<?echo $fecha_h?>" onchange="checkrefecha(this.form)"  onkeypress="return stabular(event,this)">
		...
		<tr>
          <td height="19"><table width="890" border="0">
            <tr>
              ...
              <td width="630"><span class="Estilo5"><select class="Estilo10" name="txttipo_rep" size="1" id="txttipo_rep" onFocus="encender(this)" onBlur="apagar(this)"  onkeypress="return stabular(event,this)">
			<option value='HTML'>FORMATO HTML</option>  <option value='PDF'>FORMATO PDF</option> <option value='PDF2'>FORMATO PDF (REFIERE A) </option> <option value='PDF3'>FORMATO PDF (BENEFICIARIO) </option> <option value='PDF6'>FORMATO PDF (DETALLE) </option>  <option value='EXCEL'>FORMATO EXCEL</option> </select></td>
            </tr>
          </table></td>
        </tr>		
