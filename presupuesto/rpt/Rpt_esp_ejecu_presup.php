...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Especial Ejecucion Presupuestaria)</title>
...
if ($registro=pg_fetch_array($resultado,0)){$formato_presup=$registro["campo504"];$titulo=$registro["campo525"];$cant_cat=$registro["campo550"]; $mdes_cat[1]=$registro["campo505"]; $mdes_cat[2]=$registro["campo507"]; $mdes_cat[3]=$registro["campo509"]; $mdes_cat[4]=$registro["campo511"]; $mdes_cat[5]=$registro["campo513"]; $mdes_cat[5]=$registro["campo515"];
} $l=strlen($formato_presup); $cant_cat=$cant_cat+1;
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE ESPECIAL EJECUCION PRESUPUESTARIA</div></td>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="140"><div align="right"><span class="Estilo5">MOSTRAR EL NIVEL :</span></div></td>
			  <td width="194"><select class="Estilo10" name="txtsubtotal" id="txtsubtotal" onFocus="encender(this)" onBlur="apagar(this);"> 
			  <?php  for ($i=0; $i<=$cant_cat; $i++) {?> <option value="<?php  echo $i;?>"><?php  echo $mdes_cat[$i];?></option>
			  <?php }?>
			  </td>     			  
            </tr>
          </table></td>
        ...
        <tr>
          <td height="50"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_esp_ejecucion_presup('Rpt_esp_ejec_presup.php');">  </div></td>
...
function Llama_Rpt_esp_ejecucion_presup(murl){var url;var r;var asig; var s; 
