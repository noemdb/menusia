...
<html>
<head>
<title>SIACONTABILIDAD PRESUPUESTARIA (Reporte Ejecucion Presupuestaria del Gasto)</title>
...
function Llama_Rpt_presupuesto_gas(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Ejecucion Presupuestaria del Gasto?");
  if (r==true) {
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE EJECUCI&Oacute;N PRESUPUESTO DEL GASTO </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="978" height="492" border="1" id="tablacuerpo">
  <tr>
    <td width="965" height="486">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:464px; z-index:1; top: 71px; left: 16px;">
        <form name="form1" method="get">
           <table width="950" height="458" border="0">
    <tr>
      <td width="958" height="454" align="center" valign="top"><table width="830" height="445" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td height="30"><table width="813" border="0">
            <tr>
              ...
              <td width="221"><span class="Estilo12"><span class="Estilo5">
                <input name="txtcod_presupd" type="text" id="txtcod_presupd" size="35" maxlength="32"  value="<?php echo $cod_presup_d?>" onFocus="encender(this); " onBlur="apagar(this);">
              </span></span></td>
          ...
          <td height="30"><table width="827" border="0">
            <tr>
              ...
              <td width="222"><span class="Estilo12"><span class="Estilo5">
                <input name="txtcod_presuph" type="text" id="txtcod_presuph" size="35" maxlength="32"  value="<?php echo $cod_presup_h?>" onFocus="encender(this); " onBlur="apagar(this);">
              </span></span></td>
        ...
        <tr>
          <td height="19"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              <td width="196">ASIGNACI&Oacute;N GLOBAL : </td>
              <td width="624"><table width="115" height="30" border="1">
                <tr>
        ...
        <tr>
          <td height="59"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td>
                    <div align="center">
                      <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_presupuesto_gas('Rpt_presupuesto_gas.php');">
                      </div></td>
              <td>
                    <div align="center">
