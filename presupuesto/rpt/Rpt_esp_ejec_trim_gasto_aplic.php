...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Especial Ejecucion Trimestral de Gastos y Aplicacion)</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE ESPECIAL EJECUCION TRIMESTRAL DE GASTO Y APLICACION</div></td>
        ...
        <tr>
          <td height="50"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_esp_ejec_trim_gas_apli('Rpt_esp_ejec_trim_gas_apli.php');">  </div></td>
...
function Llama_Rpt_esp_ejec_trim_gas_apli(murl){var url;var r;var s;  var mcod_d; 
  ...
  r=confirm("Desea Generar el Reporte Especial Ejecucion Trimestral de Gastos y Aplicacion ?");
  if (r==true) { url=murl+"?cod_cat="+mcod_cat+"&cod_part="+document.form1.txtpart_d.value+"&cod_unidad="+document.form1.txtunidad_sol.value +"&timestre="+document.form1.txtperiodo.value+"&tipo_rep="+document.form1.txttipo_rep.value;
        window.open(url);
  }
}
