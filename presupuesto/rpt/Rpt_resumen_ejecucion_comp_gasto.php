...
if (pg_last_error($conn)){ ?> <script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script> <?php } else { $Nom_Emp=busca_conf(); }
 ...
 $cod_fuente_d="";  $cod_fuente_h="zz"; $des_fuente_d=""; $des_fuente_h="";$tipo="";$mes="";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
"http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>SIACONTABILIDAD PRESUPUESTARIA (Reporte Resumen Ejecucion Financiera del Gasto)</title>
...
function Llama_Rpt_resumen_ejecucion_comp_gas(murl){var url;var r;;var tip;
  if(document.form1.optipo[0].checked==true){tip="P";}
  if(document.form1.optipo[1].checked==true){tip="C";}
  r=confirm("Desea Generar el Reporte Resumen Ejecucion Financiera del Gasto?");
  if (r==true) {
    url=murl+"?cod_presupd="+document.form1.txtcod_presupd.value+"&cod_fuented="+document.form1.txtcod_fuented.value+"&cod_fuenteh="+document.form1.txtcod_fuenteh.value+"&mes="+document.form1.txt_mes_desde.value+"&tipo="+tip;
        window.open(url);
  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE RESUMEN EJECUCI&Oacute;N FINANCIERA DEL GASTO </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="978" height="449" border="1" id="tablacuerpo">
  <tr>
    <td width="965" height="443">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:419px; z-index:1; top: 71px; left: 16px;">
        <form name="form1" method="get">
           <table width="950" height="415" border="0">
    <tr>
      <td width="958" height="411" align="center" valign="top"><table width="830" height="402" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="30"><table width="813" border="0">
            <tr>
              <td width="322" height="26">                <div align="right">C&Oacute;DIGO CATEGORIA : </div></td><td width="199"><span class="Estilo12"><span class="Estilo5">
                <input name="txtcod_presupd" type="text" id="txtcod_presupd2" size="35" maxlength="32"  value="<?php echo $cod_presup_d?>" onFocus="encender(this); " onBlur="apagar(this);">
              </span></span></td>
              <td width="278"><span class="Estilo5">SIPAP
                <input name="btCodPre" type="button" id="btCodPre3" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onclick="VentanaCentrada('Cat_codigos_presupd.php?criterio=','SIA','','750','500','true')" value="...">
              </span></td>
              </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="45"><span class="Estilo5">SIPAP
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="46"><span class="Estilo5">SIPAP
        ...
        <tr>
          <td height="19"><table width="802" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              <td width="130">&nbsp;</td>
              <td width="438">ASIGNACI&Oacute;N GLOBAL : </td>
              <td width="224">UTILIZAR : </td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="19"><table width="828" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="347"><table width="115" height="30" border="1">
                <tr>
      ...
      NO </label></td>
              ...
              <td width="303"><table width="196" height="30" border="1">
                <tr>
                  <td width="206" valign="top"><label>
                     <input name="optipo" type="radio" value="P">

      PAGO</label>

                      <label>

                      <input name="optipo" type="radio" value="C" checked>
        ...
        <tr>
          <td height="64"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td>
                    <div align="center">
                      <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_resumen_ejecucion_comp_gas('Rpt_resumen_ejecucion_comp_gas.php');">
                      </div></td>
              <td>
                    <div align="center">
