...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Ejecucion Presupuestaria y Financiera)</title>
...
function Llama_Rpt_presup_financie(murl){var url;var r;var tip;
  if(document.form1.optipo[0].checked==true){tip="CO";}
  if(document.form1.optipo[1].checked==true){tip="CA";}
  r=confirm("Desea Generar el Reporte Ejecucion Presupuestaria y Financiera?");
  if (r==true) {
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE EJECUCI&Oacute;N PRESUPUESTARIA FINANCIERA </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="978" height="634" border="1" id="tablacuerpo">
  <tr>
    <td width="965" height="628">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:602px; z-index:1; top: 71px; left: 16px;">
        <form name="form1" method="get">
           <table width="950" height="598" border="0">
    <tr>
      <td width="958" height="594" align="center" valign="top"><table width="830" height="577" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="19" colspan="2"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="245">DEUDA EN BASE A </td>
            </tr>
          </table></td>
        </tr>
        <tr>
      ...
      NO </label></td>
              ...
              <td width="292"><table width="264" height="30" border="1">
                <tr>
      ...
      CAUSADO</label></td>
        ...
        <tr>
          <td height="64" colspan="2"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td>
                    <div align="center">
                      <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_presup_financie('Rpt_presup_financie.php');">
                      </div></td>
              <td>
                    <div align="center">
