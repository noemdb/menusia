...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Financiera Compartimiento del Gasto)</title>
...
function Llama_Rpt_financiera_comp_gas(murl){var url;var r;var tip;
  if(document.form1.optipo[0].checked==true){tip="P";}
  if(document.form1.optipo[1].checked==true){tip="C";}
  r=confirm("Desea Generar el Reporte Financiera Compartimiento del Gasto?");
  if (r==true) {
    url=murl+"?cod_presupd="+document.form1.txtcod_presupd.value+"&cod_presuph="+document.form1.txtcod_presuph.value+"&cod_fuented="+document.form1.txtcod_fuented.value+"&cod_fuenteh="+document.form1.txtcod_fuenteh.value+"&mes="+document.form1.txt_mes_desde.value+"&tipo="+tip;
        window.open(url);
  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE EJECUCI&Oacute;N FINANCIERA COMPARTIMIENTO DEL GASTO </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="978" height="629" border="1" id="tablacuerpo">
  <tr>
    <td width="965" height="623">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:597px; z-index:1; top: 71px; left: 16px;">
        <form name="form1" method="get">
           <table width="950" height="595" border="0">
    <tr>
      <td width="958" height="591" align="center" valign="top"><table width="830" height="584" border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          <td height="30" colspan="2"><table width="813" border="0">
            <tr>
              ...
              <td width="252"><span class="Estilo5">SIPAP
        ...
        <tr>
          <td height="30" colspan="2"><table width="827" border="0">
            <tr>
              ...
              <td width="266"><span class="Estilo5">SIPAP
        ...
        <tr>
          <td height="19" colspan="2"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              <td width="24">&nbsp;</td>
              <td width="124">SUB-TOTAL</td>
              <td width="315">ASIGNACI&Oacute;N GLOBAL </td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="19" colspan="2"><table width="829" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="173"><table width="115" height="30" border="1">
                <tr>
      ...
      NO </label></td>
        ...
        <tr>
          <td height="19" colspan="2"><table width="827" border="0.5" cellspacing="1" cellpadding="1">
            <tr>
              <td width="100">UTILIZAR : </td>
              <td width="720"><table width="196" height="30" border="1">
                <tr>
      ...
      CAUSADO</label></td>
        ...
        <tr>
          <td height="66" colspan="2"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td>
                    <div align="center">
                      <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_financiera_comp_gas('Rpt_financiera_comp_gas.php');">
                      </div></td>
              <td>
                    <div align="center">
