...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Asignacion Presupuestria Actualizada)</title>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="229"><span class="Estilo15"><?php  echo $titulo; ?></span></td>
              <td width="255">&nbsp;</td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="62"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuented" type="text" id="txtcod_fuented" onFocus="encender(this)" onBlur="apagar(this)" size="5" maxlength="3" value="<?php echo $fuente_d?>" onkeypress="return stabular(event,this)">   </span></td>
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="61"><span class="Estilo5"><input class="Estilo10" name="txtcod_fuenteh" type="text" id="txtcod_fuenteh" onFocus="encender(this)" onBlur="apagar(this)" size="5" maxlength="3" value="<?php echo $fuente_h?>" onkeypress="return stabular(event,this)">   </span></td>
