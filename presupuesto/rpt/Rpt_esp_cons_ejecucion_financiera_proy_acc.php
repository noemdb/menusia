...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Especial Ejecucion Financiar por Partidas)</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE ESPECIAL EJECUCION FINNACIERAS POR PARTIDAS</div></td>
      ...
      <td width="958" height="195" align="center" valign="top"><table width="830" height="180" border="0" cellpadding="0" cellspacing="0">
		...
		<tr> <td height="30"><table width="830" border="0">
          <tr>
            ...
            <td width="164"><select name="txtperiodo" size="1" id="txtperiodo">
        ...
        <tr>
          <td height="50"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_esp_cons_ejec_fin_proy('Rpt_esp_cons_ejec_fin_proy.php');">  </div></td>
...
function Llama_Rpt_esp_cons_ejec_fin_proy(murl){var url;var r; var s;  var mcod_d; 
  ...
  r=confirm("Desea Generar el Reporte Especial Consolidado de la Ejecucion Financiera ?");  
  if (r==true) { url=murl+"?cod_cat="+mcod_cat+"&cod_part="+document.form1.txtpart_d.value+"&cod_unidad="+document.form1.txtunidad_sol.value +"&timestre="+document.form1.txtperiodo.value+"&csubtotal="+s+"&tipo_rep=PDF";
        window.open(url);  }
}
