        ...
        <tr>
          <td height="19" colspan="2"><table width="766" border="0">
            <tr>
              ...
              <td width="254"><span class="Estilo15"><?php echo $titulo?></span></td>
              <td width="204">&nbsp;</td>
            </tr>
          </table></td>
        </tr>
          ...
          <td height="30" colspan="2"><table width="813" border="0">
            <tr>
              ...
              <td width="252"><span class="Estilo5">
                <input name="btCodPre" type="button" id="btCodPre" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presupd.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
            </tr>
          </table></td>
        </tr>
          ...
          <td height="30" colspan="2"><table width="827" border="0">
            <tr>
              ...
              <td width="266"><span class="Estilo5">
                <input name="btCodPre2" type="button" id="btCodPre2" title="Abrir Catalogo C&oacute;digos Presupuestarios"  onClick="VentanaCentrada('Cat_codigos_presuph.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
            </tr>
          </table></td>
        </tr>
          ...
          <td height="19" colspan="2"><table width="827" border="0">
            <tr>
              ...
              <td width="45"><span class="Estilo5">
                <input name="btfuente2" type="button" id="btfuente6" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_fuentesd.php?criterio=','SIPAP','','750','500','true')" value="...">
              </span></td>
