...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte de Tipo Diferidos)</title>
...
return true;}
function Llama_Rpt_tipo_diferi(murl){var url;var r;
  r=confirm("Desea Generar el Reporte de Tipo Diferidos?");
  if (r==true) {url=murl+"?tipo_diferidod="+document.form1.txttipo_diferidod.value+"&tipo_diferidoh="+document.form1.txttipo_diferidoh.value+"&tipo_rep="+document.form1.txttipo_rep.value;
        window.open(url);
  }
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE DE TIPOS DIFERIDOS </div></td>
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="285"><span class="Estilo5"><input class="Estilo10" name="bttipo_diferidod" type="button" id="bttipo_diferidod" title="Abrir Catalogo Tipos de Compromiso" onClick="VentanaCentrada('Cat_tipo_diferidod.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
              ...
              <td width="194"><span class="Estilo5">  <input class="Estilo10" name="bttipo_diferidoh" type="button" id="bttipo_diferidoh" title="Abrir Catalogo Tipos de Compromiso" onClick="VentanaCentrada('Cat_tipo_diferidoh.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr> <td>&nbsp;</td></tr>
        ...
        <tr>
          <td height="40"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td> <div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_tipo_diferi('Rpt_tipo_diferi.php');">  </div></td>
