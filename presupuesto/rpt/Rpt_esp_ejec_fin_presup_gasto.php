...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Reporte Especial Ejecucion Finaciera del Presupuesto de Gastos)</title>
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE ESPECIAL EJECUCION FINACIERA DEL PRESUPUESTO DE GASTOS</div></td>
        ...
        <tr>
          <td height="19"><table width="828" border="0">
            <tr>
              ...
              <td width="160"><span class="Estilo5"><select class="Estilo10" name="txtmes_desde">
              ...
              <td width="260"><span class="Estilo5"><select class="Estilo10" name="txtmes_hasta">
        ...
        <tr>
          <td height="19"><table width="827" border="0">
            <tr>
              ...
              <td width="140" align="right"><span class="Estilo5">TIPO DE REPORTE : </span></td>
              <td width="194"><span class="Estilo5"><select class="Estilo10" name="txttipo_rep" size="1" id="txttipo_rep" onFocus="encender(this)" onBlur="apagar(this)" onkeypress="return stabular(event,this)"><option value='PDFC'>FORMATO PDF</option>  <option value='PDFL'>FORMATO PDF - EXTRAOFICIO</option> </select></td>
        ...
        <tr>
          <td height="50"><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr align="center" valign="middle">
              <td><div align="center"> <input name="btgenera" type="button" id="btgenera" value="GENERAR" onClick="javascript:Llama_Rpt_esp_res_cons_ejec_presup('Rpt_esp_ejec_financ_presup_gasto.php');">  </div></td>
