...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Catalogo de Pagos)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK href="../class/sia.css" type="text/css"  rel="stylesheet">
<script language="JavaScript" type="text/JavaScript">
function CargarUrl(mclave) {var murl;   murl="Act_pagos.php?Gcriterio="+mclave;   document.location = murl;}
</script></head>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    <td width="73"><div align="center" class="Estilo2 Estilo4"><img src="../imagenes/Logo_sia.gif" width="72" height="42"></div></td>
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATALOGO PAGOS </div></td>
...
<?php 
        ...
        $criterio = " where tipo_pago like '%" . $txt_criterio . "%' or referencia_pago like '%" . $txt_criterio . "%' or descripcion_pago like '%" . $txt_criterio . "%'";}}
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Pagos</font>";$pagina=1; $inicio=1; $final=1; $numPags=1;
              ...
              if(!isset($_GET["orden"])){$orden="tipo_pago,referencia_pago";}else{$orden=$_GET["orden"];}   $tamPag=10;
                ...
                echo "<th bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=fecha_pago,referencia_pago&criterio=".$txt_criterio."'>Fecha</a></th>";
                echo "<th bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=descripcion_pago&criterio=".$txt_criterio."'>Descripci&oacute;n</a></th>";
                $linea=0; $Salir=false;
                while($registro=pg_fetch_array($res)) {$linea=$linea+1;
                $descripcion=$registro["descripcion_pago"]; $sfecha=$registro["fecha_pago"]; $descripcion=substr($descripcion,0,150);
...
<form action="Cat_act_pagos.php" method="get">
<table border="0" width="900">
  <tr>
	...
	<td width="100" >&nbsp;</td>
	<td width="100" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onClick="javascript:LlamarURL('Act_pagos.php')";
        onMouseOut="this.style.backgroundColor='#EAEAEA'"o"];" height="20" align="center" bgcolor=#EAEAEA><a class=menu href="Act_pagos.php">Menu Anterior</a></div></td>
    <td width="100" >&nbsp;</td>
