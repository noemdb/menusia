...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATALOGO PRE-DEFINICI&Oacute;N DE SERVICIOS</div></td>
...
<?php       $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron resultados</font>";$pagina=1; $inicio=1; $final=1; $numPags=1;
              ...
              if(!isset($_GET["orden"])){$orden="cod_servicio";}else{$orden=$_GET["orden"];}  $tamPag=15;
