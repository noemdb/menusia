...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Incluir C�digos en el Causado)</title>
...
<body>
<form name="form1" method="post" action="Insert_cod_caus.php" onSubmit="return revisar()">
  <table width="686" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="683" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo2 Estilo6">INCLUIR NUEVO CODIGO EN EL CAUSADO </span></td>
        </tr>
        <tr>
          ...
          <td><span class="Estilo5"> </span>
            <table width="674" border="0">
              <tr>
                ...
                <td width="494"><span class="Estilo5"><textarea class="Estilo10" name="txtdenominacion" cols="65" rows="2" readonly="readonly" id="txtdenominacion"></textarea>  </span></td>
              </tr>
            </table>            </td>
        </tr>
        <tr>
          <td><table width="681">
            <tr>
              ...
              <td width="158"><span class="Estilo5"> <select class="Estilo10" name="txttipo_imput_presu" size="1" id="txttipo_imput_presu" onFocus="encender(this)" onBlur="apagar(this)" >
          ...
          <td><span class="Estilo5"> </span>
              <table width="671" border="0">
                <tr>
                  ...
                  <td width="180"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto" size="25" style="text-align:right" maxlength="22" onFocus="encender_monto(this)" onBlur="apagar(this)" onKeypress="return validarNum(event)"></span></td>
                </tr>
            </table></td>
        </tr>
        <tr>
          <td><table width="670">
            <tr>
              ...
              <td width="179"><span class="Estilo5"><input class="Estilo10" name="txtmonto_credito" type="text" id="txtmonto_credito" size="25" style="text-align:right" maxlength="22" onFocus="encender_monto(this)" onBlur="apagar(this)" onKeypress="return validarNum(event)">   </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
