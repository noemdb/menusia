...
function llamar_anterior(){document.location ='Det_inc_aumento_comp.php?codigo_mov=<?echo $codigo_mov?>';}
...
?>
<body>
<form name="form1" method="post" action="Update_cod_aum_comp.php" onSubmit="return revisar()">
      ...
      <td><table width="692" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="689" border="0">
            <tr>
              <td width="167"><span class="Estilo5">COMPROMETIDO : </span></td>
