...
if (pg_last_error($conn)){ ?><script language="JavaScript">muestra('OCURRIO UN ERROR CONECTANDO LA BASE DE DATOS');</script><?php }
 else{ $sql="Select * from sia001 WHERE campo101='$usuario_sia'";  $res=pg_query($sql);
...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA  (Cambio de Clave)</title>
...
function revisar(){var f=document.form1; var Valido=true;
   ...
   if(f.txtClaveA.value==""){alert("Clave Actual no puede estar Vacio"); return false; } else{f.txtClaveA.value=f.txtClaveA.value.toUpperCase();}
      ...
      <td><table width="530" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="520">
            <tr>
              ...
              <td width="300"><input class="Estilo10" name="txtnombre_usuario" type="text"  id="txtnombre_usuario" size="20" maxlength="20" readonly value="<?php  echo $usuario_sia ?>"></td>
               </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               <td width="20">&nbsp;</td>
               <td width="200"><span class="Estilo5">TIPEE CLAVE ACTUAL : </span></td>
               <td width="300"><span class="Estilo5"><input class="Estilo10" name="txtClaveA" type="password" id="txtClaveA" size="15" maxlength="20" value="" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input class="Estilo10" name="txtClaveN" type="password" id="txtClaveN" size="15" maxlength="15" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520" border="0">
            <tr>
               ...
               <td width="300"><span class="Estilo5"><input class="Estilo10" name="txtClaveNR" type="password" id="txtClaveNR" size="15" maxlength="15" onFocus="encender(this);" onBlur="apagar(this);"> </span></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
