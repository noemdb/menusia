...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (AUDITORIA DE PRESUPUESTO)</title>
...
<?php       $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Comprobantes</font>";
                ...
                echo "<th bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=descrip_doc&criterio=".$txt_criterio."'>Descripci�n</a></th>";
                $linea=0;          $Salir=false;
...
<table width="800" height="50" border="0" >
  <tr>
    ...
    <td width="200"> <input name="btImprimir" type="button" id="btImprimir" value="Imprimir" onClick="javascript:window.open('/sia/presupuesto/rpt/imprimir_auditoria.php?criterio=<?php  echo $txt_criterio ?>&fechaop=<?php  echo $fecha_aud ?>');" >
	</td>
  </tr>
  <tr>
