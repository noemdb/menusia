...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Detalles Ajustes del Causado)</title>
<LINK
...
$sql="SELECT pre031.referencia_ajuste,pre031.tipo_ajuste,pre031.cod_presup,pre031.fuente_financ,pre031.monto,pre011.fecha_ajuste FROM PRE031,PRE011,PRE005 where pre031.referencia_ajuste=pre011.referencia_ajuste and pre031.tipo_ajuste=pre011.tipo_ajuste and pre031.referencia_pago=pre011.referencia_pago and pre031.tipo_pago=pre011.tipo_pago and pre031.referencia_comp=pre011.referencia_comp and pre031.tipo_compromiso=pre011.tipo_compromiso and pre031.referencia_caus=pre011.referencia_caus and pre031.tipo_causado=pre011.tipo_causado and pre011.tipo_ajuste=pre005.tipo_ajuste and pre031.tipo_causado='$tipo_causado' and pre031.referencia_caus='$referencia_caus' and  pre031.referencia_comp='$referencia_comp' and pre031.tipo_compromiso='$tipo_compromiso' and pre005.refierea='CAUSADO'  Order By PRE011.fecha_ajuste,PRE031.tipo_ajuste,PRE031.referencia_ajuste,PRE031.cod_presup";
$res=pg_query($sql);
?>
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           <td width="120" align="left"><?php  echo $registro["referencia_ajuste"].' '.$registro["tipo_ajuste"]; ?></td>
