...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Actualizar Maestro)</title>
  ...
  <table width="530" height="176" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center" valign="top"><table width="457" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr><td>&nbsp;</td> </tr>
        <tr>
          <td><p><strong>Los Saldos de los Codigos seran Actualizados, tomando como base los Movimientos Presupuestarios. </strong></p>            </td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="454" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center"><input name="btactualiza" type="button" id="btactualiza3" value="ACTUALIZAR" onClick="javascript:document.location ='Act_mov_maes.php';"></td>
