...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Detalles C&oacute;digos del Compromiso)</title>
...
?>
       <table width="1590"  border="1" cellspacing='0' cellpadding='0' align="left" id="ctas_comprobante">
         ...
         <?php  $total=0;$totaln=0;$totalc=0;$totalp=0;$totala=0;$totalr=0;
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" >
           ...
           <td width="110" align="right"><?php  echo $causado; ?></td>
           <td width="110" align="right"><?php  echo $pagado; ?></td>
           <td width="110" align="right"><?php  echo $ajustado; ?></td>
           <td width="110" align="right"><?php  echo $neto; ?></td>
       ...
       <tr>
         ...
         <td><table width="685" border="1" cellspacing="0" cellpadding="0">
           <tr>
             ...
             <td width="110" align="right" class="Estilo5"><?php  echo $totalc; ?></td>
             <td width="110" align="right" class="Estilo5"><?php  echo $totalp; ?></td>
             <td width="110" align="right" class="Estilo5"><?php  echo $totala; ?></td>
             <td width="110" align="right" class="Estilo5"><?php  echo $totaln; ?></td>
             <td width="110" align="right" class="Estilo5"><?php  echo $totalr; ?></td>
           </tr>
         </table></td>
       </tr>
       <tr>
         ...
         <td width="686"><table width="685" border="0" cellspacing="0" cellpadding="0">
           <tr>
             <td width="123">&nbsp;</td>
             <td width="110" align="center"><input name="btcausado" type="button" id="btcausado" value="Causados" onclick="javascrip:Ventana_002('Det_caus_comp.php?criterio=<?php  echo $criterio; ?>','SIPAP','','790','400','true')"></td>
             <td width="110" align="center"><input name="btpagado" type="button" id="btpagado" value="Pagos" onclick="javascrip:Ventana_002('Det_pag_comp.php?criterio=<?php  echo $criterio; ?>','SIPAP','','790','400','true')"></td>
             <td width="110" align="center"><input name="btajustado" type="button" id="btajustado" value="Ajustes" onclick="javascrip:Ventana_002('Det_aju_comp.php?criterio=<?php  echo $criterio; ?>','SIPAP','','580','400','true')"></td>
             <td width="110">&nbsp;</td>
             <td width="110">&nbsp;</td>
           </tr>
         </table></td>
