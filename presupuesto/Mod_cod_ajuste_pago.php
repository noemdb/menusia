...
function llamar_anterior(){document.location ='Det_inc_ajustes_pago.php?codigo_mov=<?echo $codigo_mov?>';}
...
if ($registro=pg_fetch_array($res,0)){  $denominacion=$registro["denominacion"];  $monto=$registro["monto"];
  ...
  $montocomp=$registro["monto_presup"];  $credito=$registro["amort_anticipo"];  $cod_contable=$registro["cod_con_g_pagar"];
...
?>
<body>
<form name="form1" method="post" action="Update_cod_ajust_pago.php" onSubmit="return revisar()">
      ...
      <td><table width="692" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="689" border="0">
            <tr>
              <td width="167"><span class="Estilo5">SALDO DEL PAGO  : </span></td>
