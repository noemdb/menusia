...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATALOGO COMPROMISOS </div></td>
...
<?
        ...
        $criterio = " where tipo_compromiso like '%" . $txt_criterio . "%' or referencia_comp like '%" . $txt_criterio . "%' or nro_documento like '%" . $txt_criterio. "%' or nombre like '%" . $txt_criterio . "%' or descripcion_comp like '%" . $txt_criterio . "%'";}}
        ...
        }else{ if(!isset($_GET["orden"])){$orden="tipo_compromiso,referencia_comp";} else{$orden=$_GET["orden"];}   $tamPag=10;
...
?>
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:CargarUrl('<? echo $registro["tipo_compromiso"].$registro["referencia_comp"].$registro["cod_comp"]; ?>');" >
...
<form action="Cat_act_compromisos.php" method="get">
