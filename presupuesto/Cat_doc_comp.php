...
function cerrar_catalogo(mtipo,mabrev){
  window.opener.document.forms[0].txttipo_compromiso.value = mtipo;
  window.opener.document.forms[0].txtnombre_abrev_comp.value = mabrev;
  window.opener.document.forms[0].txttipo_compromiso.focus();
  window.close();
}
</script>
...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Catalogo Documentos de Compromisos)</title>
...
<?php       $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Documentos</font>"; $pagina=1; $inicio=1; $final=1; $numPags=1;
                ...
                echo "<th height='20' bgcolor='#99CCFF' ><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=tipo_compromiso&criterio=".$txt_criterio."'>Documento Compromiso</a></th>";
                echo "<th height='20' bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=nombre_tipo_comp&criterio=".$txt_criterio."'>Descripcion</a></th>";
                echo "<th height='20' bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=nombre_abrev_comp&criterio=".$txt_criterio."'>Nombre Abreviado</a></th>";
                $linea=0; $Salir=false;
...
<form action="Cat_doc_comp.php" method="get">Criterio de b&uacute;squeda:
