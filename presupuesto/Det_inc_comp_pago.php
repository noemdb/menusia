...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Comprobante del Pago)</title>
<LINK
 ...
 <table width="904" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td><table width="861" border="0" align="left">
       <tr>
         <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Cuenta al Comprobante" onclick="javascript:LlamarURL('Inc_cuenta_comp.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
