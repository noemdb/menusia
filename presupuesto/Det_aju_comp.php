...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Detalles Ajustes del Compromiso)</title>
<LINK
...
<body>
 <table width="575" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td>
<?php
if (!$_GET){$criterio='';$referencia_comp='';$tipo_diferido='';}
