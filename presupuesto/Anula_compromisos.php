...
if (!$_GET){ $referencia_comp='';$tipo_compromiso='';  $cod_comp=''; $fecha_fin=$fecha_hoy; } else {$referencia_comp = $_GET["txtreferencia_comp"]; $tipo_compromiso = $_GET["txttipo_compromiso"];$cod_comp = $_GET["txtcod_comp"]; $fec_fin_e=$_GET["fecha_fin"]; $fecha_fin=formato_ddmmaaaa($fec_fin_e);}
...
var Valido=true;
	...
	r=confirm("Esta seguro en Anular el Compromiso ?");
    if (r==true) {r=confirm("Esta Realmente seguro en Anular el Compromiso ?");   if (r==true) {Valido=true;} else {return false;}  }
...
<body>
<form name="form1" method="post" action="Anu_compromiso.php" onSubmit="return revisar()">
  <table width="714" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="707" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">ANULAR EL COMPROMISO </span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
