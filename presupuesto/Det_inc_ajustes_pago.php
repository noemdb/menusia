...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Detalles Incluir C&oacute;digos del Ajuste)</title>
...
var murl;
  ...
  else{ murl="Mod_cod_ajuste_pago.php?codigo_mov="+mcodigo_mov+"&codigo="+mcodigo+"&fuente="+mfuente+"&ref_imput_presu="+mref_imput_presu; document.location=murl;}
}
</script>
<body>
