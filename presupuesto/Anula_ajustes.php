...
if (!$_GET){  $referencia_caus='';$tipo_causado='';$tipo_pago=''; $referencia_pago='';  $referencia_comp='';$tipo_compromiso='';$referencia_ajuste='';$tipo_ajuste='';}
...
<body>
<form name="form1" method="post" action="Anu_ajuste.php" onSubmit="return revisar()">
  <table width="714" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="707" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">ANULAR EL AJUSTE </span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
