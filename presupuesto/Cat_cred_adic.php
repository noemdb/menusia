...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Catalogo de Creditoa Adicionales)</title>
...
<body>
<?php       $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;    $criterio = "where (anulado='N') and (tipo_modif='1')";
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron creditos adicionales</font>"; $pagina=1; $inicio=1; $final=1; $numPags=1;
        }else{
...
?>
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:cerrar_catalogo('<?php  echo $registro["referencia_modif"];?>');" >
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><?php  echo $registro["referencia_modif"]; ?></b></font></td>
