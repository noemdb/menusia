...
function llamar_anterior(){document.location ='Det_inc_ajustes_caus.php?codigo_mov=<?echo $codigo_mov?>';}
...
if ($registro=pg_fetch_array($res,0)){ $denominacion=$registro["denominacion"]; $monto=$registro["monto"];
  ...
  $montoc=$registro["monto_credito"]; $montocomp=$registro["monto_presup"];  $credito=$registro["amort_anticipo"];
...
?>
<body>
<form name="form1" method="post" action="Update_cod_ajust_caus.php" onSubmit="return revisar()">
        ...
        <tr>
          <td><table width="689" border="0">
            <tr>
              ...
              <td width="167"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" value="<? echo $monto ?>" size="25" maxlength="22" onKeypress="return validarNum(event)" >  </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
