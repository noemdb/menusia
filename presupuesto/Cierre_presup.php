<?php include ("../class/conect.php");  include ("../class/funciones.php"); $sia_periodo="00"; $cod_modulo="05";    
...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="05"; $opcion="04-0000025"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Periodo de Trabajo)</title>
...
<body>
<form name="form1" method="post" action="Update_periodo_presup.php" onSubmit="return revisar()">
  <table width="534" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="530" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">PERIODO DE TRABAJO PRESUPUESTO</span></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td><table width="520">
            <tr>
              ...
              <td width="240"><span class="Estilo5"><input class="Estilo10" name="txtperiodo" type="text" id="txtperiodo"  size="3" maxlength="2" value="<?php echo $periodo ?>"  onFocus="encender(this)" onBlur="apagar(this)">  </span></div></td>
             </tr>
          </table></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
