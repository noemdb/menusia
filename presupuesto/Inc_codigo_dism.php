...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Incluir Codigos en la Disminicion)</title>
...
function llamar_anterior(){ document.location ='Det_inc_disminuciones.php?codigo_mov=<?php echo $codigo_mov?>'; }
...
<body>
<form name="form1" method="post" action="Insert_cod_dism.php" onSubmit="return revisar()">
  <table width="634" height="70" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="628" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo2 Estilo6">INCLUIR NUEVO C&Oacute;DIGO EN LA DISMINUCION</span></td>
        </tr>
        <tr>
          <td><table width="620" border="0">
              <tr>
                <td width="168"><span class="Estilo5">C&Oacute;DIGO PRESUPUESTARIO :</span></td>
                <td width="217"><span class="Estilo5"> <input class="Estilo10" name="txtcod_presup" type="text" id="txtcod_presup" title="Registre el C&oacute;digo de la Disminucion"  size="34" maxlength="34" onFocus="encender(this); " onBlur="apagar(this);">   </span></td>
          ...
          <td><span class="Estilo5"> </span>
              <table width="620" border="0">
                <tr>
                  ...
                  <td width="180"><span class="Estilo5"><input class="Estilo10" name="txtmonto" type="text" id="txtmonto" size="25" style="text-align:right" maxlength="22" onFocus="encender_monto(this)" onBlur="apaga_monto(this)" onKeypress="return validarNum(event)">
                  </span></td>
                </tr>
            </table></td>
        </tr>
