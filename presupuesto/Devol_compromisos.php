...
function Aprobar(mtipo,mref,mcod_tipo) { var url;var r; var mdes_comp="el Compromiso ?";
   ...
   r=confirm("Desea Devolver "+mdes_comp); if (r==true){ r=confirm("Esta Realmente Seguro de Aprobar "+mdes_comp);
   if (r==true) {url="update_devuelve_comp.php?txttipo_compromiso="+mtipo+"&txtreferencia_comp="+mref+"&txtcod_comp="+mcod_tipo; document.location = url;} }
}   
</script></head>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">DEVOLVER COMPROMISOS </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<div id="Layer1" style="position:absolute; width:978px; height:448px; z-index:1; top: 70px; left: 1px;">
<?
        $criterio = "where (tipo_compromiso<>'0000') And (tipo_compromiso<>'A000') And (anulado='N') And ((aprobado='N'))";
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Compromisos</font>";$pagina=1; $inicio=1; $final=1; $numPags=1;
                ...
                $descripcion=substr($descripcion,0,100);$fecha=substr($sfecha,8,2)."/".substr($sfecha,5,2)."/".substr($sfecha,0,4); $status=$registro["status"]; $des_status=""; if($status=="D"){$des_status="DEVUELTO";} if($status=="S"){$des_status="APROBADA";}
...
<form action="Devol_compromisos.php" method="get">
