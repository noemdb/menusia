...
function llamar_anterior(){document.location ='Det_inc_compromisos_dife.php?codigo_mov=<?echo $codigo_mov?>';}
...
<?
$conn=pg_connect("host=".$host." port=".$port." password=".$password." user=".$user." dbname=".$dbname."");$denominacion="";$des_fuente="";$monto=0;$monto_presup=0;
...
if ($registro=pg_fetch_array($res,0)){
  $denominacion=$registro["denominacion"];  $monto=$registro["monto"]; $monto_presup=$registro["monto_presup"];  $des_fuente=$registro["des_fuente_financ"];  $tipo_imput_presu=$registro["tipo_imput_presu"];
...
$monto=formato_monto($monto);$montoc=formato_monto($montoc);$montod=formato_monto($montod); $monto_presup=formato_monto($monto_presup);
?>
<body>
<form name="form1" method="post" action="Update_cod_comp_dife.php" onSubmit="return revisar()">
      ...
      <td><table width="630" border="0" cellpadding="0" cellspacing="0">
          ...
          <td><span class="Estilo5"> </span>
            <table width="678" border="0">
              <tr>
                ...
                <td width="494"><span class="Estilo5"> <textarea name="txtdenominacion" class="Estilo10" cols="65" rows="2" readonly="readonly" id="txtdenominacion"><? echo $denominacion ?></textarea>   </span></td>
              </tr>
            </table>            </td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table width="671" border="0">
            <tr>
              ...
              <td width="277"><span class="Estilo5"><input class="Estilo10" name="txtdisponible" type="text" id="txtdisponible" size="25" style="text-align:right" value="<? echo $montod ?>" readonly>   </span> </td>
              <td width="69"><span class="Estilo5">MONTO  : </span></td>
              <td width="184"><span class="Estilo5"> <input class="Estilo10" name="txtmonto" type="text" id="txtmonto" style="text-align:right" onFocus="encender_monto(this)" onBlur="apagar(this)" onKeypress="return validarNum(event)" value="<? echo $monto ?>" size="25" maxlength="22" > </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td><table width="670">
            <tr>
              ...
              <td width="182"><span class="Estilo5"><input class="Estilo10" name="txtmonto_credito" type="text" id="txtmonto_credito" size="25" style="text-align:right" maxlength="22" value="<? echo $montoc ?>" readonly>  </span></td>
            </tr>
          </table> </td>
        </tr>
        <tr>
        ...
        <table width="629" align="center">
          <tr>
			...
			<td width="15"><input name="txtmonto_presup" type="hidden" id="txtmonto_presup" value="<?echo $monto_presup?>"></td>
            <td width="180">&nbsp;</td>
