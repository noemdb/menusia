		   ...
		   <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="320"><span class="Estilo5"><input name="txtced_responsabled" type="text" class="Estilo5" id="txtced_responsabled" size="15" maxlength="12"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo5" value="<?php echo $ced_responsabled?>">
                      <input name="btced_respd" type="button" id="btced_respd" title="Abrir Catalogo Cedula Responsable" onClick="VentanaCentrada('Cat_responsablesd.php?criterio=','SIPAP','','750','500','true')" value="..."> </span></td>
                 <td width="300"><span class="Estilo5">  <input name="txtced_responsableh" type="text" class="Estilo5" id="txtced_responsableh" size="15" maxlength="12"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo5" value="<?php echo $ced_responsableh?>">
                      <input name="btced_resph" type="button" id="btced_resph" title="Abrir Catalogo Cedula Responsable" onClick="VentanaCentrada('Cat_responsablesh.php?criterio=','SIPAP','','750','500','true')" value="...">  </span></td>
               </tr>
             </table></td>
           </tr>
           <tr>
