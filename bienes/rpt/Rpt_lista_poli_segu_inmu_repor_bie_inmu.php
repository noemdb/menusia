...
return true;}
function Llama_Rpt_lista_poli_segu_inmu_repor_bie(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Listado de Poliza de Seguros de Bienes Inmuebles?");
...
"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value;
  window.open(url,"Reporte Reporte Listado de Poliza de Seguros de Bienes Inmuebles")}
}
...
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REP. LISTADO DE POLIZA DE SEGURO DE BIENES INMUEBLES</div></td>
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td>
                   <div align="center">
                     <input name="btgenera" type="button" id="btgenera5" value="GENERAR" onClick="javascript:Llama_Rpt_lista_poli_segu_inmu_repor_bie('Rpt_lista_poli_segu_inmu_repor_bie.php');">
                 </div></td>
                 <td>
                   <div align="center">
