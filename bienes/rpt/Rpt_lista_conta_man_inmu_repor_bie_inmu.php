...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="13"; $opcion="03-0000085"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 if ($filas>0){$reg=pg_fetch_array($res); $Mcamino=$reg["campo607"].$reg["campo608"].$reg["campo609"].$reg["campo610"].$reg["campo611"].$reg["campo612"].$reg["campo613"].$reg["campo614"].$reg["campo615"].$reg["campo616"].$reg["campo617"].$reg["campo618"].$reg["campo619"].$reg["campo620"].$reg["campo621"].$reg["campo622"].$reg["campo623"].$reg["campo624"].$reg["campo625"].$reg["campo626"]; }
}$posicion=strpos($Mcamino,'S'); if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> document.location='../menu.php';</script><?php }
$cod_bien_inmd=""; $cod_bien_inmh="";   $cedulad=""; $cedulah=""; $numero_contratod="";$numero_contratoh="";$fecha_d=formato_ddmmaaaa($Fec_Ini_Ejer);
...
return true;}
function Llama_Rpt_lista_conta_man_inmu_repor_bie(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Listado de Contratos de Mantenimiento Bienes Inmuebles?");
...
"&numero_contratod="+document.form1.txtnumero_contratod.value+"&numero_contratoh="+document.form1.txtnumero_contratoh.value+
"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value;
  window.open(url,"Reporte Listado de Contratos de Mantenimiento Bienes Inmuebles")}
}
...
//CONTRATOS
$sql="SELECT MAX(numero_contrato) As Max_numero_contrato, MIN(numero_contrato) As Min_numero_contrato FROM BIEN018";
$res=pg_query($sql);if ($registro=pg_fetch_array($res,0)){$encontro=true;}else{$encontro=false;}
if($encontro=true){$numero_contratod=$registro["min_numero_contrato"];$numero_contratoh=$registro["max_numero_contrato"];}
?>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    <td width="73"><div align="center" class="Estilo2 Estilo4"><img src="../../imagenes/Logo_sia.gif" width="72" height="45"></div></td>
    <td width="836"><div align="center" class="Estilo2 Estilo6">REP. LISTADO DE CONTRATOS DE MANTENIMIENTO DE BIEN INMU.</div></td>
      ...
      <td width="958" height="384" align="center" valign="top"><table width="783" height="274" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
               ...
               <tr>
                 ...
                 <td width="460" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong>
                   <input name="txtcod_bien_inm_h" type="text" class="Estilo5" id="txtcod_bien_inm_h" size="30" maxlength="30"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo5" value="<?php echo $cod_bien_inmh?>">
                    <strong><strong>
                     <input name="btfuente" type="button" id="btfuente6" title="Abrir Catalogo de Bienes Inmuebles" onClick="VentanaCentrada('Cat_bienes_inmueblesh.php?criterio=','SIPAP','','750','500','true')" value="...">
               ...
               <tr>
                ...
                <input name="btfuente" type="button" id="btfuente6" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_proveedoresd.php?criterio=','SIPAP','','750','500','true')" value="...">
                 ...
                 <td width="440" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong>
                    ...
                    <strong><strong>
                <input name="btfuente" type="button" id="btfuente6" title="Abrir Catalogo Fuentes de Financiamiento" onClick="VentanaCentrada('Cat_proveedoresh.php?criterio=','SIPAP','','750','500','true')" value="...">
                 </strong></strong></strong></strong> </strong></strong></span></span></span></div></td>
               </tr>
             </table></td>
           </tr>
           <tr>
             <td><table width="965">
               <tr>
                 <td width="279" scope="col"><div align="right"><span class="Estilo5">N&Uacute;MERO DE CONTRATO :</span></div></td>
                 <td width="229" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10">
                     <input name="txtnumero_contratod" type="text" id="txtnumero_contratod" size="15" maxlength="10"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $numero_contratod?>">
                     <span class="menu"><strong><strong>                 </strong></strong></span> </span></span></div></td>
                 <td width="441" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong>
                     <input name="txtnumero_contratoh" type="text" id="txtnumero_contratoh" size="15" maxlength="10"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $numero_contratoh?>">
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td>
                   <div align="center">
                     <input name="btgenera" type="button" id="btgenera4" value="GENERAR" onClick="javascript:Llama_Rpt_lista_conta_man_inmu_repor_bie('Rpt_lista_conta_man_inmu_repor_bie.php');">
                 </div></td>
                 <td>
                   <div align="center">
                     <input name="btcancelar" type="button" id="btcancelar4" value="CANCELAR" onClick="javascript:Llama_Menu_Rpt('menu.php');">
                 </div></td>
               </tr>
             </table></td>
           </tr>
