...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Reporte Catalogo de Responsables Primarios)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK href="../../class/sia.css" type="text/css" rel="stylesheet">
<script language="JavaScript" src="../../class/sia.js" type="text/javascript"></script>
<script language="JavaScript" type="text/JavaScript">
function Llama_Rpt_resp_pri_repor(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Catalogo de Responsables Primarios?");
  if(document.form1.opordenado[0].checked==true){deta="ced_responsable";}
  if(document.form1.opordenado[1].checked==true){deta="nombre_res";}
  if (r==true){url=murl+"?&ced_responsabled="+document.form1.txtced_responsabled.value+"&ced_responsableh="+document.form1.txtced_responsableh.value+"&ordenado="+deta;
...
if($encontro=true){$ced_responsabled=$registro["min_ced_responsable"];$ced_responsableh=$registro["max_ced_responsable"];}
?>
<body>
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    <td width="73"><div align="center" class="Estilo2 Estilo4"><img src="../../imagenes/Logo_sia.gif" width="72" height="42"></div></td>
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE CATALAGO RESPONSABLES PRIMARIOS </div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="306" border="1" id="tablacuerpo">
  <tr>
   <td width="888" height="250"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
             ...
             <td><table width="850">
               <tr>
                 ...
                 <td width="320"><span class="Estilo5"><input name="txtced_responsabled" type="text" class="Estilo10" id="txtced_responsabled" onFocus="encender(this)" onBlur="apagar(this)" size="15" maxlength="12" class="Estilo10" value="<?php echo $ced_responsabled?>" >
                   <input class="Estilo10" name="btced_respd" type="button" id="btced_respd" title="Abrir Catalogo Responsables" onClick="VentanaCentrada('Cat_responsablesd.php?criterio=','SIPAP','','750','500','true')" value="...">    </span></td>
                 <td width="300"><span class="Estilo5"><input name="txtced_responsableh" type="text" class="Estilo10" id="txtced_responsableh" onFocus="encender(this)" onBlur="apagar(this)" size="15" maxlength="12" class="Estilo10" value="<?php echo $ced_responsableh?>">
                   <input class="Estilo10" name="btced_resph" type="button" id="btced_resph" title="Abrir Catalogo Responsables" onClick="VentanaCentrada('Cat_responsablesh.php?criterio=','SIPAP','','750','500','true')" value="...">   </span></td>
                 </tr>
             </table></td>
        </tr>
        <tr> <td height="19">&nbsp;</td>  </tr>		   
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td><div align="center"> <input name="btgenera" type="button" id="btgenera2" value="GENERAR" onClick="javascript:Llama_Rpt_resp_pri_repor('Rpt_resp_pri_repor.php');"> </div></td>
