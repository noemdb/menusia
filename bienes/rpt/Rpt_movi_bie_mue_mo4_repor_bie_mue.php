...
return true;}
function Llama_Rpt_movi_bie_mue_mo4_repor_bie(murl){var url;var r;
...
"&referenciad="+document.form1.txtreferenciad.value+"&referenciah="+document.form1.txtreferenciah.value+
"&fecha_d="+document.form1.txtfecha.value;
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td>
                   <div align="center">
                     <input name="btgenera2" type="button" id="btgenera6" value="GENERAR" onClick="javascript:Llama_Rpt_movi_bie_mue_mo4_repor_bie('Rpt_movi_bie_mue_mo4_repor_bie.php');">
                 </div></td>
                 <td>
                   <div align="center">
                     <input name="btcancelar2" type="button" id="btcancelar6" value="CANCELAR" onClick="javascript:Llama_Menu_Rpt('menu.php');">
                 </div></td>
               </tr>
             </table></td>
           </tr>
