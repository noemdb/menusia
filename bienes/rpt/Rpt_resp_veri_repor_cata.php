...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Reportes Responsables Verificadores)</title>
           ...
           <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="320"> <input class="Estilo10" name="txtced_res_verificadord" type="text" class="Estilo10" id="txtced_res_verificadord" size="15" maxlength="12"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $ced_res_verificadord?>">
                   <input name="btced_respd" type="button" id="btced_respd" title="Abrir Catalogo Responsables" onClick="VentanaCentrada('Cat_responsables_verid.php?criterio=','SIPAP','','750','500','true')" value="...">    </td>
                 <td width="300"> <input name="txtced_res_verificadorh" type="text" class="Estilo10" id="txtced_res_verificadorh" size="15" maxlength="12"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $ced_res_verificadorh?>">
                   <input class="Estilo10" name="btced_resph" type="button" id="btced_resph" title="Abrir Catalogo Responsables" onClick="VentanaCentrada('Cat_responsables_verih.php?criterio=','SIPAP','','750','500','true')" value="...">   </td>
                 </tr>
             </table></td>
           </tr>
