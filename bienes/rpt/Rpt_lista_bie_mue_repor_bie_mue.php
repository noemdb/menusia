...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Reportes Listado de Bienes Muebles)</title>
...
function llama_cat_dird(mform){  var mcod_depd; var mcod_deph;  var murl; 
  ...
  VentanaCentrada(murl,'SIPAP','','750','500','true');
return true;}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE LISTADO DE BIENES MUEBLES </div></td>
           ...
           <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="320"><span class="Estilo5"><input name="txtcod_bien_inm_d" type="text" class="Estilo5" id="txtcod_bien_mue_d" size="30" maxlength="30"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo10" value="<?php echo $cod_bien_mued?>">
                 ...
                 <td width="300"><span class="Estilo5"><input name="txtcod_bien_inm_h" type="text" class="Estilo5" id="txtcod_bien_mue_h" size="30" maxlength="30"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo10" value="<?php echo $cod_bien_mueh?>">
			  ...
			  <td height="19"><table width="850" border="0">
				<tr>
				  ...
				  <td width="200"><span class="Estilo5"><select name="txttipo_rep" size="1" id="txttipo_rep" onFocus="encender(this)" onBlur="apagar(this)">
				         <option value='HTML'>FORMATO HTML</option>  <option value='PDF'>FORMATO PDF</option> <option value='PDF2'>FORMATO PDF2</option> <option value='EXCEL'>FORMATO EXCEL</option></select></td>						 
           ...
           <tr>		      
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
			     <td> <div align="center"><input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_lista_bie_mue_repor('Rpt_lista_bie_mue_repor.php');">   </div></td>
