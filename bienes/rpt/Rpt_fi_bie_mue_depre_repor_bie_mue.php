...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="13"; $opcion="03-0000133"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 if ($filas>0){$reg=pg_fetch_array($res); $Mcamino=$reg["campo607"].$reg["campo608"].$reg["campo609"].$reg["campo610"].$reg["campo611"].$reg["campo612"].$reg["campo613"].$reg["campo614"].$reg["campo615"].$reg["campo616"].$reg["campo617"].$reg["campo618"].$reg["campo619"].$reg["campo620"].$reg["campo621"].$reg["campo622"].$reg["campo623"].$reg["campo624"].$reg["campo625"].$reg["campo626"]; }
}$posicion=strpos($Mcamino,'S'); if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> document.location='../menu.php';</script><?}
$cod_bien_mued=""; $cod_bien_mueh="";   $cod_empresad=""; $cod_empresah=""; $cod_dependenciad=""; $cod_dependenciah=""; $cod_direcciond=""; $cod_direccionh=""; $cod_departamentod=""; $cod_departamentoh=""; $fecha_d=formato_ddmmaaaa($Fec_Ini_Ejer);
...
return true;}
function Llama_Rpt_fi_bie_mue_depre_repor_bie(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Ficha de Bienes Muebles Depreciados?");
...
"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value;
  window.open(url,"Reporte Ficha de Bienes Muebles Depreciados")}
}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE FICHA DE BIENES MUEBLES DEPRECIADOS</div></td>
        ...
        <tr>
          <td height="19" colspan="3">&nbsp;</td>
           ...
           <tr>
             <td><table width="965">
               <tr>
                 <td width="281" scope="col"><div align="right"><span class="Estilo5">OBSERVACI&Oacute;N :</span></div></td>
                 <td width="611" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10">                     <span class="menu"><strong><strong>
                   <textarea name="txtcode_ingre_mora222224" cols="65" id="txtcode_ingre_mora222222" onFocus="encender(this)" onBlur="apagar(this)"></textarea> 
                   </strong></strong></span> </span></span></div></td>
                 <td width="57" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong> <strong><strong><strong><strong> </strong></strong></strong></strong> </strong></strong></span></span></span></div></td>
               </tr>
             </table></td>
           </tr>
           <tr>
             <td><table width="961">
               <tr>
                 <td width="305" scope="col"><div align="right"><span class="Estilo12">ESTADO DEL BIEN </span></div></td>
           ...
           <tr>
             <td><table width="965">
               <tr>
                 <td width="452" scope="col"><div align="right"><span class="Estilo5">
                     <input name="radiobutton" type="radio" value="radiobutton">
        SOLO DEPRECIADO EN SU TOTALIDAD </span></div></td>
                 <td width="172" scope="col"><div align="center"><span class="Estilo5">
                     <input name="radiobutton" type="radio" value="radiobutton">
        LOS DEPRECIADOS</span></div></td>
                 <td width="325" scope="col"><span class="Estilo5">
                   <input name="radiobutton" type="radio" value="radiobutton">
      TODOS</span></td>
               </tr>
             </table></td>
           ...
           <tr>
             <td><table width="965">
               <tr>
                 <td width="437" scope="col"><div align="right"><span class="Estilo5"> MOSTRAR AGRUPADO POR DEPARTAMENTO : </span></div></td>
                 <td width="89" scope="col"><div align="left"><span class="Estilo5">
                     <input name="radiobutton" type="radio" value="radiobutton">
        SI</span></div></td>
                 <td width="423" scope="col"><span class="Estilo5">
                   <input name="radiobutton" type="radio" value="radiobutton">
      NO</span></td>
               </tr>
             </table></td>
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td>
                   <div align="center">
                     <input name="btgenera2" type="button" id="btgenera23" value="GENERAR" onClick="javascript:Llama_Rpt_fi_bie_mue_depre_repor_bie('Rpt_fi_bie_mue_depre_repor_bie.php');">
                 </div></td>
                 <td>
                   <div align="center">
                     <input name="btcancelar2" type="button" id="btcancelar23" value="CANCELAR" onClick="javascript:Llama_Menu_Rpt('menu.php');">
                 </div></td>
               </tr>
             </table></td>
           </tr>
