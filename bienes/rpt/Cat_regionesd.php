...
function cerrar_catalogo(mcuenta,mnombre){
  window.opener.document.forms[0].txtcod_regiond.value = mcuenta;
  window.opener.document.forms[0].txtcod_regiond.focus();
  window.close();
}
</script>
...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Catalogo de Regiones)</title>
...
<?php 
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Fuentes</font>";
                ...
                echo "<th height='20' bgcolor='#99CCFF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=nombre_region&criterio=".$txt_criterio."'>Denominaci�n</a></th>";
                $linea=0; $Salir=false;
