...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="13"; $opcion="03-0000125"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
return true;}
function Llama_Rpt_lista_poli_segu_bie_mue_repor_bie(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Listado Poliza de Seguro de Bienes Muebles?");
...
"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value;
  window.open(url,"Reporte Reporte Listado Poliza de Seguro de Bienes Muebles")}
}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE LISTADO DE POLIZAS DE SEGURO DE BIENES MUEBLES</div></td>
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td>
                   <div align="center">
                     <input name="btgenera2" type="button" id="btgenera2" value="GENERAR" onClick="javascript:Llama_Rpt_lista_poli_segu_bie_mue_repor_bie('Rpt_lista_poli_segu_bie_mue_repor_bie.php');">
                 </div></td>
                 <td>
                   <div align="center">
