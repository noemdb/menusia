...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="13"; $opcion="03-0000145"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
 if ($filas>0){$reg=pg_fetch_array($res); $Mcamino=$reg["campo607"].$reg["campo608"].$reg["campo609"].$reg["campo610"].$reg["campo611"].$reg["campo612"].$reg["campo613"].$reg["campo614"].$reg["campo615"].$reg["campo616"].$reg["campo617"].$reg["campo618"].$reg["campo619"].$reg["campo620"].$reg["campo621"].$reg["campo622"].$reg["campo623"].$reg["campo624"].$reg["campo625"].$reg["campo626"]; }
}$posicion=strpos($Mcamino,'S'); if(is_numeric($posicion)){$Mcamino=$Mcamino;}else{?><script language="JavaScript"> document.location='../menu.php';</script><?php }
$cod_bien_semd=""; $cod_bien_semh="";   $cod_dependenciad=""; $cod_dependenciah=""; $referencia_depd=""; $referencia_deph=""; $fecha_d=formato_ddmmaaaa($Fec_Ini_Ejer);$fecha_h=formato_ddmmaaaa($Fec_Fin_Ejer);$calculo="";
?>
...
return true;}
function Llama_Rpt_depre_bie_semo_repor(murl){var url;var r;var cal;
  ...
  r=confirm("Desea Generar el Reporte Listados de Depreciaciones de Bienes Semovientes?");
...
"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value+"&calculo="+cal;
  window.open(url,"Reporte Listados de Depreciaciones de Bienes Semovientes")}
}
...
//REFERENCIAS
$sql="SELECT MAX(referencia_dep) As Max_referencia_dep, MIN(referencia_dep) As Min_referencia_dep FROM bien029";
$res=pg_query($sql);if ($registro=pg_fetch_array($res,0)){$encontro=true;}else{$encontro=false;}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE LISTADO DE DEPRECIACIONES DE BIENES SEMOVIENTES </div></td>
        ...
        <tr>
          <td height="19" colspan="3">&nbsp;</td>
             ...
             <td><table width="965">
               <tr>
                 ...
                 <td width="350" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10">
                   ...
                   <span class="menu"><strong><strong>SIPAP
                 ...
                 <td width="400" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong>
                  <input name="txtcod_dependenciah" type="text" class="Estilo5" id="txtcod_dependenciah" onFocus="encender(this)" onBlur="apagar(this)" size="5" maxlength="4" class="Estilo5" value="<?php echo $cod_dependenciah?>">
                   <strong><strong><strong><strong>SIPAP
             ...
             <td><table width="965">
               <tr>
                 ...
                 <td width="221" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10">
                     <input name="txtreferencia_depd" type="text" class="Estilo5" id="txtreferencia_depd" size="10" maxlength="8"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $referencia_depd?>">
                 ...
                 <td width="438" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong>
                     <input name="txtreferencia_deph" type="text" class="Estilo5" id="txtreferencia_deph" size="10" maxlength="8"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $referencia_deph?>">
           ...
           <tr>
             <td><table width="961">
               <tr>
                 <td width="356" scope="col"><div align="right"><span class="Estilo12">C&Aacute;LCULO DEPRECIACI&Oacute;N </span></div></td>
                 <td width="593" scope="col"><div align="left"><span class="Estilo5"> <span class="Estilo10"><span class="menu"><strong><strong> </strong></strong></span></span> </span></div></td>
               </tr>
             </table></td>
           </tr>
           <tr>
             <td><table width="965">
               <tr>
                 <td width="399" scope="col"><div align="right"><span class="Estilo5">
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td>
                   <div align="center">
                     <input name="btgenera2" type="button" id="btgenera22" value="GENERAR" onClick="javascript:Llama_Rpt_depre_bie_semo_repor('Rpt_depre_bie_semo_repor.php');">
                 </div></td>
                 <td>
                   <div align="center">
