...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Reportes Listado de Bienes Muebles Faltantes)</title>
...
return true;}
function Llama_Rpt_lista_bie_mue_faltantes_repor_bie(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Bienes Muebles Faltantes?");
...
"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value;
  window.open(url,"Reporte Listados Bienes Muebles Faltantes")}
}
        ...
        <tr>
          <td height="19">&nbsp;</td>
           ...
           <tr>
             <td><table width="850">
               <tr>
                 <td width="230"><span class="Estilo5">FECHA DE MOVIMIENTO :</span></td>
		   ...
		   <tr>
			  <td height="19"><table width="850" border="0">
				<tr>
				  ...
				  <td width="620"><span class="Estilo5"><select name="txttipo_rep" size="1" id="txttipo_rep" onFocus="encender(this)" onBlur="apagar(this)"><option value='PDF'>FORMATO PDF</option> </select></td>	  
				</tr>
			  </table></td>
		   </tr>
           <tr><td height="19">&nbsp;</td></tr>
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td> <div align="center"> <input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_lista_bie_mue_faltantes_repor_bie('Rpt_lista_bie_mue_faltantes_repor_bie.php');">  </div></td>
