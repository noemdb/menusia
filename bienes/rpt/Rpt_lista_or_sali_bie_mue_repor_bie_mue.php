...
if($tipo_u=="A"){$Mcamino="SSSSSSSSSSSSSSSSSSSS";}  else{$modulo="13"; $opcion="03-0000139"; $sql="select * from sia006 where campo601='$usuario_sia' and campo602='$modulo' and campo603='$opcion'";$res=pg_exec($conn,$sql);$filas=pg_numrows($res);
...
return true;}
function Llama_Rpt_lista_or_sali_bie_mue_repor_bie(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Listados de Ordenes de Salida de Bienes Muebles?");
  if (r==true){url=murl+"?&referenciad="+document.form1.txtreferenciad.value+"&referenciah="+document.form1.txtreferenciah.value+
...
"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value;
  window.open(url,"Reporte Listados de Ordenes de Salida de Bienes Muebles")}
}
...
//ORDEN DE SALIDA
$sql="SELECT MAX(referencia) As Max_referencia, MIN(referencia) As Min_referencia FROM bien044";
$res=pg_query($sql);if ($registro=pg_fetch_array($res,0)){$encontro=true;}else{$encontro=false;}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE LISTADO DE ORDEN DE SALIDA BIENES MUEBLES </div></td>
        ...
        <tr>
          <td height="19" colspan="3">&nbsp;</td>
           ...
           <tr>
             <td><table width="965">
               <tr>
                 <td width="279" scope="col"><div align="right"><span class="Estilo5">REFERENCIA :</span></div></td>
                 <td width="227" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10">
                 ...
                 <td width="443" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong>
           ...
           <tr>
             <td><table width="905">
               <tr>
                 <td width="320" scope="col"><div align="right"><span class="Estilo5">FECHA ORDEN DESDE:</span></div></td>
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td>
                   <div align="center">
                     <input name="btgenera2" type="button" id="btgenera2" value="GENERAR" onClick="javascript:Llama_Rpt_lista_or_sali_bie_mue_repor_bie('Rpt_lista_or_sali_bie_mue_repor_bie.php');">
                 </div></td>
                 <td>
                   <div align="center">
