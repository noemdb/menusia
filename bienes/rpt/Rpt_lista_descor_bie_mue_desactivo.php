...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Reportes Listado de Incorporacion Bienes Muebles)</title>
...
function Llama_Rpt_lista_bie_mue_repor(murl){var url;var r; var tipo; var tord;
  ...
  r=confirm("Desea Generar el Reporte Listados Incorporaciones Bienes Muebles?");
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE LISTADO DE INCORPORACION BIENES MUEBLES </div></td>
           ...
           <tr>		      
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">			     
                 <td> <div align="center"><input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_lista_bie_mue_repor('Rpt_lista_inc_bie_mue.php');">   </div></td>
