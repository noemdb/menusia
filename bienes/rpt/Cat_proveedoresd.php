...
function cerrar_catalogo(mcuenta,mnombre){
  window.opener.document.forms[0].txtced_provee_d.value = mcuenta;
  window.opener.document.forms[0].txtced_provee_d.focus();
  window.close();
}
</script>
...
<html>
<head>
<title>SIPAP CONTABILIDAD BIENES NACIONALES (Catalogo de Proveedores)</title>
