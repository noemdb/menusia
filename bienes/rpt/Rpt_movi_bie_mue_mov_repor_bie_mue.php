...
$ced_resp_usod=""; $ced_resp_usoh="";$nombre_rpt="Rpt_movi_bie_mue_mov_repor_bie.php";
if($Cod_Emp=="58"){$nombre_rpt="Rpt_movi_bie_mue_mov_repor_bie_gby.php";}
?>
...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Reportes Movimientos de Bienes Muebles)</title>
...
function Llama_Rpt_movi_bie_mue_mov_repor_bie(murl){var url;var r; var tord;
  if(document.form1.oporden[0].checked==true){tord="C";}  if(document.form1.oporden[1].checked==true){tord="N";}
  r=confirm("Desea Generar el Reporte Movimientos Bienes Muebles?");
  if (r==true){url=murl+"?&cod_bien_mued="+document.form1.txtcod_bien_mue_d.value+"&cod_bien_mueh="+document.form1.txtcod_bien_mue_h.value+"&cod_dependenciad="+document.form1.txtcod_dependenciad.value+"&cod_dependenciah="+document.form1.txtcod_dependenciah.value+
	 "&cod_direcciond="+document.form1.txtcod_direcciond.value+"&cod_direccionh="+document.form1.txtcod_direccionh.value+"&cod_departamentod="+document.form1.txtcod_departamentod.value+"&cod_departamentoh="+document.form1.txtcod_departamentoh.value+"&cod_empresad="+document.form1.txtcod_empresad.value+"&cod_empresah="+document.form1.txtcod_empresah.value+
	 ...
	 "&agrup_dep="+document.form1.txtagrup_dep.value+"&tipo_rep="+document.form1.txttipo_rep.value+"&ordenado="+tord;
  window.open(url,"Reporte Movimientos Bienes Muebles")}
}
...
//REFERENCIA
$sql="SELECT MAX(referencia) As max_referencia, MIN(referencia) As min_referencia FROM bien025";
$res=pg_query($sql);if ($registro=pg_fetch_array($res,0)){$encontro=true;}else{$encontro=false;}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE DE MOVIMIENTO DE BIENES MUEBLES </div></td>
...
<table width="977" height="422" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="416">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:413px; z-index:1; top: 53px; left: 23px;">
        <form name="form1" method="get">
           <table width="950" height="388" border="0">
    <tr>
      <td width="958" height="404" align="center" valign="top"><table width="783" height="394" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="19">&nbsp;</td>
        </tr>
		<tr>
           ...
           <tr>
             <td><table width="850">
               <tr>
				 ...
				 <td width="320"><span class="Estilo5"> <input name="txtreferencia_d" type="text" id="txtreferencia_d" onFocus="encender(this)" onBlur="apaga_referenciad(this)" value="<?php echo $referenciad?>" size="10" maxlength="8" class="Estilo5">  </span></td>
                 <td width="300"><span class="Estilo5"><input name="txtreferencia_h" type="text" id="txtreferencia_h" onFocus="encender(this)" onBlur="apaga_referenciah(this)" value="<?php echo $referenciah?>" size="10" maxlength="8" class="Estilo5">  </span></td>          
				</tr>
             </table></td>
           </tr>
           <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="620"><span class="Estilo5"><input name="txtmes_proceso" type="text" class="Estilo5" id="txtmes_proceso" size="10" maxlength="7"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $mes_proceso?>">
                     </span></div></td>
               </tr>
             </table></td>
           </tr>
			...
			<tr>		      
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 ...
                 <td> <div align="center"><input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_movi_bie_mue_mov_repor_bie('<?php echo $nombre_rpt;?>');">   </div></td>
