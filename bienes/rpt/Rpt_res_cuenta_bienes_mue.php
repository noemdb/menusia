...
$ced_resp_usod=""; $ced_resp_usoh="";$nombre_rpt="Rpt_resumen_cuen_bien_mue.php";
if($Cod_Emp=="58"){$nombre_rpt="Rpt_resumen_cuen_bien_mue.php";}
?>
...
function Llama_Rpt_resumen_cuen_bien_mue(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Movimientos Bienes Muebles?");
  if (r==true){url=murl+"?mes_proceso="+document.form1.txtmes_proceso.value+"&tipo_rep="+document.form1.txttipo_rep.value;
...
<table width="977" height="222" border="1" id="tablacuerpo">
  <tr>
    <td width="870" height="220">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:956px; height:393px; z-index:1; top: 73px; left: 23px;">
        <form name="form1" method="get">
           <table width="950" height="218" border="0">
    <tr>
      <td width="958" height="214" align="center" valign="top"><table width="783" height="214" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="19">&nbsp;</td>
        </tr>
           ...
           <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="620"><span class="Estilo5"><input name="txtmes_proceso" type="text" class="Estilo10" id="txtmes_proceso" size="10" maxlength="7"  onFocus="encender(this)" onBlur="apagar(this)" value="<?php echo $mes_proceso?>">
                     </span></div></td>
               </tr>
             </table></td>
           </tr>
			...
			<tr>		      
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
			      <td> <div align="center"><input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_resumen_cuen_bien_mue('<?php echo $nombre_rpt;?>');">   </div></td>
