...
$cod_bien_mued=""; $cod_bien_mueh="";   $cedulad=""; $cedulah=""; $numero_contratod="";$numero_contratoh="";$fecha_d=formato_ddmmaaaa($Fec_Ini_Ejer);$fecha_h=formato_ddmmaaaa($Fec_Fin_Ejer);
?>
...
return true;}
function Llama_Rpt_lista_conta_man_mue_repor_bie(murl){var url;var r;
  r=confirm("Desea Generar el Reporte Listado de Contratos de Mantenimiento Bienes Muebles?");
...
"&fecha_d="+document.form1.txtFechad.value+"&fecha_h="+document.form1.txtFechah.value;
  window.open(url,"Reporte Listado de Contratos de Mantenimiento Bienes Muebles")}
}
...
//CONTRATOS
$sql="SELECT MAX(numero_contrato) As Max_numero_contrato, MIN(numero_contrato) As Min_numero_contrato FROM BIEN019";
$res=pg_query($sql);if ($registro=pg_fetch_array($res,0)){$encontro=true;}else{$encontro=false;}
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REP. LISTADO DE CONTRATOS DE MANTENIMIENTO DE BIENES MUEBLES</div></td>
             ...
             <td><table width="965">
               <tr>
                 ...
                 <td width="229" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10">
                     <input name="txtnumero_contratod" type="text" id="txtnumero_contratod" size="15" maxlength="10"  onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $numero_contratod?>">
                 ...
                 <td width="441" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"><span class="menu"><strong><strong>
                     <input name="txtnumero_contratoh" type="text" id="txtnumero_contratoh" size="15" maxlength="10"  onFocus="encender(this)" onBlur="apagar(this)" value="<?echo $numero_contratoh?>">
           ...
           <tr>
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">
                 <td>
                   <div align="center">
                     <input name="btgenera2" type="button" id="btgenera7" value="GENERAR" onClick="javascript:Llama_Rpt_lista_conta_man_mue_repor_bie('Rpt_lista_conta_man_mue_repor_bie.php');">
                 </div></td>
                 <td>
                   <div align="center">
                     <input name="btcancelar2" type="button" id="btcancelar7" value="CANCELAR" onClick="javascript:Llama_Menu_Rpt('menu.php');">
                 </div></td>
               </tr>
             </table></td>
           </tr>
