...
if (is_numeric($posicion))
  ...
  { ?><script language="Javascript"> document.location='../menu.php';</script><?php
  }
...
<script language="Javascript" type="text/Javascript">
  ...
  function Llama_Rpt_lista_bie_mue_repor(murl) {
      var url;
      var r;
      var tipo;
      var tord;

      r = confirm("Desea Generar el Reporte Listados Bienes Muebles Desincorporados?");
      if (r == true) {
          url = murl + "?cod_empresad=" + document.form1.txtcod_empresad.value + "&cod_empresah=" + document.form1.txtcod_empresah.value + "&cod_dependenciad=" + document.form1.txtcod_dependenciad.value + "&cod_dependenciah=" + document.form1.txtcod_dependenciah.value +
              ...
              "&fecha_d=" + document.form1.txtFechad.value + "&fecha_h=" + document.form1.txtFechah.value + "&tipo_rep=" + document.form1.txttipo_rep.value + "&titulo_listado=" +  document.form1.titulo_listado.value;
          
          //alert(url);
          window.open(url, "Reporte Listados Bienes Muebles Desincorporados")
      }
  }
...
if ($encontro = true)
  {
  $cod_bien_mued = $registro["min_cod_bien_mue"];
  $cod_bien_mueh = $registro["max_cod_bien_mue"];
  }
...
if ($encontro = true)
  {
  $cod_empresad = $registro["min_cod_empresa"];
  $cod_empresah = $registro["max_cod_empresa"];
  }
...
if ($encontro = true)
  {
  $cod_dependenciad = $registro["min_cod_dependencia"];
  $cod_dependenciah = $registro["max_cod_dependencia"];
  }
...
if ($encontro = true)
  {
  $cod_direcciond = $registro["min_cod_direccion"];
  $cod_direccionh = $registro["max_cod_direccion"];
  }
...
if ($encontro = true)
  {
  $cod_departamentod = $registro["min_cod_departamento"];
  $cod_departamentoh = $registro["max_cod_departamento"];
  }
...
<table width="977" height="38" border="0" bgcolor="#000066">
  <tr>
    ...
    <td width="836"><div align="center" class="Estilo2 Estilo6">REPORTE LISTADO DE BIENES MUEBLES DESINCORPORADOS</div></td>
    <td width="55" class="Estilo2"><strong class="Estilo2 Estilo9">VER 6.0 </strong></td>
  </tr>
</table>
<table width="977" height="422" border="1" id="tablacuerpo">
  <tr>
    <td width="970" height="416">       <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b></b></font>
      <div id="Layer1" style="position:absolute; width:856px; height:393px; z-index:1; top: 50px; left: 33px;">
        <form name="form1" method="get">
          <input type="hidden" name="titulo_listado" value="DESINCORPORACIONES">
    ...
    <tr>
       ...
       <tr>
           ...
           <tr>
             <td><table width="850">
               <tr>
                 ...
                 <td width="320">
                  <span class="Estilo5">
                    <input name="txtFechad_inc" type="text" class="Estilo5" id="txtFechad_inc" onFocus="encender(this)" onBlur="apagar(this)" value="<?php //echo $fecha_d;?>" size="12" maxlength="10" class="Estilo5" onChange="checkrefechad(this.form)">
                    <img src="../../imagenes/img_cal.png" width="20" height="14" id="Calendario15" style="cursor: pointer; border: 1px solid blue;" title="Seleccionar Fecha"
                        onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario15')"  /></span>
                  </td>
                <td width="300">
                  <span class="Estilo5">
                    <input name="txtFechah_inc" type="text" class="Estilo5" id="txtFechah_inc" onFocus="encender(this)" onBlur="apagar(this)" value="<?php //echo $fecha_h;?>" size="12" maxlength="10" class="Estilo5" onChange="checkrefechah(this.form)">
                    <img src="../../imagenes/img_cal.png" width="20" height="14" id="Calendario16" style="cursor: pointer; border: 1px solid blue;" title="Seleccionar Fecha"
                        onMouseOver="this.style.background='blue';" onMouseOut="this.style.background=''"  onClick="javascript:showCal('Calendario16')"  />
                  </span></div></td>
               </tr>
             </table></td>
           </tr> 
         -->
           ...
           <tr>
             <td><table width="850">
               <tr>
                 <td width="230"><span class="Estilo5">FECHA DE DESCORPORACI&Oacute;N :</span></td>
       ...
       <tr>
        ...
        <tr>
          ...
          <script language="Javascript" type="text/Javascript">
            var mpdf_rpt='<?php echo $pdf_rpt ?>';
            if(mpdf_rpt=="SI"){
              document.form1.txttipo_rep.options[1].selected = true;
            }
            else{
              document.form1.txttipo_rep.options[0].selected = true;
            }
          </script>
      <tr><td height="19">&nbsp;</td></tr>
      <tr><td height="19">&nbsp;</td></tr>
           <tr>         
             <td><table width="454" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr align="center" valign="middle">           
                 <td> <div align="center"><input name="btgenerar" type="button" id="btgenerar" value="GENERAR" onClick="javascript:Llama_Rpt_lista_bie_mue_repor('Rpt_lista_des_bie_mue.php');">   </div></td>
