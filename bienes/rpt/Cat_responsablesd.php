...
function cerrar_catalogo(mcuenta,mnombre){
  window.opener.document.forms[0].txtced_responsabled.value = mcuenta;
  window.opener.document.forms[0].txtced_responsabled.focus();
  window.close();
}
</script>
...
<html>
<head>
<title>SIPAP CONTABILIDAD BIENES NACIONALES (Catalogo de Responsables Primarios)</title>
...
<?php 
  ...
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:cerrar_catalogo('<?php  echo $registro["ced_responsable"]; ?>','<?php  echo $registro["nombre_res"]; ?>');" >
