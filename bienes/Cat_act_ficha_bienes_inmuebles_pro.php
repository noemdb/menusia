...
function CargarUrl(mcodigo) {var murl;
   murl="Act_ficha_bienes_inmuebles_pro.php?Gcod_bien_inm="+mcodigo;   document.location = murl;}
</script></head>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    <td width="73"><div align="center" class="Estilo2 Estilo4"><img src="../imagenes/Logo_sia.gif" width="72" height="42"></div></td>
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATOLOGO DE BIENES INMUEBLES</div></td>
...
<?php       $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        $sql="SELECT * FROM BIEN014 ".$criterio; $res=pg_query($sql);$numeroRegistros=pg_num_rows($res);
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron resultados</font>"; $pagina=1; $inicio=1; $final=1; $numPags=1;
                ...
                $sql="SELECT * FROM BIEN014 ".$criterio." ORDER BY ".$orden;   $res=pg_query($sql);
...
<form action="Cat_act_ficha_bienes_inmuebles_pro.php" method="get">
