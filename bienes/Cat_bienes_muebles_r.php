...
function cerrar_catalogo(mcodigo,mdenominacion,mmonto){
  window.opener.document.forms[0].txtcod_bien_r.value = mcodigo;  
  window.opener.document.forms[0].txtcod_bien_r.focus();
  window.close();
}
</script>
...
?>
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:cerrar_catalogo('<?php  echo $registro["cod_bien_mue"]; ?>','<?php  echo $denominacion; ?>','<?php  echo $monto; ?>')" >
...
<form action="Cat_bienes_muebles_r.php" method="get">
