<?php include ("../class/ventana.php"); $equipo=getenv("COMPUTERNAME");  $mcod_m="BIEN027".$usuario_sia.$equipo; 
...
<body>
<form name="form1" method="post" action="Insert_bienes_inmu_depreciacion.php" onSubmit="return revisar()">
  <table width="790" height="80" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="785" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">INCLUIR BIEN A DEPRECIAR</span></td>
        </tr>
        <tr> <td>&nbsp;</td></tr>
          <tr>
            <td><table width="780">
              <tr>
                ...
                <td width="300"><span class="Estilo5"><input name="txtcod_bien_mue" type="text" id="txtcod_bien_mue" size="30" maxlength="30"  onFocus="encender(this)" onBlur="apagar(this)" class="Estilo5"></span></td>
                <td width="250"><span class="Estilo5"><input name="btcod_bien" type="button" id="btcod_bien" title="Abrir Catalogo de Bienes Inmuebles" onClick="VentanaCentrada('Cat_bienes_inmuebles_depreciados.php?criterio=','SIPAP','','750','500','true')" value="..."></span></td>
              </tr>
            </table></td>
          </tr>
		  <tr>
            <td>
              <table width="780" border="0">
                <tr>
                  ...
                  <td width="650"><span class="Estilo5"><textarea name="txtdenominacion" cols="58" rows="2" readonly="readonly" id="txtdenominacion"></textarea>
                  </span></td>
                </tr>
              </table>  </td>
          </tr> 
          <tr>
            <td><table width="780">
              <tr>
                ...
                <td width="250"><span class="Estilo5"><input name="txtvida_util" type="text" id="txtvida_util" size="10"  readonly></span></td>
                <td width="150"><span class="Estilo5">VALOR RESIDUAL :</span></div></td>
                <td width="250"><span class="Estilo5"><input name="txtvalor_residual" type="text" id="txtvalor_residual" readonly></span></td>
              </tr>
            </table></td>
          </tr>	
          <tr>
            <td><table width="780">
              <tr>
                ...
                <td width="280"><span class="Estilo5"> <input name="txtcod_presup_dep" type="text" id="txtcod_presup_dep" size="40" maxlength="32"  readonly class="Estilo5"></span></td>
                <td width="150"><span class="Estilo5">SALDO DEPRECIADO :</span></td>
                <td width="150"><span class="Estilo5"> <input name="txtmonto_depreciado" type="text" id="txtmonto_depreciado" size="20" maxlength="15" value="<?php echo $num?>" readonly class="Estilo5"></span></td>
              </tr>
            </table></td>
          </tr>	
          <tr>
