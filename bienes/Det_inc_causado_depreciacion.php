...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Detalles Causado de Depreciacion)</title>
   ...
   <tr>
      <td align="left"><table width="840" border="0" align="left">
          <tr>
		    ...
		    <td width="50"><span class="Estilo5"><input name="txtafecta_presup" type="text" id="txtafecta_presup" size="5" maxlength="4" value="<?php echo $afecta_presup?>" readonly class="Estilo5"> </td>
		    <td width="150" align="center"><input name="btGenCaus" type="button" id="btGenCaus" value="Generar Causado" title="Generar Causado" onclick="javascript:LlamarURL('Gen_caus_depreciacion.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
		    <td width="150"><span class="Estilo5">DOCUMENTO CAUSADO :</span></td>
		    <td width="110"><span class="Estilo5"><input name="txttipo_causado" type="text" id="txttipo_causado" size="5" maxlength="4"  value="<?php echo $tipo_causado?>" readonly class="Estilo5"></td>
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:enviar('<?php  echo $codigo_mov; ?>','<?php  echo $registro["cod_bien"]; ?>');">
           ...
           <td width="140" align="right"><?php  echo $monto; ?></td>
         </tr>
         <?php }
