...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Catalogo de Poliza de Seguro de Bienes Muebles)</title>
<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
<LINK href="../class/sia.css" type="text/css" rel="stylesheet">
<script language="JavaScript" type="text/JavaScript">
function CargarUrl(mcodigo) {var murl;
   murl="Act_bienes_muebles_pro_poli_segu.php?Gcod_bien_mue="+mcodigo;   document.location = murl;}
</script></head>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    <td width="73"><div align="center" class="Estilo2 Estilo4"><img src="../imagenes/Logo_sia.gif" width="72" height="42"></div></td>
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATOLOGO DE POLIZA DE SEGURO BIENES MUBLES</div></td>
...
<?php       $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        $criterio = " where cod_bien_mue like '%" . $txt_criterio . "%' or numero_poliza like '%" . $txt_criterio . "%'";}}
        $sql="SELECT * FROM BIEN022 ".$criterio; $res=pg_query($sql);$numeroRegistros=pg_num_rows($res);
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron resultados</font>"; $pagina=1; $inicio=1; $final=1; $numPags=1;
                ...
                $sql="SELECT * FROM BIEN022 ".$criterio." ORDER BY ".$orden;    $res=pg_query($sql);
                ...
                echo "<th height='25' bgcolor='#99CCFF' ><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=numero_poliza&criterio=".$txt_criterio."'>Numero Poliza</a></th>";
                $linea=0;                $Salir=false;
  ...
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:CargarUrl('<?php  echo $registro["cod_bien_mue"]; ?>');" >
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"><b><?php  echo $registro["numero_poliza"]; ?></b></font></td>
  </tr>
<?php } }echo "</table>";}?>
        <br>
...
<form action="Cat_act_bienes_muebles_pro_poli_segu.php" method="get">
