...
<table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
		    <?php if ($Mcamino{0}=="S"){?>
            <td width="222" align="center" valign="middle"> <input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar planilla de retenci�n" onclick="javascript:Llama_Agragar('<?php echo $cod_dependen?>','<?php echo $cod_direcci?>')">   </td>
            <?php }?>
