...
var murl;
var r;
 if (Gcodigo=="") {alert("C�digo del Semoviente debe ser Seleccionada");}
  else { murl="Esta seguro en Eliminar el C�digo:"+Gcodigo+" del Bien ?";
  r=confirm(murl);
  if(r==true){
    r=confirm("Esta Realmente seguro en Eliminar el Bien ?");
    if(r==true){murl="Delete_cod_bienes.php?codigo_mov="+Gcodigo_mov+"&codigo="+Gcodigo;document.location=murl;}
    }
...
var murl;
  ...
  else{ murl="Mod_codigo_bienes_semo_movimientos.php?codigo_mov="+Gcodigo_mov+"&codigo="+Gcodigo; document.location=murl;}
}
</script>
<body>
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left">
          <tr>
            <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar C�digo al Movimiento" onclick="javascript:LlamarURL('Inc_bienes_Semo_Movimientos.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
