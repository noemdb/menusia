...
<body>
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td>
<?php if (!$_GET){$criterio='';$referencia='';}else{$criterio=$_GET["criterio"];$referencia=substr($criterio,0,8);}
$sql="SELECT * FROM DET_SAL_MUE where referencia='$referencia' order by cod_bien_mue";
$res=pg_query($sql);
?>
