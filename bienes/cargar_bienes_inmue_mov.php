...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Cargar Movimiento Bienes Muebles)</title>
...
<body>
<form name="form1" method="post" action="Insert_mov_bienes_inmue_carga.php" onSubmit="return revisar()">
   <table width="640" height="300" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="635" height="290" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">CARGAR MOVIMIENTO BIENES INMUEBLES</span></td>
        </tr>
        <tr> <td>&nbsp;</td></tr>
          <tr>
            <td><table width="630">
              <tr>
                ...
                <td width="350"><span class="Estilo5"><select name="txttipo" size="1" id="txttipo" onFocus="encender(this)" onBlur="apagar(this)">
                      <option selected>INCORPORACION</option>     </select> </span></td>
              </tr>
            </table></td>
          </tr>
		  <tr> <td>&nbsp;</td></tr>
