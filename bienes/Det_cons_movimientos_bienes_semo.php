...
<html>
<head>
<title>SIPAP BIENES NACIONALES (Detalles Movimientos Bienes Semovientes)</title>
<LINK
...
//print_r($referencia);
//print_r($fecha);
$sql="SELECT * FROM DET_MOV_SEM where text(fecha)='$fecha' and referencia='$referencia' order by referencia";
$res=pg_query($sql);
?>
