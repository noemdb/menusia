...
<body>
  <table width="888" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td  width="262" align="center"><input name="btGenComp" type="button" id="btGenComp" value="Generar Comprobante" title="Generar Comprobante" onclick="javascript:LlamarURL('Gen_Comp_Orden.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
     <td  width="156" align="center"><input name="btAmortAnt" type="button" id="btAmortAnt" value="Amortiza Anticipo" title="Registra Amortizacion de Anticipo" onclick="javascript:LlamarURL('Inc_amort_ant.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
     <td  width="75" align="left"><input type="text" name="txtamort_ant" size="2" value="<?php echo $amort_ant?>" readonly ></td>
     <td  width="139" align="center"><span class="Estilo5">CUENTA POR PAGAR  :</span></td>
     <td  width="256" align="left"><span class="Estilo10">
       <input name="txtcod_contable" type="text" id="txtcod_contable" size="25" maxlength="30" value="<?php echo $cod_contable?>" readonly>
     </span></td>
   </tr>
   <tr>
