...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Incluir Movimientos de Bienes Semovientes)</title>
            ...
            <td><table width="962">
              <tr>
                ...
                <td width="839" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"> <span class="menu"><strong><strong><strong><strong><strong><strong><strong><strong>
                    ...
                    <strong><strong>
                     <input name="btfuente" type="button" id="btfuente6" title="Abrir Catalogo de Bienes Semovientes" onClick="VentanaCentrada('Cat_bienes_semovientesd.php?criterio=','SIPAP','','750','500','true')" value="...">
