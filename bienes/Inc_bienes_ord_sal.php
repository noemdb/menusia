<?php include ("../class/ventana.php"); $equipo=getenv("COMPUTERNAME");  $mcod_m="BIEN045".$usuario_sia.$equipo; 
...
function llamar_anterior(){ document.location ='Det_inc_bienes_ord_salida.php?codigo_mov=<?php echo $codigo_mov?>'; }
function revisar(){
...
<body>
<form name="form1" method="post" action="Insert_bienes_ord_sal.php" onSubmit="return revisar()">
  <table width="640" height="80" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="635" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="31" align="center" bgcolor="#000066"><span class="Estilo9">INCLUIR BIEN A LA ORDEN DE SALIDA</span></td>
        </tr>
        <tr> <td>&nbsp;</td></tr>
          <tr>
            <td><table width="630">
