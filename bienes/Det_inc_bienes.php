 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left">
          <tr>
            <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar C�digo al Movimiento" onclick="javascript:LlamarURL('Inc_bienes.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
   ...
   <tr>
     <td>
       <?php
$sql="SELECT * FROM CODIGOS_MUEBLES_BIEN050 where codigo_mov='$codigo_mov' order by referencia";
$res=pg_query($sql);
?>
