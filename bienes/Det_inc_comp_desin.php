...
<html>
<head>
<title>SIPAP CONTROL DE BIENES NACIONALES (Detalles Comprobante Desincorporacion)</title>
...
<body>
  <table width="888" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td  width="262" align="center"><input name="btGenComp" type="button" id="btGenComp" value="Generar Comprobante" title="Generar Comprobante" onclick="javascript:LlamarURL('Gen_Comp_Mue_Desin.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
