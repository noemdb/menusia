...
<html>
<head>
<title>SIPAP COMPRAS,SERVICIOS Y ALMAC&Eacute;N (Detalle Reparaciones y Mejoras)</title>
   ...
   <tr>
     <td width="800">
       <table width="800"  border="1" cellspacing='0' cellpadding='0' align="left" id="ret_orden">
         ...
         <?php  $total_rep=0; $filas=pg_num_rows($resultado); 
         ...
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:Llama_Modificar('<?php  echo $cod_bien_mue; ?>','<?php  echo $registro["cod_bien_aso"]; ?>');">
           <td width="200" align="left"><?php  echo $registro["cod_bien_aso"]; ?></td>
           <td width="420" align="left"><?php  echo $registro["denominacion"]; ?></td>
		   <td width="80" align="center"><?php  echo $fecha_rep; ?></td>
		   <td width="100" align="right"><?php  echo $valor_rep; ?></td>
         </tr>
         <?php }  $total_rep=formato_monto($total_rep); ?>
       </table></td>
   </tr>
   <tr><td>&nbsp;</td>   </tr>
   <tr>
     <td><table width="800" border="0">
       <tr>
         ...
         <td width="120"><table width="119" border="1" cellspacing="0" cellpadding="0">
           <tr>
             <td align="right" class="Estilo5"><?php  echo $total_rep; ?></td>
           </tr>
         </table></td>
       </tr>
     </table></td>
