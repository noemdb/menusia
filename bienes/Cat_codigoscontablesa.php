...
function cerrar_catalogo(mcodigo,mdenominacion){
  window.opener.document.forms[0].txtcod_contablea.value = mcodigo;
  window.opener.document.forms[0].txtcod_contablea.focus();
  window.close();
}
</script>
...
<form action="Cat_codigoscontablesa.php" method="get">
