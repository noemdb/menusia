...
function cerrar_catalogo(mcuenta,mnombre){
  window.opener.document.forms[0].txtcod_dependenciad.value = mcuenta;
  window.opener.document.forms[0].txtcod_dependenciad.focus();
  window.close();
}
</script>
...
<html>
<head>
<title>SIPAP CONTABILIDAD PRESUPUESTARIA (Catalogo de Dependencias)</title>
...
<?php 
        ...
        if($numeroRegistros<=0){echo "<font face='verdana' size='-2'>No se encontraron Dependencias</font>";
                ...
                echo "<th height='20' bgcolor='#99CCFF' ><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&orden=cod_dependencia&criterio=".$txt_criterio."'>Partida</a></th>";
