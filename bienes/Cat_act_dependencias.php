...
function CargarUrl(mcodigo) {var murl;
   murl="Act_dependencias_ar.php?Gcod_dependencia="+mcodigo;   document.location = murl;}
</script></head>
<body>
<table width="978" height="38" border="0" bgcolor="#000066">
  <tr>
    <td width="73"><div align="center" class="Estilo2 Estilo4"><img src="../imagenes/Logo_sia.gif" width="72" height="42"></div></td>
    <td width="836"><div align="center" class="Estilo2 Estilo6">CATOLOGO DEPENDENCIAS</div></td>
...
<?php       $criterio=""; $txt_criterio=""; $pagina=1;$inicio=1;$final=1;
        ...
        }else{if ($_GET["orden"]==""){$orden="cod_dependencia";} else{$orden=$_GET["orden"];} $tamPag=15;
  ...
  <tr bgcolor='#FFFFFF' bordercolor='#000000' onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:CargarUrl('<?php  echo $registro["cod_dependencia"]; ?>');" >
...
<form action="Cat_act_dependencias.php" method="get">
