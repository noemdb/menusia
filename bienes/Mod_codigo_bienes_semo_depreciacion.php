...
function llamar_anterior(){document.location ='Det_inc_bienes_semo_depreciacion.php?codigo_mov=<?php echo $codigo_mov?>';}
function revisar(){
var f=document.form1;
var Valido=true;
   if(f.txtcod_bien_sem.value==""){alert("C�digo del Semoviente no puede estar Vacio"); return false; } else{f.txtcod_bien_sem.value=f.txtcod_bien_sem.value.toUpperCase();}
            ...
            <td><table width="806">
              <tr>
                ...
                <td width="839" scope="col"><div align="left"><span class="Estilo5"><span class="Estilo10"> <span class="menu"><strong><strong><strong><strong><strong><strong><strong><strong>
                    <input name="txtcod_bien_sem" type="text" class="Estilo5" id="txtcod_bien_sem" size="30" maxlength="30" readonly value="<?php  echo $cod_bien ?>">
                    <strong><strong>
