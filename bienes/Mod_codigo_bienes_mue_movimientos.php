...
var Valido=true;
   if(f.txtcod_bien_mue.value==""){alert("C�digo del Mueble no puede estar Vacio"); return false; } else{f.txtcod_bien_mue.value=f.txtcod_bien_mue.value.toUpperCase();}
...
?>
<body>
<form name="form1" method="post" action="Update_cod_bienes_mue_movimientos.php" onSubmit="return revisar()">
      ...
      <td><table width="735" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> <td>&nbsp;</td></tr>
          <tr>
            <td><table width="806">
              <tr>
                <td width="111" scope="col"><span class="Estilo5">C&Oacute;DIGO DEL BIEN MUEBLE :</span></td>
