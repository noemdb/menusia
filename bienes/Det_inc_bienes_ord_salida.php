...
function Llama_Eliminar(){var murl;var r;
 if (Gcodigo=="") {alert("Codigo del Mueble debe ser Seleccionada");}
  ...
  if(r==true){    r=confirm("Esta Realmente seguro en Eliminar el Bien de la Transferencia ?");
    if(r==true){murl="Delete_cod_bienes_ord_sal.php?codigo_mov="+Gcodigo_mov+"&codigo="+Gcodigo;document.location=murl;}    }
 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left">
          <tr>
            <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar Codigo al Movimiento" onclick="javascript:LlamarURL('Inc_bienes_ord_sal.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
