 ...
 <table width="845" border="0" cellspacing="0" cellpadding="0">
   <tr>
      <td align="left"><table width="840" border="0" align="left">
          <tr>
            <td width="222" align="center" valign="middle"><input name="btAgregar" type="button" id="btAgregar" value="Agregar" title="Agregar C�digo al Movimiento" onclick="javascript:LlamarURL('Inc_bienes_Semo_Depreciacion.php?codigo_mov=<?php echo $codigo_mov?>')"></td>
...
?>
         <tr bgcolor='#FFFFFF' bordercolor='#000000' height="20" class="Estilo5" onMouseOver="this.style.backgroundColor='#CCCCCC';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#FFFFFF'"o"];" onDblClick="javascript:enviar('<?php  echo $codigo_mov; ?>','<?php  echo $registro["cod_bien"]; ?>');">
           ...
           <td width="100" align="left"><?php  echo $registro["valor_residual"]; ?></td>
           <td width="100" align="left"><?php  echo $registro["vida_util"]; ?></td>
           <td width="100" align="left"><?php  echo $registro["monto_depreciado"]; ?></td>
           <td width="100" align="left"><?php  echo $registro["cod_contablea"]; ?></td>
           <td width="100" align="left"><?php  echo $registro["cod_contabled"]; ?></td>
           <td width="100" align="left"><?php  echo $registro["tipo_depreciacion"]; ?></td>
           <td width="100" align="left"><?php  echo $registro["cod_presup_dep"]; ?></td>
